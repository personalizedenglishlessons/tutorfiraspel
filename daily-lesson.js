...
(function(){
  ...
  const BANK = [
    ...
    {id:'calling-customer-service', en:'Calling Customer Service', ar:'الاتصال بخدمة العملاء'},
    {id:'doctor-appointment',    en:'Making A Doctor Appointment', ar:'حجز موعد عند الدكتور'},
    {id:'shopping-clothes',      en:'Shopping For Clothes',  ar:'شراء ملابس'},
    {id:'first-day-work',        en:'First Day At Work',     ar:'اول يوم بالدوام'},
    {id:'talking-family',        en:'Talking About Your Family', ar:'تتكلم عن عائلتك'},
  ...
  const EN_POOL = [
    ...
    {id:'reading-corner',           en:'Reading Corner',             ar:'ركن القراءة'},
    ...
    {id:'emergency-english',        en:'Emergency English',          ar:'انجليزي الطوارئ'},
