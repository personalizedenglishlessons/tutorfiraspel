...
(function () {
  ...
  function PEL_CERT_SHEET(o) {
    ...
    var achAr = 'قد اتم بنجاح منهج ' + (o.academyAr ? o.academyAr : academyEn) + (level ? ' على مستوى ' + level : '') + ' لدروس الانجليزي المخصصة.';
    ...
    return '<div class="cert-sheet" role="img" aria-label="PEL certificate of completion for ' + name + '">' +
      ...
      '<div class="cert-inner">' +
        ...
        '<div class="cert-head">' +
          ...
          '<div class="cert-brand-sub ar cert-ar">دروس الانجليزي المخصصة</div>' +
        '</div>' +
        // title
        '<h1 class="cert-title">Certificate of Completion</h1>' +
        '<div class="cert-title-ar cert-ar">شهادة اتمام</div>' +
        '<div class="cert-div"><span class="cert-diamond"></span></div>' +
        // recipient
        '<div class="cert-certifies">This certificate is proudly presented to</div>' +
        '<div class="cert-certifies-ar cert-ar">يُمنح هذا المستند بكل فخر الى</div>' +
        ...
        '<div class="cert-foot">' +
          '<div class="cert-iss">' +
            ...
            '<div class="role-ar cert-ar">اكاديمية PEL</div>' +
            '<div class="rule"></div>' +
