...
(function () {
  ...
  function PEL_CERT_SHEET(o) {
    ...
    var achAr = 'قد اتم بنجاح منهج ' + (o.academyAr ? o.academyAr : academyEn) + (level ? ' على مستوى ' + level : '') + ' لدروس الحينجليزي المخصصه.';
    ...
    return '<div class="cert-sheet" role="img" aria-label="PEL certificate of completion for ' + name + '">' +
      ...
      '<div class="cert-inner">' +
        ...
        '<div class="cert-certifies-ar cert-ar">يُمنح ذا المستند بكل فخر الى</div>' +
