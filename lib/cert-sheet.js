...
(function () {
  ...
  function PEL_CERT_SHEET(o) {
    ...
    var achAr = 'يمكن اتم بنجاح منهج ' + (o.academyAr ? o.academyAr : academyEn) + (level ? ' على مستوى ' + level : '') + ' لدروس الانجليزي المخصصه.';
    ...
    return '<div class="cert-sheet" role="img" aria-label="PEL certificate of completion for ' + name + '">' +
      ...
      '<div class="cert-inner">' +
        ...
        '<div class="cert-head">' +
          ...
          '<div class="cert-brand-sub ar cert-ar">دروس الانجليزي المخصصه</div>' +
        '</div>' +
        // title
