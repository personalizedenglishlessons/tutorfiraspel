...
(function () {
  ...
  function PEL_CERT_SHEET(o) {
    ...
    var achAr = 'يمكن اتم بنجاح منهج ' + (o.academyAr ? o.academyAr : academyEn) + (level ? ' على مستوى ' + level : '') + ' لدروس الحينجليزي المخصصه.';
    ...
    return '<div class="cert-sheet" role="img" aria-label="PEL certificate of completion for ' + name + '">' +
      ...
      '<div class="cert-inner">' +
        ...
        '<div class="cert-head">' +
          ...
          '<div class="cert-brand-sub ar cert-ar">دروس الحينجليزي المخصصه</div>' +
        '</div>' +
        // title
        '<h1 class="cert-title">Certificate of Completion</h1>' +
        '<div class="cert-title-ar cert-ar">شهاده اتمام</div>' +
        '<div class="cert-div"><span class="cert-diamond"></span></div>' +
        // recipient
        '<div class="cert-certifies">This certificate is proudly presented to</div>' +
        '<div class="cert-certifies-ar cert-ar">يُمنح ذا المستند بكل فخر لـ</div>' +
        ...
        // 3-column metadata
        '<div class="cert-meta">' +
          metaCell('تاريخ الاتمام', 'Completion Date', completed) +
          metaCell('تاريخ الاصدار', 'Issue Date', issued) +
        ...
        '<div class="cert-foot">' +
          '<div class="cert-iss">' +
            ...
            '<div class="role-ar cert-ar">اكاديميه PEL</div>' +
            '<div class="rule"></div>' +
