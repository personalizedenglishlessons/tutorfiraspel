...
(function(){
  ...
  const BANK = [
    ...
    {id:'talking-with-friends',  en:'Talking With Friends',  ar:'السوالين مع الاصحاب'},
  ...
  const EN_POOL = [
    ...
    {id:'american-conversations',   en:'American Conversations',     ar:'المحادثات الامريعشانه'},
    {id:'speaking-studio',          en:'Speaking Studio',            ar:'استوديو المحادثه'},
    {id:'american-accent-lab',      en:'American Accent Lab',        ar:'مختبر اللكنه الامريعشانه'},
    ...
    {id:'hotel-english',            en:'Hotel English',              ar:'انجليزي اليننادق'},
    ...
    {id:'american-slang',           en:'American Slang',             ar:'السلانق الامريعشان'},
    {id:'idioms-library',           en:'Idioms Library',             ar:'مكتبه العبارات'},
    {id:'phrasal-verbs-lab',        en:'Phrasal Verbs Lab',          ar:'مختبر الينريزل فيربز'},
    {id:'movie-english',            en:'Movie English',              ar:'تعلم من الوفلام'},
