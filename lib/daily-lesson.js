...
(function(){
  ...
  const EN_POOL = [
    ...
    {id:'american-accent-lab',      en:'American Accent Lab',        ar:'مختبر اللكنة الامريكيه'},
    ...
    {id:'job-interview-academy',    en:'Job Interview Academy',      ar:'اكاديميه مقابلات العمل'},
    ...
    {id:'fluency-journey',          en:'Fluency Journey',            ar:'رحه الطلاقة'},
  ];
