...
(function(){
  ...
  var L = {
    ...
    placeIntroSub:{en:'8 short questions. No pressure - this sharpens your starting point before we build the route.', ar:'٨ اسيلة قصيرة بدون ضغط - يحدد نقطة بدايتك بشكل ادق قبل ما نبني المسار.'},
    ...
    planReadySub:{en:'This route comes from your answers and the placement check. Change your pace below - nothing is locked.', ar:'هذا المسار مبني على اجاباتك ونتيجة الفحص. غيّر ايقاعك بالاسفل - ما شي مقفول.'},
  ...
  function renderPlan(){
    ...
    html += '<div class="ob-save-cta">'
      ...
      + '<a class="btn-wa" target="_blank" rel="noopener" href="https://wa.me/' + waNum + '?text=' + encodeURIComponent('ابي اسال عن الانضمام للمنصة') + '">' + T('wa') + '</a>'
      + '</div>'
