...
(function(){
  ...
  var L = {
    ...
    planReadySub:{en:'This route comes from your answers and the placement check. Change your pace below - nothing is locked.', ar:'هذا المسار مبني على اجاباتك ونتيجه الفحص. غيّر ايقاعك بالاسفل - ما شي مقفول.'},
    start:{en:'Starting point', ar:'نقطه البداية'},
