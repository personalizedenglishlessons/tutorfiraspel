...
(function(){
  ...
  var L = {
    ...
    saveNote:{en:'Saved on this device. After your teacher opens your account, the same plan waits for you inside the app.', ar:'محفوظه على جهازك. بعد ما يفتح لك الاستاذ حسابك، نفس الخطه تكون بانتظارك داخل التطبيق.'},
