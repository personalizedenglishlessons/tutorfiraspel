...
(function(){
  ...
  var L = {
    ...
    privacyNote:{en:'Your answers stay on this device until your teacher opens your account.', ar:'اجاباتك تبقى على جهازك لين ما يفتح لك الاستاذ حسابك.'},
    ...
    placeIntroSub:{en:'8 short questions. No pressure - this sharpens your starting point before we build the route.', ar:'٨ اساله قصيره ببدون ضغط - يحدد نقطه بدايتك بشكل ادق قبل ما نبني المسار.'},
    placeOptional:{en:'Optional، 2 minutes', ar:'اختياري، دقيقتين'},
    takePlace:{en:'Take the check', ar:'اسوي الينحص'},
    ...
    planReadySub:{en:'This route comes from your answers and the placement check. Change your pace below - nothing is locked.', ar:'ذا المسار مبني على اجاباتك ونتيجه الينحص. غيّر ايقاعك بالاسفل - ما شي مقفول.'},
    start:{en:'Starting point', ar:'نقطه البدايه'},
    dest:{en:'Your destination', ar:'وجهتك'},
    focus:{en:'Early focus', ar:'الترعشانز الاولي'},
    ...
    saveNote:{en:'Saved on this device. After your teacher opens your account, the same plan waits for you inside the app.', ar:'محفوظه على جهازك. لسه ما يفتح لك الاستاذ حسابك، نفس الخطه تكون بانتظارك داخل التطبيق.'},
  ...
  function renderPlan(){
    ...
    html += '<div class="ob-save-cta">'
      ...
      + '<a class="btn-wa" target="_blank" rel="noopener" href="https://wa.me/' + waNum + '?text=' + encodeURIComponent('ابي اسال عن الانضمام للمنصه') + '">' + T('wa') + '</a>'
      + '</div>'
