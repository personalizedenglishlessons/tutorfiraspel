...
(function () {
  ...
  var L = {
    ...
    introSub: { en: 'Ready to see your level? Let us jump straight in. 10 minutes, up to 20 questions, and we adapt to you as you go.', ar: 'جاهز تشوف مستواك؟ خلنا نبدا علطول. 10 دقايق، حتى 20 سوال، ونتكيف معاك وانت جاي.' },
    ...
    resultExam: { en: 'You are advanced. The Exam Prep plan fits you (STEP, TOEFL, IELTS).', ar: 'مستواك متقدم. خطه التجهيز للاختبارات تناسبك (STEP و TOEFL و IELTS).' },
    ...
    activatedNote: { en: 'Activation within minutes after manual confirmation.', ar: 'التنشيط خلال دقايق لسه التاكيد اليدوي.' },
  ...
  /* A learner who cannot read English letters gets a transliteration track:
     ...
     Arabic script (e.g. كيفك -> هاو ار يو). Tests pronunciation/recognition,
  ...
  function tierMeta(t) {
    return t === 'exam_prep' ? {
      ...
      featAr: ['وصول كامل للوحه التحكم والدروس', 'دروس اساسيه غير متقدمه', 'سيناريوهات يوميه واقعيه', 'ترجمه فوريه وشرح بالعربي'],
  ...
  function cardHtml(r, tier, level) {
    ...
    html += '</ul>';
    var waText = ar
      ? 'السلام عليكم، اختبرت مستواي بمنصه PEL وطلع لي ' + (window.PEL_ENGINE && PEL_ENGINE.levelInfo ? (PEL_ENGINE.levelInfo(level).ar || level) : level) + ' (' + (tier === 'exam_prep' ? 'متقدم' : 'مبتدي') + '). ابي اشترك بباقه ' + dl.ar + ' بـ ' + r.price + ' ريال. وش طريقه الدفع؟'
  ...
  var FALLBACK_QUESTIONS = [
    ...
    { code: 'n01', tier: 'beginner', level: 'A2', difficulty_rating: 2, question_en: 'Choose the correct verb: While I ___ dinner, the phone rang.', question_ar: 'اختار الفعل الصح: While I ___ dinner, the phone rang.', options: [{ en: 'was cooking', ar: 'was cooking' }, { en: 'cooked', ar: 'cooked' }, { en: 'cook', ar: 'cook' }, { en: 'cooking', ar: 'cooking' }], correct_index: 0 },
    { code: 'n02', tier: 'beginner', level: 'B1', difficulty_rating: 3, question_en: 'Choose the correct verb: She ___ her phone. She cannot find it.', question_ar: 'اختار الفعل الصح: She ___ her phone. She cannot find it.', options: [{ en: 'has lost', ar: 'has lost' }, { en: 'lost', ar: 'lost' }, { en: 'is losing', ar: 'is losing' }, { en: 'loses', ar: 'loses' }], correct_index: 0 },
  ...
  var TRUE_ZERO_QUESTIONS = [
    ...
    { code: 'tz02', tier: 'true_zero', level: 'A0', difficulty_rating: 1,
      ...
      question_ar: '«كيفك» - اختار النطق الصح بالحينجليزي',
    ...
    { code: 'tz09', tier: 'true_zero', level: 'A0', difficulty_rating: 1,
      ...
      question_ar: '«تقدر تساعدني» - اختار النطق الصح بالحينجليزي',
