...
(function () {
  ...
  var SB_URL = (window.PEL_CONFIG && PEL_CONFIG.SUPABASE_URL) || 'https://lewoochehpiycocvfwtz.supabase.co';
  var SB_KEY = (window.PEL_CONFIG && PEL_CONFIG.SUPABASE_ANON_KEY) || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imxld29vY2hlaHBpeWNvY3Zmd3R6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODQwNzQ3MzcsImV4cCI6MjA5OTY1MDczN30.sIWK6jwX7PW70fH0yPUuhOb25N1lBw2-Cvb3dtwDb9Y';
  ...
  var L = {
    ...
    introSub: { en: 'Ready to see your level? Let us jump straight in. 10 minutes, up to 20 questions, and we adapt to you as you go.', ar: 'جاهز تشوف مستواك؟ خلنا نبدا علطول. 10 دقايق، حتى 20 سوال، ونتكيف معك وانت جاي.' },
    ...
    classesWeek: { en: 'live classes / week', ar: 'حصص مباشرة كل اسبوع' },
    classesWeekNote: { en: 'included with this plan', ar: 'مشمولة معك بهالباقة' },
  ...
  function tierMeta(t) {
    return t === 'exam_prep' ? {
      ...
      featAr: ['مسارات التجهيز للاختبارات', 'اساله محاكاة للامتحان', 'وحدات مصطلحات مستهدفة', 'ترجمة فورية ومراجعة كتابة'],
  ...
  function cardHtml(r, tier, level) {
    ...
    html += '</ul>';
    var waText = ar
      ? 'السلام عليكم، اختبرت مستواي بمنصة PEL وطلع لي ' + (window.PEL_ENGINE && PEL_ENGINE.levelInfo ? (PEL_ENGINE.levelInfo(level).ar || level) : level) + ' (' + (tier === 'exam_prep' ? 'متقدم' : 'مبتدي') + '). ابي اشترك بباقة ' + dl.ar + ' بـ ' + r.price + ' ريال. وش طريقة الدفع؟'
  ...
  var FALLBACK_QUESTIONS = [
    ...
    { code: 'n03', tier: 'beginner', level: 'B1', difficulty_rating: 3, question_en: 'Choose the correct word: I ___ live in Riyadh, but I moved.', question_ar: 'اختار الكلمة الصح: I ___ live in Riyadh, but I moved.', options: [{ en: 'used to', ar: 'used to' }, { en: 'use to', ar: 'use to' }, { en: 'using to', ar: 'using to' }, { en: 'am used', ar: 'am used' }], correct_index: 0 },
    ...
    { code: 'n06', tier: 'exam_prep', level: 'B2', difficulty_rating: 4, question_en: 'Choose the best word: She made a good ___ on the interviewers.', question_ar: 'اختار افضل كلمة: She made a good ___ on the interviewers.', options: [{ en: 'impression', ar: 'انطباع' }, { en: 'expression', ar: 'تعبير' }, { en: 'impressive', ar: 'مبهر' }, { en: 'impress', ar: 'يبهر' }], correct_index: 0 }
  ];
