...
(function () {
  ...
  var FALLBACK_QUESTIONS = [
    { code: 'q01', tier: 'beginner', level: 'A1', difficulty_rating: 1, question_en: 'She ___ to school every day.', question_ar: 'هي ___ للمدرسه كل يوم.', options: [{ en: 'go', ar: 'go' }, { en: 'goes', ar: 'goes' }, { en: 'going', ar: 'going' }, { en: 'gone', ar: 'gone' }], correct_index: 1 },
  ...
  var TRUE_ZERO_QUESTIONS = [
    ...
    { code: 'tz10', tier: 'true_zero', level: 'A0', difficulty_rating: 1,
      ...
      question_ar: '«اشوفك بعدين» - اختار النطق الصح بالحينجليزي',
