...
(function () {
  ...
  var L = {
    ...
    introSub: { en: 'Ready to see your level? Let us jump straight in. 10 minutes, up to 20 questions, and we adapt to you as you go.', ar: 'جاهز تشوف مستواك؟ خلنا نبدا علطول. 10 دقايق، حتى 20 سوال، ونتعشان معاك وانت جاي.' },
  ...
  /* A learner who cannot read English letters gets a transliteration track:
     ...
     Arabic script (e.g. عشانك -> هاو ار يو). Tests pronunciation/recognition,
  ...
  var TRUE_ZERO_QUESTIONS = [
    ...
    { code: 'tz02', tier: 'true_zero', level: 'A0', difficulty_rating: 1,
      ...
      question_ar: '«عشانك» - اختار النطق الصح بالانجليزي',
