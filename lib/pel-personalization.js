...
(function(){
  ...
  const LEVELS = [
    { id:'A0', en:'English Starter', ar:'انجليزي البداية',
  ...
  const ACADEMY_META = {
    ...
    'writing-workshop':        { en:'Writing Workshop', ar:'ورشة الكتابه', icon:'pen-line', from:'#A88345', to:'#17171B', diff:'Advanced', level:'B2' },
  ...
  const QUESTIONS = [
    ...
    { key:'q6', multi:true, max:3, id:'style',
      ...
      options:[
        ...
        { id:'conversation-first', en:'Conversation first', ar:'المحادثه اولا' },
  ...
  const API = {
    ...
    whyPlan: function(profile, route){
      ...
      if(foc.length){
        ...
        linesAr.push('خطتك تركز على ' + foc.map(f => ({Speaking:'المحادثه',Listening:'الاستماع',Vocabulary:'المفردات',Grammar:'القواعد',Pronunciation:'النطق',Writing:'الكتابه'})[f] || f).join(' و ') + ' لانك اخترتها كاولوية ونتيجة التقييم تاكدها.');
      }
