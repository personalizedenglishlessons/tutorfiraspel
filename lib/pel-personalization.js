...
(function(){
  ...
  const QUESTIONS = [
    { key:'q1', multi:true, max:4, id:'goals',
      ...
      sub:{ en:'Pick everything that matters. You can change this later.', ar:'اختر كل شي يهمك. تيمكنر تغيره بعدين.' },
      options:[
    ...
    recommendNext: function(profile, route, state){
      ...
      if(unit){
        if(stage.theme === 'foundation' && stage.key === 'start-here'){
          ...
          whyAr = 'اخترناه لان ' + (cOpt ? cOpt.ar : 'المواقف الحقيقيه') + ' هي المكان اللي تبي تستخدم فيه الانجليزي.';
