  ...
  const QUESTIONS = [
    ...
    { key:'q2', multi:true, max:4, id:'abilities',
      ...
      options:[
        ...
        { id:'customers', en:'Communicate with customers', ar:'تتواصل مع العملاء' },
      ]},
