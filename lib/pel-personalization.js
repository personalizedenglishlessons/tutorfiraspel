...
(function(){
  ...
  const QUESTIONS = [
    { key:'q1', multi:true, max:4, id:'goals',
      ...
      sub:{ en:'Pick everything that matters. You can change this later.', ar:'اختر كل شي يهمك. تقدر تغيره لسهين.' },
      options:[
    ...
    { key:'q2', multi:true, max:4, id:'abilities',
      ...
      options:[
        ...
        { id:'small-talk', en:'Make small talk', ar:'تسولف سوالف خفيفه' },
    ...
    { key:'q5', multi:false, id:'comfort',
      ...
      options:[
        ...
        { id:'basic-words', en:'I know basic words but struggle to make sentences', ar:'اعرف كلمات بس ما اقدر اكمل جمله' },
        { id:'simple-convos', en:'I can handle very simple conversations', ar:'اقدر احكي محادثات بسيطه' },
        { id:'understand-more', en:'I understand more than I can speak', ar:'افهم اكثر مما اتكلم' },
        { id:'communicate-mistakes', en:'I can communicate, but I make a lot of mistakes', ar:'اتواصل بس اخطايي كثيره' },
    ...
    { key:'q6', multi:true, max:3, id:'style',
      ...
      sub:{ en:'This shapes lesson length and format, not what you skip.', ar:'ذا يحدد طول الدروس وشكلها، مو اللي تتخطاه.' },
      options:[
  ...
  const API = {
    ...
    recommendNext: function(profile, route, state){
      ...
      if(!whyEn){
        ...
        whyAr = 'اخترناه لانه الخطوه التاليه في مسارك.';
      }
