...
(function(){
  ...
  const PLACEMENT = [
    ...
    { band:'B2', q:{ en:'A client complains about a mistake. You say...', ar:'عميل اشتكى من غلط. تقول له...' },
      options:[ { en:'I take full responsibility and here is how I\'ll fix it', ar:'اتحمل المسووليه وهذي طريقه حلها' }, { en:'It is not my fault', ar:'مو غلطتي' }, { en:'Sorry maybe', ar:'اسف تقدر' } ], correct:0 },
  ];
