...
(function(){
  ...
  const LEVELS = [
    { id:'A0', en:'English Starter', ar:'انجليزي البدايه',
      descEn:'From zero: your first words and the most essential survival words.',
      descAr:'من الصفر: اول كلماتك واهم كلمات البقا.' },
    { id:'A1', en:'English Basics', ar:'انجليزي الاساس',
      descEn:'Building the basics: sounds, simple words, short sentences.',
      descAr:'تبني الاساس: الاصوات، الكلمات البسيطه، والجمل القصيره.' },
    { id:'A2', en:'English Daily', ar:'انجليزي اليومي',
      descEn:'Handling simple real situations: ordering, asking, introducing.',
      descAr:'تتعامل مع مواقف بسيطه: تطلب، تسال، تعرف بنفسك.' },
    { id:'B1', en:'English Middle', ar:'انجليزي الوسط',
      descEn:'Communicating through real conversations, mistakes and all.',
      descAr:'تتواصل بمحادثات حقيقيه، مع اغلطيك عادي.' },
    { id:'B2', en:'English Strong', ar:'انجليزي قوي',
      descEn:'Handling work, meetings and everyday life with less effort.',
      descAr:'تدير الدوام والاجتماعات وحياتك اليوميه ببدون تعب.' },
    { id:'C1', en:'English High', ar:'انجليزي عالي',
      descEn:'Speaking naturally and handling almost anything with ease.',
      descAr:'تتكلم بشكل طبيعي وتدير اغلب المواقف بسهوله.' },
  ];
  ...
  const ACADEMY_META = {
    'english-foundations':     { en:'English Foundations', ar:'اساسيات الحينجليزي', icon:'graduation-cap', from:'#C8A96A', to:'#A88345', diff:'Beginner', level:'A1' },
    'everyday-english':        { en:'Everyday English', ar:'انجليزي الحياه اليوميه', icon:'sun', from:'#D8BD83', to:'#C8A96A', diff:'Beginner', level:'A2' },
    'american-conversations':  { en:'American Conversations', ar:'المحادثات الامريعشانه', icon:'message-circle', from:'#3F8C72', to:'#276b53', diff:'Intermediate', level:'B1' },
    'speaking-studio':         { en:'Speaking Studio', ar:'استوديو المحادثه', icon:'mic-2', from:'#3F8C72', to:'#C8A96A', diff:'Intermediate', level:'B1' },
    'american-accent-lab':     { en:'American Accent Lab', ar:'مختبر اللكنه الامريعشانه', icon:'mic', from:'#C8A96A', to:'#D8BD83', diff:'Intermediate', level:'B1' },
    'vocabulary-vault':        { en:'Vocabulary Vault', ar:'خزنه المفردات', icon:'book-open', from:'#A88345', to:'#C8A96A', diff:'All Levels', level:'A2' },
    'grammar-academy':         { en:'Grammar Academy', ar:'اكاديميه القواعد', icon:'spell-check', from:'#343744', to:'#262833', diff:'All Levels', level:'A2' },
    ...
    'writing-workshop':        { en:'Writing Workshop', ar:'ورشه الكتابه', icon:'pen-line', from:'#A88345', to:'#17171B', diff:'Advanced', level:'B2' },
    ...
    'job-interview-academy':   { en:'Job Interview Academy', ar:'اكاديميه مقابلات الشغل', icon:'user-check', from:'#C8A96A', to:'#343744', diff:'Advanced', level:'B2' },
    ...
    'hotel-english':           { en:'Hotel English', ar:'انجليزي اليننادق', icon:'bed', from:'#343744', to:'#C8A96A', diff:'Beginner', level:'A2' },
    ...
    'driving-english':         { en:'Driving English', ar:'انجليزي القياده', icon:'car', from:'#262833', to:'#D8BD83', diff:'Beginner', level:'A2' },
    'emergency-english':       { en:'Emergency English', ar:'انجليزي الطواري', icon:'siren', from:'#D25C5C', to:'#343744', diff:'Intermediate', level:'B1' },
    'american-slang':          { en:'American Slang', ar:'السلانق الامريعشان', icon:'sparkles', from:'#C8A96A', to:'#17171B', diff:'Advanced', level:'B2' },
    'idioms-library':          { en:'Idioms Library', ar:'مكتبه العبارات', icon:'quote', from:'#A88345', to:'#17171B', diff:'Advanced', level:'B2' },
    'phrasal-verbs-lab':       { en:'Phrasal Verbs Lab', ar:'مختبر الينريزل فيربز', icon:'shuffle', from:'#3F8C72', to:'#A88345', diff:'Advanced', level:'B2' },
    'movie-english':           { en:'Movie English', ar:'تعلم من الوفلام', icon:'film', from:'#343744', to:'#17171B', diff:'Advanced', level:'B2' },
    ...
    'english-mastery':         { en:'English Mastery', ar:'اتقان الحينجليزي', icon:'crown', from:'#C8A96A', to:'#D8BD83', diff:'Advanced', level:'C1' },
    'fluency-journey':         { en:'Fluency Journey', ar:'رحله الطلاقه', icon:'compass', from:'#D8BD83', to:'#A88345', diff:'All Levels', level:'C1' },
  };

  /* ---------------- LESSON REFERENCE TABLE ----------------
     id -> { t:title(en), a:title(ar), d:duration, v:difficulty } */
  const LESSON_META = {"the-alphabet":{"t":"The Alphabet & Letter Sounds","a":"الحروف الحينجليزيه ونطقها","d":"7 min","v":"Beginner"},"greetings-goodbye":{"t":"Greetings and Goodbyes","a":"التحيه والوداع","d":"7 min","v":"Beginner"},"introducing-yourself":{"t":"Introducing Yourself","a":"تعريف نفسك","d":"8 min","v":"Beginner"},"numbers-dates":{"t":"Numbers, Prices and Dates","a":"الارقام والاسعار والتواريخ","d":"8 min","v":"Beginner"},"personal-information":{"t":"Personal Information Forms","a":"تعبي استماره بياناتك","d":"7 min","v":"Beginner"},"basic-questions":{"t":"Basic Questions With What, Where, When","a":"الاساله الاساسيه: وش، وين، متى","d":"8 min","v":"Beginner"},"small-talk-weather":{"t":"Small Talk: The Weather","a":"سوالين خفيفه: الجو","d":"7 min","v":"Beginner"},"talking-family":{"t":"Talking About Your Family","a":"تحعشان عن عايلتك","d":"8 min","v":"Beginner"},"weekend-plans":{"t":"Weekend Plans","a":"خطط الويكند","d":"8 min","v":"Beginner"},"daily-routines":{"t":"Daily Routines","a":"روتينك اليومي","d":"8 min","v":"Beginner"},"inviting-friends":{"t":"Inviting Friends Out","a":"تدعي اصحابك تطلعون","d":"8 min","v":"Beginner"},"catching-up":{"t":"Catching Up With Friends","a":"نسولف مع اصحابك","d":"8 min","v":"Intermediate"},"opinions-agreeing":{"t":"Opinions, Agreeing and Disagreeing","a":"الراي والموافقه والاختلاف","d":"9 min","v":"Intermediate"},"asking-favors":{"t":"Asking for Favors","a":"تطلب خدمه","d":"8 min","v":"Intermediate"},"clarifying-misunderstandings":{"t":"Clarifying Misunderstandings","a":"توضيح سو الينهم","d":"9 min","v":"Intermediate"},"talking-past-events":{"t":"Talking About Past Events","a":"تحعشان عن واحداث سابقه","d":"9 min","v":"Intermediate"},"asking-directions":{"t":"Asking for Directions","a":"تسال عن الاتجاهات","d":"8 min","v":"Beginner"},"currency-exchanging":{"t":"Exchanging Money","a":"تصريف الشغله","d":"8 min","v":"Intermediate"},"check-in-desk":{"t":"Airport Check-in","a":"الكاونتر بالمطار","d":"8 min","v":"Beginner"},"security-checks":{"t":"Security Checks","a":"التفتيش بالامن","d":"8 min","v":"Beginner"},"delays-cancellations":{"t":"Delays and Cancellations","a":"التاخوير والالغا","d":"9 min","v":"Intermediate"},"checking-in":{"t":"Hotel Check-in","a":"تسجيل الدخول بالينندق","d":"8 min","v":"Beginner"},"hotel-requests":{"t":"Hotel Requests","a":"طلباتك بالينندق","d":"8 min","v":"Beginner"},"hotel-problems":{"t":"Hotel Problems","a":"مشاكل الينندق","d":"9 min","v":"Intermediate"},"booking-table":{"t":"Booking A Table","a":"حجز طاوله","d":"8 min","v":"Beginner"},"ordering-food":{"t":"Ordering Food","a":"تطلب اكل","d":"9 min","v":"Beginner"},"dietary-requests":{"t":"Dietary Requests and Allergies","a":"الطلبات الغذاييه والحساسيه","d":"8 min","v":"Intermediate"},"paying-bill":{"t":"Paying The Bill","a":"تدفع الحساب","d":"8 min","v":"Beginner"},"coffee-sizes":{"t":"Coffee Sizes and Types","a":"مقاسات القهوه وانواعها","d":"7 min","v":"Beginner"},"customizing-order":{"t":"Customizing Your Coffee","a":"تعديل طلب القهوه","d":"7 min","v":"Beginner"},"doctor-appointment":{"t":"Making A Doctor Appointment","a":"حجز موعد عند الدكتور","d":"8 min","v":"Beginner"},"describing-symptoms":{"t":"Describing Symptoms","a":"تصف الاعراض","d":"9 min","v":"Intermediate"},"pharmacy-requests":{"t":"At The Pharmacy","a":"بالصيدليه","d":"8 min","v":"Intermediate"},"emergency-room":{"t":"Emergency Room","a":"الطواري","d":"9 min","v":"Intermediate"},"shopping-clothes":{"t":"Shopping For Clothes","a":"شرا ملابس","d":"8 min","v":"Beginner"},"asking-prices":{"t":"Asking Prices","a":"تسال عن الاسعار","d":"7 min","v":"Beginner"},"refunds-exchanges":{"t":"Refunds and Exchanges","a":"الاسترجاع والاستبدال","d":"9 min","v":"Intermediate"},"renting-car":{"t":"Renting A Car","a":"تاجير سياره","d":"8 min","v":"Intermediate"},"gas-station":{"t":"At The Gas Station","a":"محطه البنزين","d":"7 min","v":"Beginner"},"directions-driving":{"t":"Directions While Driving","a":"الاتجاهات اثنا القياده","d":"8 min","v":"Intermediate"},"calling-911":{"t":"Calling For Help","a":"الاتصال بالطواري","d":"8 min","v":"Intermediate"},"medical-emergency":{"t":"Medical Emergency Help","a":"مساعده طبيه طاريه","d":"9 min","v":"Intermediate"},"meeting-etiquette":{"t":"Meeting Etiquette","a":"اداب الاجتماعات","d":"9 min","v":"Advanced"},"email-phrases-business":{"t":"Business Email Phrases","a":"عبارات الايميلات الرسميه","d":"9 min","v":"Advanced"},"phone-calls-business":{"t":"Business Phone Calls","a":"مكالمات الشغل","d":"9 min","v":"Advanced"},"first-day-work":{"t":"First Day At Work","a":"اول يوم بالدوام","d":"9 min","v":"Intermediate"},"asking-for-help-work":{"t":"Asking For Help At Work","a":"تطلب مساعده بالدوام","d":"8 min","v":"Intermediate"},"giving-feedback":{"t":"Giving And Receiving Feedback","a":"تعطي وتاخذ ملاحظات","d":"9 min","v":"Advanced"},"interview-self-intro":{"t":"Interview: Tell Me About Yourself","a":"المقابله: عرفني عن نفسك","d":"10 min","v":"Advanced"},"interview-strengths":{"t":"Interview: Strengths and Weaknesses","a":"المقابله: نقاط القوه والضعف","d":"10 min","v":"Advanced"},"interview-follow-up":{"t":"Interview Follow-up","a":"متابعه لسه المقابله","d":"8 min","v":"Advanced"},"present-simple-lesson":{"t":"Present Simple Mastery","a":"اتقان الحاضر البسيط","d":"9 min","v":"Intermediate"},"past-simple-lesson":{"t":"Past Simple Mastery","a":"اتقان الماضي البسيط","d":"9 min","v":"Intermediate"},"future-forms-lesson":{"t":"Future Forms: Will and Going To","a":"المستقبل: will و going to","d":"9 min","v":"Intermediate"},"learning-words-effectively":{"t":"How To Learn Words Effectively","a":"عشانف تتعلم الكلمات بفعاليه","d":"9 min","v":"All Levels"},"collocations-basics":{"t":"Collocations: Words That Go Together","a":"الكلمات اللي تجي مع بعض","d":"8 min","v":"Intermediate"},"sounding-natural":{"t":"Sounding Natural: Contractions","a":"لام طبيعي: الاختصارات","d":"8 min","v":"Intermediate"},"word-stress-basics":{"t":"Word Stress Basics","a":"اساسيات التشديد","d":"8 min","v":"Intermediate"},"linking-words":{"t":"Linking Words Together","a":"وصل الكلمات ببعض","d":"8 min","v":"Advanced"},"listening-announcements":{"t":"Listening To Announcements","a":"تستمع للاعلانات","d":"9 min","v":"Intermediate"},"listening-phone-calls":{"t":"Listening On Phone Calls","a":"الاستماع بالمكالمات","d":"9 min","v":"Intermediate"},"reading-emails":{"t":"Reading Emails Quickly","a":"قرايه الايميلات بسرعه","d":"8 min","v":"Intermediate"},"reading-signs":{"t":"Reading Signs and Notices","a":"قرايه اللوحات والاشارات","d":"7 min","v":"Beginner"},"writing-emails-polite":{"t":"Polite Email Writing","a":"كتابه ايميل مهذب","d":"9 min","v":"Advanced"},"writing-messages":{"t":"Writing WhatsApp-Style Messages","a":"كتابه رسايل قصيره","d":"7 min","v":"Intermediate"},"slang-basics":{"t":"Everyday American Slang","a":"السلانق الامريعشان اليومي","d":"8 min","v":"Advanced"},"idioms-basics":{"t":"Idioms You Hear Every Day","a":"تعابير تسمعها كل يوم","d":"9 min","v":"Advanced"},"phrasal-basics":{"t":"Phrasal Verbs: Look, Give, Call","a":"الوفعال المركبه الشايعه","d":"9 min","v":"Advanced"},"movie-talk":{"t":"Talking About Movies","a":"تحعشان عن الوفلام","d":"8 min","v":"Intermediate"},"music-talk":{"t":"Talking About Music","a":"تحعشان عن الاغاني","d":"8 min","v":"Intermediate"},"mastery-review":{"t":"Mastery Review: Build Your Own Lesson","a":"مراجعه الاتقان","d":"10 min","v":"Advanced"},"fluency-habit":{"t":"Building The Daily Habit","a":"بنا عاده التعلم اليوميه","d":"8 min","v":"All Levels"},"calling-customer-service":{"t":"Calling Customer Service","a":"الاتصال بخدمه الشغلا","d":"9 min","v":"Intermediate"},"sa-hello-hala":{"t":"Hala: The Saudi Hello","a":"هلا والله","d":"6 min","v":"Beginner"},"sa-how-are-you":{"t":"Asking How Someone Is","a":"عشانفك","d":"7 min","v":"Beginner"},"sa-bye-inshallah":{"t":"Saying Goodbye","a":"مع السلامه","d":"6 min","v":"Beginner"},"sa-thank-you":{"t":"Thanking Someone","a":"شكرا ويعطيك العافيه","d":"6 min","v":"Beginner"},"sa-introducing-name":{"t":"Saying Your Name","a":"اسمي","d":"6 min","v":"Beginner"},"sa-meeting-new":{"t":"Meeting Someone New","a":"التعرف على شخص جديد","d":"7 min","v":"Beginner"},"sa-taxi-driver":{"t":"Taking a Taxi","a":"اخذ تاكسي","d":"8 min","v":"Beginner"},"sa-market-shopping":{"t":"Shopping at the Market","a":"تسوق بالسوق","d":"8 min","v":"Beginner"},"sa-family-talk":{"t":"Talking About Family","a":"سوالين العايله","d":"8 min","v":"Beginner"},"sa-plans-weekend":{"t":"Weekend Plans","a":"خطط الويكند","d":"7 min","v":"Beginner"},"sa-restaurant-order":{"t":"Ordering at a Restaurant","a":"طلب بالمطعم","d":"8 min","v":"Beginner"},"sa-clarifying-again":{"t":"When You Do Not Understand","a":"اذا ما فهمت","d":"6 min","v":"Beginner"},"sa-coffee-order":{"t":"Ordering Coffee the Saudi Way","a":"طلب قهوه سعودي","d":"7 min","v":"Beginner"},"sa-coffee-sizes":{"t":"Coffee Sizes and Types","a":"انواع القهوه","d":"7 min","v":"Beginner"},"sa-coffee-smalltalk":{"t":"Small Talk at the Coffee Shop","a":"سوالين الكوفي","d":"7 min","v":"Intermediate"},"sa-coffee-pay":{"t":"Paying at the Coffee Shop","a":"الدفع بالكوفي","d":"6 min","v":"Beginner"},"sa-smalltalk-work":{"t":"Small Talk at Work","a":"سوالين الدوام","d":"7 min","v":"Intermediate"},"sa-inviting-friend":{"t":"Inviting a Friend","a":"دعوه صاحب","d":"7 min","v":"Intermediate"},"sa-opinions":{"t":"Giving Your Opinion","a":"ابدا رايك","d":"7 min","v":"Intermediate"},"sa-apologizing":{"t":"Apologizing the Saudi Way","a":"الاعتذار","d":"6 min","v":"Intermediate"},"sa-saying-no-politely":{"t":"Saying No Politely","a":"رفض مودب","d":"7 min","v":"Intermediate"},"sa-describing-day":{"t":"Describing Your Day","a":"وصف يومك","d":"8 min","v":"Intermediate"},"sa-work-greeting":{"t":"Greetings at the Office","a":"تحيه المكتب","d":"6 min","v":"Intermediate"},"sa-meeting-talk":{"t":"Speaking in a Meeting","a":"اللام بالاجتماع","d":"8 min","v":"Intermediate"},"sa-asking-help":{"t":"Asking for Help","a":"طلب المساعده","d":"7 min","v":"Intermediate"},"sa-deadline-talk":{"t":"Deadlines and Timing","a":"المواعيد النهاييه","d":"7 min","v":"Intermediate"},"sa-feedback-saudi":{"t":"Giving Feedback at Work","a":"اعطا ملاحظات","d":"8 min","v":"Intermediate"},"sa-phone-work":{"t":"Work Phone Calls","a":"مكالمات الدوام","d":"8 min","v":"Intermediate"},"sa-family-parents":{"t":"Talking to Parents Respectfully","a":"اللام مع الواعندين","d":"7 min","v":"Beginner"},"sa-family-gathering":{"t":"The Family Gathering","a":"اللمه العايليه","d":"7 min","v":"Beginner"},"sa-family-meals":{"t":"Family Meals","a":"وجبات العايله","d":"7 min","v":"Beginner"},"sa-family-marriage":{"t":"Wedding Talk","a":"سوالين العرس","d":"8 min","v":"Intermediate"},"sa-family-kids":{"t":"Talking About Children","a":"اللام عن الاطفال","d":"7 min","v":"Intermediate"},"sa-family-visit":{"t":"Visiting Relatives","a":"زياره الاقارب","d":"7 min","v":"Beginner"},"sa-hospital-appointment":{"t":"Booking a Doctor Appointment","a":"حجز موعد طبيب","d":"8 min","v":"Intermediate"},"sa-hospital-symptoms":{"t":"Describing Symptoms","a":"وصف الاعراض","d":"8 min","v":"Intermediate"},"sa-hospital-pharmacy":{"t":"At the Pharmacy","a":"عند الصيدليه","d":"7 min","v":"Intermediate"},"sa-hospital-reception":{"t":"At Hospital Reception","a":"استقبال المستشفى","d":"7 min","v":"Intermediate"},"sa-hospital-visit":{"t":"Visiting a Patient","a":"زياره مريض","d":"7 min","v":"Intermediate"},"sa-hospital-emergency":{"t":"In an Emergency","a":"في الطواري","d":"8 min","v":"Intermediate"},"sa-travel-booking":{"t":"Booking a Flight","a":"حجز رحله طيران","d":"8 min","v":"Beginner"},"sa-travel-airport":{"t":"At the Airport","a":"في المطار","d":"8 min","v":"Beginner"},"sa-travel-hotel":{"t":"Checking Into a Hotel","a":"تسجيل الينندق","d":"8 min","v":"Beginner"},"sa-travel-directions":{"t":"Asking for Directions","a":"سوال عن الاتجاهات","d":"7 min","v":"Beginner"},"sa-travel-lost":{"t":"When You Get Lost","a":"لما تضيع","d":"7 min","v":"Beginner"},"sa-travel-flight-delay":{"t":"Flight Delays and Changes","a":"تاخوير الرحلات","d":"7 min","v":"Intermediate"},"sa-mosque-greeting":{"t":"The Mosque Greeting","a":"تحيه المسجد","d":"7 min","v":"Intermediate"},"sa-mosque-wudu":{"t":"Ablution at the Mosque","a":"الوضو بالمسجد","d":"7 min","v":"Intermediate"},"sa-mosque-time":{"t":"Prayer Times","a":"مواقيت الصلاه","d":"7 min","v":"Intermediate"},"sa-mosque-after-prayer":{"t":"After the Prayer","a":"لسه الصلاه","d":"6 min","v":"Intermediate"},"sa-mosque-eid":{"t":"Eid Greetings","a":"تهاني العيد","d":"7 min","v":"Intermediate"},"sa-mosque-ramadan":{"t":"Ramadan Phrases","a":"عبارات رمضان","d":"7 min","v":"Intermediate"},"sa-phone-answer":{"t":"Answering the Phone","a":"الرد على الاتصال","d":"7 min","v":"Intermediate"},"sa-phone-wrong-number":{"t":"Wrong Number","a":"رقم غلط","d":"6 min","v":"Intermediate"},"sa-phone-message":{"t":"Leaving a Message","a":"ترك رساله","d":"7 min","v":"Intermediate"},"sa-phone-callback":{"t":"Calling Back","a":"اعاده الاتصال","d":"6 min","v":"Intermediate"},"sa-phone-busy":{"t":"When Someone Is Busy","a":"لما يكون مشغول","d":"6 min","v":"Intermediate"},"sa-phone-end":{"t":"Ending a Call","a":"انها المكالمه","d":"6 min","v":"Intermediate"},"meeting-someone-new":{"t":"Meeting Someone New","a":"التعرف على شخص جديد","d":"7 min","v":"Beginner"},"ordering-coffee":{"t":"Ordering Coffee","a":"طلب قهوه","d":"9 min","v":"Beginner"},"talking-with-friends":{"t":"Talking With Friends","a":"السوالين مع الاصحاب","d":"8 min","v":"Intermediate"},"going-to-airport":{"t":"Going To The Airport","a":"الذهاب للمطار","d":"8 min","v":"Beginner"},"booking-hotel":{"t":"Booking A Hotel","a":"حجز فندق","d":"9 min","v":"Beginner"}};
  ...
  const QUESTIONS = [
    { key:'q1', multi:true, max:4, id:'goals',
      ...
      sub:{ en:'Pick everything that matters. You can change this later.', ar:'اختر كل شي يهمك. تيمكنر تغيره لسهين.' },
      options:[
        { id:'work', en:'Work', ar:'شغل' },
        { id:'new-job', en:'A new job', ar:'وظيفه جديده' },
        { id:'interviews', en:'Interviews', ar:'مقابلات' },
        { id:'travel', en:'Travel', ar:'سفر' },
        { id:'everyday', en:'Everyday life', ar:'حياتك اليوميه' },
        { id:'study', en:'Study', ar:'دراسه' },
        { id:'university', en:'University', ar:'جامعه' },
        ...
        { id:'media', en:'Understanding movies and shows', ar:'تفهم الوفلام والمسلسلات' },
        { id:'customers', en:'Customer service', ar:'خدمه عملا' },
        { id:'abroad', en:'Living abroad', ar:'تعيش برا' },
        { id:'confidence', en:'Confidence', ar:'ثقه بالنفس' },
    ...
    { key:'q2', multi:true, max:4, id:'abilities',
      ...
      sub:{ en:'These become your learning targets.', ar:'هذي تتحول لاهدافك التعلميه.' },
      options:[
        { id:'speak-no-freeze', en:'Speak without freezing', ar:'تتكلم ببدون ما تجمد' },
        { id:'understand', en:'Understand people more easily', ar:'تفهم الناس اسهل' },
        { id:'stop-translating', en:'Stop translating in my head', ar:'توقف الترجمه براسك' },
        ...
        { id:'order-confidently', en:'Order things confidently', ar:'تطلب بثقه' },
        { id:'ask-help', en:'Ask for help', ar:'تطلب مساعده' },
        { id:'small-talk', en:'Make small talk', ar:'تسولف سوالين خفيفه' },
        { id:'media', en:'Understand English media', ar:'تفهم المحتوى الحينجليزي' },
        { id:'natural', en:'Speak more naturally', ar:'تتكلم بشكل طبيعي' },
        { id:'customers', en:'Communicate with customers', ar:'تتواصل مع الشغلا' },
      ]},
    { key:'q3', multi:true, max:5, id:'contexts',
      title:{ en:'Where will you actually use English?', ar:'وين بتستخدم الحينجليزي فعليا؟' },
      sub:{ en:'This shapes which real-life lessons come first.', ar:'ذا يحدد وش الدروس الشغليه اللي تبدا فيها.' },
      options:[
        ...
        { id:'school', en:'School', ar:'مدرسه' },
        { id:'university', en:'University', ar:'جامعه' },
        { id:'interviews', en:'Interviews', ar:'مقابلات' },
        { id:'friends', en:'Friends', ar:'اصحاب' },
        { id:'everyday', en:'Everyday conversations', ar:'محادثات يوميه' },
        { id:'online', en:'Online', ar:'اونلوين' },
      ]},
    { key:'q4', multi:true, max:4, id:'weaknesses',
      title:{ en:'What feels hardest right now?', ar:'وش اصعب شي عليك الحين؟' },
      sub:{ en:'This tells us where to focus early practice.', ar:'ذا يحدد وين نركز في بدايه التدريب.' },
      options:[
        { id:'speaking', en:'Speaking', ar:'المحادثه' },
        ...
        { id:'writing', en:'Writing', ar:'الكتابه' },
        { id:'finding-words', en:'Finding the right words', ar:'تلاقي الكلمه الصح' },
        { id:'building-sentences', en:'Building sentences', ar:'تبني جمل' },
        { id:'fast-speech', en:'Understanding fast speech', ar:'تفهم اللام السريع' },
        { id:'confidence', en:'Confidence', ar:'الثقه' },
      ]},
    { key:'q5', multi:false, id:'comfort',
      title:{ en:'How comfortable are you with English right now?', ar:'وين تقف مع الحينجليزي الحين؟' },
      sub:{ en:'There is no wrong answer. We start where you are.', ar:'ما فيه جواب غلط. نبدا من وين انت.' },
      options:[
        { id:'none', en:'I know almost no English', ar:'ما اعرف شي تقريب' },
        { id:'basic-words', en:'I know basic words but struggle to make sentences', ar:'اعرف كلمات بس ما ايمكنر اكمل جمله' },
        { id:'simple-convos', en:'I can handle very simple conversations', ar:'ايمكنر احعشان محادثات بسيطه' },
        { id:'understand-more', en:'I understand more than I can speak', ar:'افهم اكثر مما اتكلم' },
        { id:'communicate-mistakes', en:'I can communicate, but I make a lot of mistakes', ar:'اتواصل بس اغلطيي كثيره' },
        { id:'fairly-comfortable', en:'I can speak fairly comfortably', ar:'اتكلم بشكل مريح نوعا ما' },
        { id:'regular', en:'I use English regularly and want to become more natural', ar:'استخدمه باستمرار وابي اكون اكثر طبيعيه' },
      ]},
    { key:'q6', multi:true, max:3, id:'style',
      title:{ en:'How do you like to learn?', ar:'عشانف تحب تتعلم؟' },
      sub:{ en:'This shapes lesson length and format, not what you skip.', ar:'ذا يحدد طول الدروس وشكلها، مو اللي تتغلطه.' },
      options:[
        { id:'short-daily', en:'Short daily practice', ar:'تمرين يومي قصير' },
        { id:'long-sessions', en:'Longer sessions', ar:'جلسات اطول' },
        { id:'conversation-first', en:'Conversation first', ar:'المحادثه اول شي' },
        { id:'listening-first', en:'Listening first', ar:'الاستماع اول شي' },
        { id:'step-by-step-grammar', en:'Step-by-step grammar', ar:'القواعد خطوه خطوه' },
        { id:'vocabulary-first', en:'Vocabulary first', ar:'المفردات اول شي' },
        { id:'real-life', en:'Real-life situations', ar:'مواقف حقيقيه' },
        { id:'speaking-practice', en:'Speaking practice', ar:'تمرين محادثه' },
        { id:'balanced', en:'A balanced mix', ar:'خليط متوازن' },
        { id:'repetition', en:'Repetition and review', ar:'تكرار ومراجعه' },
        { id:'quick-challenges', en:'Quick challenges', ar:'تحديات سريعه' },
      ]},
    { key:'q7', multi:false, id:'dailyMinutes',
      title:{ en:'How much time can you realistically study each day?', ar:'كم تيمكنر تدرس فعليا باليوم؟' },
      sub:{ en:'Be honest. Consistency beats big promises.', ar:'كن صادق مع نفسك. الاستمراريه اهم من الوعود الكبيره.' },
      options:[
        { id:'5', en:'5 minutes', ar:'٥ دقايق' },
        { id:'10', en:'10 minutes', ar:'١٠ دقايق' },
        { id:'15', en:'15 minutes', ar:'١٥ دقيقه' },
        { id:'20', en:'20 minutes', ar:'٢٠ دقيقه' },
        { id:'30', en:'30 minutes', ar:'٣٠ دقيقه' },
        { id:'45', en:'45+ minutes', ar:'٤٥+ دقيقه' },
      ]},
    { key:'q8', multi:false, id:'frequency',
      title:{ en:'How often will you practice?', ar:'كم مره بتتدرب بالاسبوع؟' },
      sub:{ en:'This sets your route pacing.', ar:'ذا يحدد ايقاع مسارك.' },
      options:[
        ...
        { id:'whenever', en:'Whenever I have time', ar:'متى ما ايمكنر', days:3 },
      ]},
    { key:'q9', multi:false, id:'targetOutcome',
      ...
      sub:{ en:'This is your destination. We build toward it.', ar:'ذا وجهتك. نبني نحوه.' },
      options:[
        { id:'everyday-convos', en:'Handle everyday conversations', ar:'تدير محادثاتك اليوميه' },
        { id:'work-confident', en:'Speak confidently at work', ar:'تتكلم بثقه بالدوام' },
        { id:'travel-comfortable', en:'Travel comfortably', ar:'تسافر براحه' },
        { id:'handle-interview', en:'Handle an interview', ar:'تدير مقابله' },
        ...
        { id:'write-confident', en:'Write confidently', ar:'تكتب بثقه' },
        { id:'customers', en:'Communicate with customers', ar:'تتواصل مع الشغلا' },
    ...
    { key:'q10', multi:false, id:'deadline',
      ...
      sub:{ en:'Optional. We never promise a guaranteed result by a date.', ar:'اختياري. ما نعدك بنتيجه مضمونه بتاريخ معاين.' },
      options:[
        { id:'none', en:'No deadline', ar:'ببدون موعد' },
        { id:'trip', en:'Upcoming trip', ar:'رحله قريبه' },
        { id:'interview', en:'Interview coming up', ar:'مقابله قريبه' },
        { id:'new-job', en:'New job', ar:'وظيفه جديده' },
        { id:'school', en:'Starting school', ar:'دراسه قريبه' },
  ...
  const PLACEMENT = [
    { band:'A1', q:{ en:'What is a "book"?', ar:'وش يعني "book"؟' },
      options:[ { en:'Something you read', ar:'شي تقراه' }, { en:'Something you eat', ar:'شي تاكله' }, { en:'A kind of car', ar:'نوع سياره' } ], correct:0 },
    ...
    { band:'B1', q:{ en:'Your manager asks: "Can you handle the client call?" You say...', ar:'مديرك سالك: "Can you handle the client call?" تقول...' },
      options:[ { en:'Yes, I\'ll take it and do my best', ar:'ايه، انا باخذه وببذل قصاشوف جهدي' }, { en:'Give me client', ar:'اعطيني العميل' }, { en:'What is client', ar:'وش هو العميل' } ], correct:0 },
    { band:'B2', q:{ en:'"Despite the delay, we delivered." means...', ar:'"Despite the delay, we delivered." يعني...' },
      options:[ { en:'Even though we were late, we finished', ar:'رغم التاخوير انهينا الشغل' }, { en:'Because we were late, we stopped', ar:'لاننا تاخرنا وقفنا' }, { en:'We replaced the delay', ar:'استبدلنا التاخوير' } ], correct:0 },
    { band:'B2', q:{ en:'A client complains about a mistake. You say...', ar:'عميل اشتكى من غلط. تقول له...' },
      options:[ { en:'I take full responsibility and here is how I\'ll fix it', ar:'اتحمل المسووليه وهذي طريقه حلها' }, { en:'It is not my fault', ar:'مو غلطتي' }, { en:'Sorry maybe', ar:'اسف تيمكنر' } ], correct:0 },
  ];
  ...
  const API = {
    ...
    estimateDuration: function(profile, route, overrides){
      ...
      lessons.forEach(l => {
        ...
        workloadMin += minutesOf(meta && meta.d ? meta.d : '8');
      });
    ...
    unlockState: function(profile, route, state){
      ...
      if(!currentLesson){
        ...
        const last = (route[currentStage].units && route[currentStage].units[0]) || { academyId: '', lessonIds: [] };
    ...
    recommendNext: function(profile, route, state){
      ...
      if(!fit && profile.dailyMinutes <= 10){
        const short = { view:'lessonOfDay', academyId: lesson.academyId, lessonId: lesson.lessonId,
          ...
          whyAr: 'ذا الدرس ياخذ ' + durMin + ' دقايق، اطول شوي من يومك (' + profile.dailyMinutes + ' دقيقه). ابدا فيه وقت ما يكون عندك وقت، او سو مراجعه سريعه اليوم.' };
        return short;
      }
      ...
      if(unit){
        if(stage.theme === 'foundation' && stage.key === 'start-here'){
          ...
          whyAr = 'اخترناه لان كل شي يبني على هذي الاساسيات. اول ما تصير سهله، تنفتح المواقف الحقيقيه.';
          ...
          whyAr = 'اخترناه كتسخين سريع تاخذ فيه الراحه قبل ما يبدا المسار فعليا.';
          ...
          whyAr = 'اخترناه لان ' + (cOpt ? cOpt.ar : 'المواقف الحقيقيه') + ' هي المكان اللي تبي تستخدم فيه الحينجليزي.';
          ...
          whyAr = 'اخترناه لان ' + (wOpt ? wOpt.ar : 'هذي المهاره') + ' من الاشيا اللي تبي تقويها.';
        }
      }
      if(!whyEn){
        whyEn = 'Chosen because it is the next step in your route.';
        whyAr = 'اخترناه لانه الخطوه الجاه في مسارك.';
      }
    ...
    whyPlan: function(profile, route){
      ...
      if(foc.length){
        ...
        linesAr.push('خطتك تركز على ' + foc.map(f => ({Speaking:'المحادثه',Listening:'الاستماع',Vocabulary:'المفردات',Grammar:'القواعد',Pronunciation:'النطق',Writing:'الكتابه'})[f] || f).join(' و ') + ' لانك اخترتها كاولويه ونتيجه التقييم تاكدها.');
      }
      ...
      if(ctx){
        ...
        linesAr.push('دروسك الاولى تغطي ' + profile.realLifeContexts.slice(0, 3).map(c => (ctxOpt(c) || {}).ar || c).join('، ') + ' لانك اخترت هذي المواقف الحقيقيه.');
      }
      linesEn.push('Your pace is built on ' + profile.dailyMinutes + ' minutes a day, ' + profile.weeklyFrequency + ' days a week.');
      linesAr.push('ايقاعك مبني على ' + profile.dailyMinutes + ' دقيقه باليوم، ' + profile.weeklyFrequency + ' ايام بالاسبوع.');
