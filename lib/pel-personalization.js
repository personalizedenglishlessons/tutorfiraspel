...
(function(){
  ...
  const ACADEMY_META = {
    ...
    'american-conversations':  { en:'American Conversations', ar:'المحادثات الامريكيه', icon:'message-circle', from:'#3F8C72', to:'#276b53', diff:'Intermediate', level:'B1' },
    'speaking-studio':         { en:'Speaking Studio', ar:'استوديو المحادثه', icon:'mic-2', from:'#3F8C72', to:'#C8A96A', diff:'Intermediate', level:'B1' },
    'american-accent-lab':     { en:'American Accent Lab', ar:'مختبر اللكنه الامريكيه', icon:'mic', from:'#C8A96A', to:'#D8BD83', diff:'Intermediate', level:'B1' },
  ...
  const QUESTIONS = [
    ...
    { key:'q6', multi:true, max:3, id:'style',
      title:{ en:'How do you like to learn?', ar:'عشان تحب تتعلم؟' },
