/* PEL platform - single authoritative pricing configuration.
   ...
   - Start From 0: 1 month 800 SAR, 2 months 1000 SAR, 3 months 1500 SAR.
  ...
  var PEL_PLANS = {
    ...
    plans: [
      /* ---------- Start From 0 ---------- */
      {
        ...
        badgeAr: '',
        badgeEn: '',
        liveNoteAr: 'حصه مباشره كل اسبوع مشموله معاك. تبغى حصص اكثر؟ اشتري رصيد عن طريق واتساب.',
        liveNoteEn: '1 live class every week is included. Want more? Buy credits via WhatsApp.',
        perMonthAr: 'يعادل 800 ريال شهرياً',
        perMonthEn: 'Equiv. 800 SAR / month',
        featuresAr: [
          'وصول كامل للوحه التحكم والدروس لمده شهر',
          'دروس اساسيه من الصفر، خطوه بخطوه',
          'حصه مباشره كل اسبوع مع الاستاذ فراس',
          'ترجمه فوريه وشرح بالعربي'
        ],
        featuresEn: [
        ...
        waText: 'السلام عليكم، ابي اشترك بخطه ابد من الصفر - شهر (800 ريال). وش طريقه الدفع؟',
        waTextEn: 'Hello, I want the Start From 0 plan - 1 month (800 SAR). How do I pay?'
      },
      {
        ...
        liveNoteAr: 'حصه مباشره كل اسبوع مشموله معاك. تبغى حصص اكثر؟ اشتري رصيد عن طريق واتساب.',
        liveNoteEn: '1 live class every week is included. Want more? Buy credits via WhatsApp.',
        perMonthAr: 'يعادل 500 ريال شهرياً',
        perMonthEn: 'Equiv. 500 SAR / month',
        featuresAr: [
          'كل مزايا باقه الشهر',
          'وصول كامل للمنصه لمده شهرين',
          'حصه مباشره كل اسبوع مع الاستاذ فراس',
          'ترجمه فوريه ومراجعه كتابه وتمارين تفاعليه'
        ],
        featuresEn: [
        ...
        waText: 'السلام عليكم، ابي اشترك بخطه ابد من الصفر - شهرين (1000 ريال). وش طريقه الدفع؟',
        waTextEn: 'Hello, I want the Start From 0 plan - 2 months (1000 SAR). How do I pay?'
      },
      {
        ...
        perMonthEn: 'Equiv. 500 SAR / month',
        featuresAr: [
          'كل مزايا باقه الشهرين',
          'وصول كامل للمنصه لمده 3 اشهر',
          'حصه مباشره كل اسبوع + متابعه تيمكنمك',
          'ترجمه فوريه ومراجعه كتابه وتمارين تفاعليه + شهاده اتمام'
        ],
        featuresEn: [
        ...
        waText: 'السلام عليكم، ابي اشترك بخطه ابد من الصفر - 3 اشهر (1500 ريال). وش طريقه الدفع؟',
        waTextEn: 'Hello, I want the Start From 0 plan - 3 months (1500 SAR). How do I pay?'
      },
      ...
      /* ---------- Exam Prep (STEP / TOEFL / IELTS) ---------- */
      {
        ...
        featuresAr: [
          ...
          'اساله محاكاه للامتحان',
          'حصه مباشره كل اسبوع مع الاستاذ فراس',
          'وحدات مصطلحات مستهدفه وترجمه فوريه'
        ],
        featuresEn: [
      ...
      },
      {
        ...
        badgeAr: 'ثاني الاكثر طلباً',
        badgeEn: '2nd Most Popular',
        liveNoteAr: 'حصتان مباشرتان كل اسبوع مشمولات معاك. تبغى حصص اكثر؟ اشتري رصيد عن طريق واتساب.',
        ...
        featuresAr: [
          'كل مزايا باقه الشهر للتجهيز',
          'وصول كامل لمسارات الاختبارات لمده شهرين',
          'حصتان مباشرتان كل اسبوع مع الاستاذ فراس',
          'اساله محاكاه + وحدات مصطلحات مستهدفه'
        ],
        featuresEn: [
        ...
        waText: 'السلام عليكم، ابي اشترك بخطه التجهيز للاختبارات - شهرين (1300 ريال، فيها حصتان مباشرتان كل اسبوع). وش طريقه الدفع؟',
      ...
      },
      {
        ...
        badgeAr: 'افضل قيمه',
        badgeEn: 'Best value',
        liveNoteAr: '3 حصص مباشره كل اسبوع مشموله معاك. تبغى اكثر؟ اشتري رصيد عن طريق واتساب.',
        ...
        featuresAr: [
          'كل مزايا باقه الشهرين للتجهيز',
          'وصول كامل لمسارات الاختبارات لمده 3 اشهر',
          '3 حصص مباشره كل اسبوع مع الاستاذ فراس',
          'اساله محاكاه + مصطلحات مستهدفه + شهاده اتمام'
        ],
        featuresEn: [
        ...
        waText: 'السلام عليكم، ابي اشترك بخطه التجهيز للاختبارات - 3 اشهر (2200 ريال، فيها 3 حصص مباشره كل اسبوع). وش طريقه الدفع؟',
