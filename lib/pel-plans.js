  ...
  var PEL_PLANS = {
    ...
    plans: [
      /* ---------- Start From 0 ---------- */
      {
        ...
        badgeAr: '',
        badgeEn: '',
        liveNoteAr: 'حصه مباشره كل اسبوع مشمولة معك. تبغى حصص اكثر؟ اشتري رصيد عن طريق واتساب.',
        ...
        featuresAr: [
          ...
          'دروس اساسية من الصفر، خطوه بخطوه',
      ...
      },
      {
        ...
        featuresAr: [
          'كل مزايا باقة الشهر',
          'وصول كامل للمنصه لمدة شهرين',
          'حصه مباشره كل اسبوع مع الاستاذ فراس',
          'ترجمة فورية ومراجعه كتابه وتمارين تفاعلية'
        ],
        featuresEn: [
      ...
      },
      {
        ...
        featuresAr: [
          ...
          'وصول كامل للمنصه لمدة 3 اشهر',
          'حصه مباشره كل اسبوع + متابعة تقدمك',
          'ترجمة فورية ومراجعه كتابه وتمارين تفاعلية + شهاده اتمام'
        ],
        featuresEn: [
      ...
      /* ---------- Exam Prep (STEP / TOEFL / IELTS) ---------- */
      {
        ...
        featuresAr: [
          ...
          'اساله محاكاة للامتحان',
          'حصه مباشره كل اسبوع مع الاستاذ فراس',
          'وحدات مصطلحات مستهدفه وترجمة فورية'
        ],
        featuresEn: [
      ...
      },
      {
        ...
        featuresAr: [
          ...
          'اساله محاكاة + وحدات مصطلحات مستهدفه'
        ],
        featuresEn: [
      ...
      },
      {
        ...
        badgeAr: 'افضل قيمه',
        badgeEn: 'Best value',
        liveNoteAr: '3 حصص مباشره كل اسبوع مشمولة معك. تبغى اكثر؟ اشتري رصيد عن طريق واتساب.',
        ...
        featuresAr: [
          ...
          'اساله محاكاة + مصطلحات مستهدفه + شهاده اتمام'
        ],
        featuresEn: [
