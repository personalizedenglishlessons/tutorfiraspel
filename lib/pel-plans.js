  ...
  var PEL_PLANS = {
    ...
    plans: [
      /* ---------- Start From 0 ---------- */
      {
        ...
        waText: 'السلام عليكم، ابي اشترك بخطة ابد من الصفر - شهر (500 ريال). وش طريقة الدفع؟',
        waTextEn: 'Hello, I want the Start From 0 plan - 1 month (500 SAR). How do I pay?'
      },
      {
        ...
        liveNoteAr: 'حصة مباشرة كل اسبوع مشمولة معك. تبغى حصص اكثر؟ اشتري رصيد عن طريق واتساب.',
        liveNoteEn: '1 live class every week is included. Want more? Buy credits via WhatsApp.',
        perMonthAr: 'يعادل 435 ريال شهرياً',
        perMonthEn: 'Equiv. 435 SAR / month',
        featuresAr: [
          'كل مزايا باقة الشهر',
        ...
        waText: 'السلام عليكم، ابي اشترك بخطة ابد من الصفر - شهرين (870 ريال). وش طريقة الدفع؟',
        waTextEn: 'Hello, I want the Start From 0 plan - 2 months (870 SAR). How do I pay?'
      },
      {
        ...
        liveNoteAr: 'حصة مباشرة كل اسبوع مشمولة معك. تبغى حصص اكثر؟ اشتري رصيد عن طريق واتساب.',
        liveNoteEn: '1 live class every week is included. Want more? Buy credits via WhatsApp.',
        perMonthAr: 'يعادل 317 ريال شهرياً',
        perMonthEn: 'Equiv. 317 SAR / month',
        featuresAr: [
        ...
        waText: 'السلام عليكم، ابي اشترك بخطة ابد من الصفر - 3 اشهر (950 ريال). وش طريقة الدفع؟',
        waTextEn: 'Hello, I want the Start From 0 plan - 3 months (950 SAR). How do I pay?'
      },
