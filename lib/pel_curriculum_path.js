...
(function(){
  ...
  function renderTools(){
    var tools = [
      ...
      {view:'speaking', en:'Speaking', ar:'المحادثة', icon:'messages-square'},
      {view:'reading', en:'Reading', ar:'القراة', icon:'book-text'},
      {view:'writing', en:'Writing', ar:'الكتابة', icon:'pen-line'},
      {view:'review', en:'Smart Review', ar:'المراجعة الذكية', icon:'rotate-ccw'},
