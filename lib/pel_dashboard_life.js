...
window.PEL_DASH_LIFE_FACTORY = function (Deps) {
  ...
  var TOOLS = [
    ...
    { view: 'review', en: 'Smart Review', ar: 'المراجعه', icon: 'rotate-ccw', subEn: 'Due cards', subAr: 'بطاقات مستحقة' },
    { view: 'bookmarks', en: 'Bookmarks', ar: 'المفضله', icon: 'bookmark', subEn: 'Marked lessons', subAr: 'دروس موشرة' },
  ...
  function buildWordBurst() {
    ...
    card.innerHTML =
      '<div style="display:flex;align-items:center;gap:10px;margin-bottom:12px;">' +
        ...
        '<span class="eyebrow" style="margin:0;">' + L('Word Burst', 'كلمه لحظية') + '</span>' +
