...
window.PEL_DASH_LIFE_FACTORY = function (Deps) {
  ...
  function buildWordBurst() {
    ...
    card.innerHTML =
      ...
      '</div>' +
      '<div class="pel-dash-burst-word" style="font-size:1.6rem;font-weight:700;font-family:\'Fraunces\',serif;letter-spacing:-.01em;direction:ltr;"></div>' +
      '<div class="pel-dash-burst-tr" style="font-size:.85rem;color:var(--gold-soft);margin-top:2px;direction:ltr;"></div>' +
      '<div class="pel-dash-burst-ar arabic" style="font-size:1.2rem;margin-top:4px;"></div>';
    // Insert Word Burst AFTER hero card so the Start Lesson card stays at the top
    var hero = document.getElementById('heroCard');
    if (hero) hero.insertAdjacentElement('afterend', card);
    else { var cc = document.getElementById('ccBlock'); if (cc) cc.insertAdjacentElement('afterend', card); else home.insertBefore(card, home.firstChild); }
