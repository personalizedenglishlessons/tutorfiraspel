...
window.PEL_DASH_LIFE_FACTORY = function (Deps) {
  ...
  function buildToolsStrip() {
    ...
    // Anchor to ccBlock (the container) rather than heroCard (a child inside it).
    // When heroCard is the only child of ccBlock, heroCard.nextSibling is null,
    // which would cause the fallback to insert at home.firstChild (wrong position).
    var anchorEl = document.getElementById('ccBlock') || hero;
