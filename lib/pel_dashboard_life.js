...
window.PEL_DASH_LIFE_FACTORY = function (Deps) {
  ...
  var TOOLS = [
    ...
    { view: 'reading', en: 'Reading', ar: 'القرا', icon: 'book-text', subEn: 'Read passages', subAr: 'اقرا النصوص' },
    { view: 'writing', en: 'Writing', ar: 'الكتابة', icon: 'pen-line', subEn: 'Write & check', subAr: 'رتب وتفحص' },
