    ...
    strip.querySelectorAll('.pel-dash-tool').forEach(function (b) {
      b.addEventListener('click', function () {
        if (b.classList.contains('locked')) {
          try { if (typeof toast === 'function') toast(ar() ? '<span class="arabic">كمل دروس اكثر عشان يفتح</span>، <span dir="ltr">Complete more lessons to unlock this tool.</span>' : 'Complete more lessons to unlock this tool.'); } catch (e) {}
          return;
        }
