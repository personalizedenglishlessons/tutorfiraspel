...
window.PEL_DASH_LIFE_FACTORY = function (Deps) {
  ...
  var TOOLS = [
    ...
    { view: 'review', en: 'Smart Review', ar: 'المراجعة', icon: 'rotate-ccw', subEn: 'Due cards', subAr: 'بطاقات مستحقة' },
    ...
    { view: 'grammar', en: 'Grammar', ar: 'القواعد', icon: 'spell-check', subEn: 'Fix mistakes', subAr: 'صحح الاخطا' },
    { view: 'listening', en: 'Listening', ar: 'الاستماع', icon: 'headphones', subEn: 'Hear & answer', subAr: 'اسمع وجاوب' },
    { view: 'reading', en: 'Reading', ar: 'القراة', icon: 'book-text', subEn: 'Read passages', subAr: 'اقرا النصوص' },
    { view: 'writing', en: 'Writing', ar: 'الكتابة', icon: 'pen-line', subEn: 'Write & check', subAr: 'اكتب وتفحص' },
    { view: 'speaking', en: 'Speaking', ar: 'المحادثة', icon: 'messages-square', subEn: 'Talk it out', subAr: 'تكلم' }
  ];
  var ICON_SVG = {
