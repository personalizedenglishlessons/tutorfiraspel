...
(function () {
  ...
  var TOOLS = [
    ...
    { view: 'bookmarks', en: 'Bookmarks', ar: 'المفضلة', icon: 'bookmark', subEn: 'Marked lessons', subAr: 'دروس مؤشرة', minDone: 6 },
    { view: 'pronunciation', en: 'Pronunciation', ar: 'النطق', icon: 'mic', subEn: 'Speak & score', subAr: 'انطق وسجل', minDone: 0 },
    { view: 'grammar', en: 'Grammar', ar: 'القواعد', icon: 'spell-check', subEn: 'Fix mistakes', subAr: 'صحح الأخطاء', minDone: 0 },
    { view: 'listening', en: 'Listening', ar: 'الاستماع', icon: 'headphones', subEn: 'Hear & answer', subAr: 'اسمع وجاوب', minDone: 0 },
    { view: 'reading', en: 'Reading', ar: 'القراءة', icon: 'book-text', subEn: 'Read passages', subAr: 'اقرأ النصوص', minDone: 0 },
    ...
    strip.querySelectorAll('.pel-dash-tool').forEach(function (b) {
      b.addEventListener('click', function () {
        if (b.classList.contains('locked')) {
          try { if (typeof toast === 'function') toast(ar() ? '<span class="arabic">كمل دروس أكثر عشان يفتح</span>، Complete more lessons to unlock this tool.' : 'Complete more lessons to unlock this tool.'); } catch (e) {}
          return;
        }
