...
window.PEL_DASH_LIFE_FACTORY = function (Deps) {
  ...
  function buildWordBurst() {
    ...
    // Insert Word Burst BEFORE hero card so it appears at the top of the page
    var hero = document.getElementById('heroCard');
    if (hero) hero.insertAdjacentElement('beforebegin', card);
    else { var cc = document.getElementById('ccBlock'); if (cc) cc.insertAdjacentElement('beforebegin', card); else home.insertBefore(card, home.firstChild); }
