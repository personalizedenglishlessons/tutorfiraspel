...
html[data-theme="light"] .pel-act-card-inner{background:var(--card);border-color:var(--border);box-shadow:0 8px 30px -16px rgba(40,28,12,.12);}
html[data-theme="light"] .pel-teach-word{background:var(--card-elevated);border-color:var(--border);}
html[data-theme="light"] .pel-teach-grammar{background:rgba(184,131,26,.06);border-color:rgba(184,131,26,.16);}
html[data-theme="light"] .pel-act-hint{background:var(--card-elevated);}
html[data-theme="light"] .pel-option{background:var(--card-elevated);border-color:var(--border);}
html[data-theme="light"] .pel-option:hover{border-color:rgba(184,131,26,.4);background:var(--card);}
html[data-theme="light"] .pel-option.correct{border-color:var(--success);background:rgba(47,138,87,.08);}
html[data-theme="light"] .pel-option.wrong{border-color:var(--danger);background:rgba(184,85,85,.08);}
html[data-theme="light"] .pel-act-primary{background:linear-gradient(135deg,#D4AE50,var(--gold) 50%,var(--bronze));color:#1A1712;box-shadow:0 6px 20px -8px rgba(184,131,26,.4);}
html[data-theme="light"] .pel-act-primary:hover{filter:brightness(1.03);box-shadow:0 8px 26px -8px rgba(184,131,26,.5);}
html[data-theme="light"] .pel-stage-back:hover{background:var(--card-elevated);}
html[data-theme="light"] .pel-conv-line.A{background:var(--card-elevated);}
html[data-theme="light"] .pel-conv-line.B{background:rgba(184,131,26,.1);border-color:rgba(184,131,26,.2);}
html[data-theme="light"] .pel-token{background:var(--card-elevated);border-color:var(--border);}
html[data-theme="light"] .pel-tile{background:var(--card-elevated);border-color:var(--border);}
html[data-theme="light"] .pel-input{background:var(--card-elevated);border-color:var(--border);}
html[data-theme="light"] .pel-arrange-drop{border-color:var(--border);}
html[data-theme="light"] .pel-concept-ex{background:rgba(184,131,26,.05);border-color:rgba(184,131,26,.14);}
html[data-theme="light"] .pel-concept-step{background:var(--card-elevated);border-color:var(--border);}
html[data-theme="light"] .pel-teach-glossary-item{background:var(--card-elevated);border-color:var(--border);}
html[data-theme="light"] .pel-stage-done .pel-done-row .pel-tool-link{background:var(--card-elevated);border-color:var(--border);}
html[data-theme="light"] .pel-act-primary.ghost{background:transparent;color:var(--text);border-color:var(--border);}
