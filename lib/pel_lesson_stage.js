...
html[data-theme="light"] .pel-act-card-inner{background:#FFFFFF;border-color:#D2D2D7;box-shadow:0 1px 3px rgba(0,0,0,.04);}
html[data-theme="light"] .pel-teach-word{background:#FAFAFA;border-color:#D2D2D7;}
html[data-theme="light"] .pel-teach-grammar{background:rgba(139,108,47,.05);border-color:rgba(139,108,47,.12);}
html[data-theme="light"] .pel-act-hint{background:#FAFAFA;}
html[data-theme="light"] .pel-option{background:#FAFAFA;border-color:#D2D2D7;}
html[data-theme="light"] .pel-option:hover{border-color:#86868B;background:#FFFFFF;}
html[data-theme="light"] .pel-option.correct{border-color:#1D7A4E;background:rgba(29,122,78,.06);}
html[data-theme="light"] .pel-option.wrong{border-color:#B8442E;background:rgba(184,68,46,.06);}
html[data-theme="light"] .pel-act-primary{background:#8B6C2F;color:#FFFFFF;box-shadow:none;}
html[data-theme="light"] .pel-act-primary:hover{filter:brightness(1.05);box-shadow:0 2px 8px rgba(0,0,0,.1);}
html[data-theme="light"] .pel-stage-back:hover{background:#FAFAFA;}
html[data-theme="light"] .pel-conv-line.A{background:#FAFAFA;}
html[data-theme="light"] .pel-conv-line.B{background:rgba(139,108,47,.08);border-color:rgba(139,108,47,.12);}
html[data-theme="light"] .pel-token{background:#FAFAFA;border-color:#D2D2D7;}
html[data-theme="light"] .pel-tile{background:#FAFAFA;border-color:#D2D2D7;}
html[data-theme="light"] .pel-input{background:#FAFAFA;border-color:#D2D2D7;}
html[data-theme="light"] .pel-arrange-drop{border-color:#D2D2D7;}
html[data-theme="light"] .pel-concept-ex{background:rgba(139,108,47,.04);border-color:rgba(139,108,47,.1);}
html[data-theme="light"] .pel-concept-step{background:#FAFAFA;border-color:#D2D2D7;}
html[data-theme="light"] .pel-teach-glossary-item{background:#FAFAFA;border-color:#D2D2D7;}
html[data-theme="light"] .pel-stage-done .pel-done-row .pel-tool-link{background:#FAFAFA;border-color:#D2D2D7;}
html[data-theme="light"] .pel-act-primary.ghost{background:transparent;color:var(--text);border-color:#D2D2D7;}
