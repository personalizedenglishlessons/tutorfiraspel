...
@media(max-width:680px){
  ...
  var PRON_HINTS = {
    ...
    'the': { beats:1, ar:'مقطع واحد: ذا - خفيفة وسريعة', avoid:'لا تقول: ده او ذي' },
    ...
    'those': { beats:1, ar:'مقطع واحد: ذوز - تبدا بـ ذ مو د', avoid:'لا تقول: دوز او دو-ز' },
    'there': { beats:1, ar:'مقطع واحد: ذير - تبدا بـ ذ مو د', avoid:'لا تقول: دير' },
    'their': { beats:1, ar:'مقطع واحد: ذير - مثل there', avoid:'لا تقول: دير' },
    'then': { beats:1, ar:'مقطع واحد: ذِن - TH هنا صوتها ذ', avoid:'لا تقول: دِن' },
    'with': { beats:1, ar:'مقطع واحد: وِذ - اخرها TH ناعمة', avoid:'لا تقول: وِت' },
    'three': { beats:1, ar:'مقطع واحد: ثري - طرف اللسان بين الاسنان', avoid:'لا تقول: تري او سري' },
    'think': { beats:1, ar:'مقطع واحد: ثِنك - TH خفيفة من بين الاسنان', avoid:'لا تقول: تنك او سنك' },
    ...
    'speak': { beats:1, ar:'مقطع واحد: سپيك - SP مع بعض و P مو B', avoid:'لا تقول: اسبيك او سبيك' },
    ...
    'have': { beats:1, ar:'مقطع واحد: هاڤ - اخرها V', avoid:'لا تقول: هاف' },
    'five': { beats:1, ar:'مقطع واحد: فايف - اخرها V خفيفة', avoid:'لا تقول: فايف بقوة F' },
    'seven': { beats:2, ar:'مقطعين: سِ-ڤن - V في النص', avoid:'لا تقول: سِفن' },

    // --- Consonant clusters (Arabic adds a vowel before s-clusters) ---
    'school': { beats:1, ar:'مقطع واحد: سكول - ابدا بـ S مباشرة', avoid:'لا تقول: اسكول' },
    'student': { beats:2, ar:'مقطعين: ستو-دنت - ابدا بـ ST مباشرة', avoid:'لا تقول: استودنت' },
    ...
    'question': { beats:2, ar:'مقطعين: كوس-چن - اخرها چن', avoid:'لا تقول: كويستيون' },

    // --- Diphthongs and long vowels ---
    'name': { beats:1, ar:'مقطع واحد: نيم - A هنا مثل اي طويلة', avoid:'لا تقول: نام' },
    'day': { beats:1, ar:'مقطع واحد: ديي - طويلة شوي', avoid:'لا تقول: داي قصيرة' },
    'rain': { beats:1, ar:'مقطع واحد: رين - AI مثل اي طويلة', avoid:'لا تقول: راين' },
    ...
    'about': { beats:2, ar:'مقطعين: ا-باوت - لا تضغط اول حرف', avoid:'لا تقول: ابَوت' },
    ...
    'hour': { beats:1, ar:'مقطع واحد: اور - H ساكت', avoid:'لا تقول: هاور' },
    'walked': { beats:1, ar:'مقطع واحد: ووكت - ED هنا صوتها T', avoid:'لا تقول: ووكد او ووكدِد' },
  ...
  var PRON_PATTERNS = [
    ...
    { test:/^str\w/i, hint:{ beats:1, ar:'STR مع بعض - ابدا بـ S ثم T ثم R بسرعة', avoid:'لا تضيف ا قبل الـ S' } },
    // s + stop clusters: Arabic speakers add ا/ا before s
    { test:/^(sp|st|sk|sm|sn)\w/i, hint:{ beats:1, ar:'ابدا بحرف S مع الحرف اللي بعده مباشرة بدون ما تضيف صوت قبلها', avoid:'لا تضيف ا او ا قبل الـ S' } },
    // ph → F
    { test:/^ph/i, hint:{ beats:1, ar:'PH تنطق F - لا تستخدم P', avoid:'لا تنطقها پ' } },
    // kn → silent K
    { test:/^kn/i, hint:{ beats:1, ar:'K ساكت - ابدا بالنون مباشرة', avoid:'لا تنطق الـ K' } },
    // wr → silent W
    { test:/^wr/i, hint:{ beats:1, ar:'W ساكت - ابدا بالراء مباشرة', avoid:'لا تنطق الـ W' } },
    // -tion ending → شن
    { test:/tion$/i, hint:{ beats:0, ar:'اخرها -tion تنطق شن مثل question', avoid:'لا تنطقها تيون او سيون' } }
  ];
