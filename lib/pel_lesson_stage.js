...
html[data-theme="light"] .pel-teach-word{background:linear-gradient(135deg, rgba(139,108,47,.04), transparent 60%), var(--card-elevated);border-color:var(--border);}
html[data-theme="light"] .pel-teach-grammar{background:rgba(139,108,47,.05);border-color:rgba(139,108,47,.12);}
...
html[data-theme="light"] .pel-option:hover{border-color:rgba(139,108,47,.35);background:linear-gradient(180deg, rgba(139,108,47,.04), transparent 50%), var(--card);}
...
html[data-theme="light"] .pel-act-primary{background:linear-gradient(135deg, #9A7B3E, var(--gold) 50%, var(--bronze));color:#FFFFFF;box-shadow:inset 0 1px 0 rgba(255,255,255,.2), 0 4px 14px -6px rgba(139,108,47,.4);}
html[data-theme="light"] .pel-act-primary:hover{filter:brightness(1.03);box-shadow:inset 0 1px 0 rgba(255,255,255,.25), 0 0 32px -8px rgba(139,108,47,.3), 0 8px 24px -8px rgba(139,108,47,.45);}
...
html[data-theme="light"] .pel-conv-line.B{background:linear-gradient(180deg, rgba(139,108,47,.06), transparent 50%), var(--card-elevated);border-color:rgba(139,108,47,.12);}
...
html[data-theme="light"] .pel-concept-ex{background:rgba(139,108,47,.04);border-color:rgba(139,108,47,.1);}
