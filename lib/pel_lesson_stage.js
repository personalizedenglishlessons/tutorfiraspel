...
@media(max-width:680px){
  ...
  var TEACHING_CONTENT = {
    ...
    'is': {
      meaning: 'تستخدم مع he/she/it — مثل: He is = هو',
    ...
    'are': {
      meaning: 'تستخدم مع we/you/they — مثل: You are = انت',
    ...
    'do': {
      meaning: 'كلمة مساعدة للاسئلة والنفي في الحاضر',
    ...
    'not': {
      ...
      dontUseWhen: 'لا تستخدمها لوحدها — دايماً مع كلمة مساعدة',
      commonMistake: 'وضع not في المكان الخطأ',
      howToAvoid: 'not تجي بعد الكلمة المساعدة: am not, is not, are not',
  ...
  var FUNCTION_WORDS = {
    'do':'كلمة مساعدة للاسئلة','does':'كلمة مساعدة مع he/she/it','did':'كلمة مساعدة للماضي',
