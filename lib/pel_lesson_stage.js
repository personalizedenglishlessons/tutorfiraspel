      ...
      turns:[
        {
          ...
          options:[
            { text:'Here you are.', ok:true, whyAr:'ممتاز! Here you are طريقه مهذبه وطبيعيه لتقديم شي.', outcomeAr:'الموظف: "Thank you. Where are you flying today?"' },
      ...
      try{
        ...
        if(saved){
          if(typeof saved.i==='number' && saved.i>0 && saved.i<this.state.seq.length){
            ...
            try{ if(typeof toast==='function'){ toast(L('Welcome back! Your progress was saved.','مرحباًرجوع! تقدّمك محفوظ.'), 'info'); } }catch(e){}
          }
