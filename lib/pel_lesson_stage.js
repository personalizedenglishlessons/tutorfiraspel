...
@media(max-width:680px){
  ...
  const PEL_MIN_PAIRS = [
    ...
    { contrast:'th vs s', target:'thank', confusion:'sank', ar:'شكرا', tipAr:'نفس الفكرة، اللسان يطلع برا بين الاسنان.' },
    { contrast:'th vs z', target:'this', confusion:'zis', ar:'هذا', tipAr:'TH الصوت الثاني (ذ) يطلع من بين الاسنان، Z من خلفها.' },
  ...
  const PEL_INTONATION_EX = [
    { sentence:'Are you coming', question:'Are you coming?', statement:'You are coming.',
      ar:'انت جاي', questionMeaning:'سوال', statementMeaning:'جملة خبرية' },
    { sentence:'Is she here', question:'Is she here?', statement:'She is here.',
      ar:'هي هنا', questionMeaning:'سوال', statementMeaning:'جملة خبرية' },
    { sentence:'Do you like it', question:'Do you like it?', statement:'You like it.',
      ar:'يعجبك', questionMeaning:'سوال', statementMeaning:'جملة خبرية' },
    { sentence:'Are they ready', question:'Are they ready?', statement:'They are ready.',
      ar:'هم جاهزين', questionMeaning:'سوال', statementMeaning:'جملة خبرية' },
  ];
  ...
  const PEL_WRITING_PROMPTS = [
    ...
    { ar:'رتب: انا من السعودية.', en:'I am from Saudi Arabia.', answer:'I am from Saudi Arabia.', hint:'Capitalize country name.', keywords:['saudi','arabia','السعودية','country','بلد'] },
    { ar:'رتب: كيف حالك؟', en:'How are you?', answer:'How are you?', hint:'Question mark in English is ?', keywords:['how are you','كيف حالك','greeting','تحية'] },
    ...
    { ar:'رتب: انا طالب.', en:'I am a student.', answer:'I am a student.', hint:'Use a before student.', keywords:['student','طالب','school','مدرسة'] },
    { ar:'رتب: انا ابي قهوة.', en:'I want coffee.', answer:'I want coffee.', hint:'No need for please here.', keywords:['coffee','قهوة','want','ابي','order','طلب'] },
  ...
  const PEL_SCENARIO_TASKS = [
    {
      ...
      turns:[
        ...
        },
        {
          ...
          options:[
            { text:'Thank you. Goodbye.', ok:true, whyAr:'ممتاز! شكرت وودعت. طريقة مهذبة لانها المكالمة.', outcomeAr:'تم حجز الموعد. احسنت!' },
    ...
    },
    {
      ...
      contextAr:'انت في كافيه. الكاشير سالك وش تبي. لازم تطلب قهوة.',
      turns:[
        {
        ...
        },
        {
          ...
          options:[
            ...
            { text:'Whatever.', ok:false, whyAr:'Whatever وقحة. قل: Thank you. مهذب دايما.', outcomeAr:'الباريستا: "...Have a nice day."' },
          ],
        },
      ],
    },
    {
      id:'directions',
      goal:{ en:'Ask for directions to the nearest pharmacy', ar:'اسال عن طريق اقرب صيدلية' },
      contextAr:'انت في الشارع. راح لشخص وسالته عن الصيدلية. لازم تعرف الوين.',
      turns:[
        {
          ...
          options:[
            ...
            { text:'Where?', ok:false, whyAr:'Where? وحدة قصيرة. قل: Where is it? اكمل السوال.', outcomeAr:'الشخص: "Sorry? Where what?"' },
        ...
        },
        {
          ...
          options:[
            { text:'Thank you. Is it far from here?', ok:true, whyAr:'ممتاز! شكرت وسالت سوال متابع. طريقة طبيعية للمحادثة.', outcomeAr:'الشخص: "No, just two minutes walk."' },
            { text:'How far?', ok:false, whyAr:'How far? قصيرة. قل: How far is it? كمل السوال.', outcomeAr:'الشخص: "Not far."' },
        ...
        },
        {
          ...
          options:[
            { text:'Thank you so much!', ok:true, whyAr:'ممتاز! شكرت بحرارة. طريقة ممتازة لانها المحادثه.', outcomeAr:'وصلت الصيدلية. احسنت!' },
      ...
      turns:[
        {
          ...
          options:[
            { text:'Here you are.', ok:true, whyAr:'ممتاز! Here you are طريقة مهذبة وطبيعية لتقديم شي.', outcomeAr:'الموظف: "Thank you. Where are you flying today?"' },
  ...
  function buildSequence(lesson, lessonId){
    ...
    if(typeof PEL_INTONATION_EX !== 'undefined' && PEL_INTONATION_EX.length){
      ...
      if(/question|intonation|rise|fall|interrogat|سوال|نبرة|استفسار/.test(_lessonTextInt)){
  ...
  function connectionNoteFor(act){
    ...
    if(/\b(a|an|the)\s+(big|small|red|blue|green|white|black|new|old|good|nice|beautiful|happy|sad|tired|hungry|good|great|long|short|tall|young|old|rich|poor|strong|weak|fast|slow|clean|dirty|empty|full|open|close|hot|cold|warm|cool|dry|wet|hard|soft|heavy|light|sharp|dull|smooth|rough|flat|round|square|deep|shallow|wide|narrow|thick|thin|bright|dark)\s+\w+/i.test(text)){
      return 'بالعربي الصفة تجي بعد الاسم: سيارة حمرا. بالانجليزي الصفة تجي قبل الاسم: a red car. الترتيب: a/an/the + كلمة وصف + الاسم. مثال: a big house = بيت كبير، the new car = السيارة الجديدة';
    }
  ...
  const RENDERERS = {
    ...
    spell(inner, act, ctx){
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        ...
        var fb = correct ? '' : L('Correct spelling: ','التهجيه الصحيحة: ')+esc(it.en);
    ...
    db_spell(inner, act, ctx){
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        ...
        var fb = correct ? '' : L('Correct spelling: ','التهجيه الصحيحة: ')+esc(p.answer);
        ctx.self.mark(ctx, correct, false, fb);
      });
      ctx.btn.disabled = true;
    },
    db_translate(inner, act, ctx){
      ...
      if(hb) hb.onclick=()=>{ if(hr){
        ...
        if(p.source_tr){
          ...
          hintHTML = '<div class="pel-act-translit"><span class="arabic">رتب نفس المعنى. ابدا بكلمة الفعل، بعدين كمل بقية الجملة.</span></div>';
        }
    ...
    mistake_coach(inner, act, ctx){
      ...
      const renderTip = () => {
        inner.innerHTML = `
          <div class="pel-act-prompt">${L('Common Saudi Mistake','غلطة شايعة عند السعوديين')}</div>
      ...
      inner.innerHTML = `
        ...
        <div style="display:flex;gap:12px;margin-bottom:16px;">
          ...
          <div style="flex:1;text-align:center;padding:16px;border:2px solid var(--danger);border-radius:12px;background:rgba(231,76,60,.06);">
            ...
            <div class="arabic" style="font-size:.85rem;color:var(--text-muted);">${L('Common mistake','غلطة شايعة')}</div>
    ...
    intonation(inner, act, ctx){
      ...
      inner.innerHTML = `
        <div class="pel-act-prompt">${L('Question or statement?','سوال ولا جملة؟')}</div>
        <div class="pel-act-hint arabic" style="margin-bottom:14px;">${L('Hear both sentences, then pick which is the question.','اسمع الجملتين، بعدين اختر اي وحدة سوال.')}</div>
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        ...
        const why = correct
          ? Lt('Correct! ' + (questionFirst ? 'Sentence 1' : 'Sentence 2') + ' is the question: Are you...? Do you...?', 'صح! ' + (questionFirst ? 'جملة 1' : 'جملة 2') + ' هي السوال: Are you...? Do you...?')
          : Lt('Questions use different word order: Are you...? Do you...? The question was ' + (questionFirst ? 'Sentence 1' : 'Sentence 2') + '.', 'الاساله بالانجليزي تغير ترتيب الكلمات: Are you...? Do you...? السوال كان ' + (questionFirst ? 'جملة 1' : 'جملة 2') + '.');
    ...
    writing_practice(inner, act, ctx){
      ...
      inner.innerHTML = `
        <div class="pel-act-prompt">${L('Build the sentence','رتب الجملة')}</div>
  ...
  var TEACHING_CONTENT = {
    ...
    'at': {
      ...
      howToAvoid: 'at = نقطة (باب، ساعة، عنوان)، in = فضا (مدينة، غرفة)',
      remember: 'at = نقطة محددة، in = فضا واسع'
    },
    ...
    'no': {
      ...
      howToAvoid: 'no = رفض (سوال)، not = نفي (جملة)',
  ...
  const PROMPTS_DEF = {
    ...
    spell:['Spell the word','اهجّ الكلمة'], translate:['Translate','ترجم'],
    ...
    grammar_correction:['Pick the correct sentence','اختر الجملة الصحيحة'], choose_natural_expression:['Pick the natural one','اختر الطبيعي'],
    free_response:['Build your answer','رتب جوابك'], review:['Recall','استرجع'], challenge:['Quick fire','سوال سريع'],
    listening_dictation:['Listen and arrange','اسمع ورتب'], guided_production:['Complete the sentence','كمل الجملة'],
    concept:['Read the rule','اقرا القاعده'], concept_examples:['See examples','شاهد الامثلة'], db_order:['Tap words in order','اضغط الكلمات بالترتيب'],
    ...
    writing_practice:['Tap words to build the sentence','اضغط الكلمات عشان تبني الجملة'],
