...
@media(max-width:680px){
  ...
  var PRON_HINTS = {
    ...
    // --- P vs B (Arabic has no P) ---
    'pen': { beats:1, ar:'مقطع واحد: پِن - صوت P يطلع بهوا من الشفايف', avoid:'لا تقول: بِن' },
    ...
    'park': { beats:1, ar:'مقطع واحد: پارك - P قوية بهوا', avoid:'لا تقول: بارك' },
  ...
  var PRON_PATTERNS = [
    ...
    // wr → silent W
    { test:/^wr/i, hint:{ beats:1, ar:'W ساكت - ابدا بالرا مباشرة', avoid:'لا تنطق الـ W' } },
    // -tion ending → شن
