  ...
  const Stage = {
    ...
    renderDone(){
      ...
      body.innerHTML = `<div class="pel-stage-done pel-card-enter">
        ...
        <div class="pel-done-tools">
          <button class="pel-tool-link" id="pelDoneReview">${L('Review words','راجع الكلمات')}</button>
          <button class="pel-tool-link" id="pelDoneVocab">${L('Vocabulary','المفردات')}</button>
          <button class="pel-tool-link" id="pelDoneGrammar">${L('Grammar','القواعد')}</button>
        </div></div>`;
