  ...
  const PEL_BEGINNER = {
    ...
    'days-and-months': {
      ...
      dialogue: [
        ...
        { who: 'A', en: 'OK, see you tomorrow.', ar: 'تمام، اشوفك بكره.', translit: 'اوكي، سي يو تومورو.' },
        { who: 'B', en: 'Goodbye!', ar: 'مع السلامه!', translit: 'غود باي!' },
      ],
    },
    'family-members': {
      ...
      items: [
        {
          ...
          usage: { en: 'Your female parent. We say امي for my mother.', ar: 'والدتك. نقول امي.' },
          sentences: [
        ...
        },
        {
          ...
          usage: { en: 'Your male parent. We say ابوي for my father.', ar: 'والدك. نقول ابوي.' },
          sentences: [
        ...
        },
        {
          ...
          ipa: '/ˈbrʌðər/',
          example: { en: 'I have one brother.', ar: 'عندي اخ واحد.', translit: 'اي هاف ون برذر.' },
          usage: { en: 'Your male sibling. We say اخوي for my brother.', ar: 'اخوك. نقول اخوي.' },
          sentences: [
    ...
    'shopping-and-money': {
      ...
      dialogue: [
        ...
        { who: 'B', en: 'OK, eight.', ar: 'تمام، ثمانانيه.', translit: 'اوكي، ايت.' },
      ],
    },
    'daily-routine': {
    ...
    'a-an-the': {
      ...
      dialogue: [
        ...
        { who: 'B', en: 'What is the idea?', ar: 'وش الفكره؟', translit: 'وات ايز ذا ايديا؟' },
    ...
    'body-parts': {
      ...
      dialogue: [
        ...
        { who: 'B', en: 'Okay, thank you.', ar: 'تمام، شكرا.', translit: 'اوكي، ثانك يو.' },
      ],
    },
    'hobbies-likes': {
    ...
    'at-the-airport': {
      ...
      items: [
        ...
        },
        {
          ...
          usage: { en: 'Your bags and suitcases. We say شنط for bags.', ar: 'فعلايبك. نقول شنط.' },
          sentences: [
      ...
      items: [
        {
          ...
          usage: { en: 'Your work. We say شغل for job or work.', ar: 'شغلك. نقول شغل.' },
          sentences: [
...
@media(max-width:680px){
  ...
  const PEL_MIN_PAIRS = [
    ...
    { contrast:'th vs s', target:'thank', confusion:'sank', ar:'شكرا', tipAr:'نفس الفكره، اللسان يطلع برا بين الاسنان.' },
  ...
  var PRON_HINTS = {
    ...
    'the': { beats:1, ar:'قول كذا: ذا - خفيفه وسريعه', avoid:'مو كذا لانه غلط: دس او زي' },
    ...
    'parking': { beats:2, ar:'قول كذا: پار-كينق - P بالبدايه', avoid:'مو كذا لانه غلط: باركينق' },
  ...
  function buildSequence(lesson, lessonId){
    ...
    // 13c. Mistake Coach — common learner mistakes woven into
  ...
  function connectionNoteFor(act){
    ...
    if(/\bhow\s+much\b/i.test(text)){
      return 'How much = كم (لللي ما يعد والفلوس). الترتيب: How much + الشي + ... مثال: How much is it = كم سعره';
    }
    ...
    if(/\b(my|your|his|her|our|their)\b/i.test(text)){
      return 'كلمات الملكيه: my = حقتي · your = حقتك · his = حقه · her = حقها · our = حقنا · their = حقهم. تحطها قبل الشي. الترتيب: كلمه ملكيه + الشي. مثال: my name = اسمي، your phone = جوالك';
    }
  ...
  function grammarGlossary(act){
    ...
    if(connNote){
      ...
      if(connNote.indexOf('كلمه ملكيه') >= 0){
        add('poss', 'كلمات الملكيه', 'كلمات تدل على الملك. my = حقتي، your = حقتك، his = حقه، her = حقها، our = حقنا، their = حقهم');
      }
    ...
    if(lesson.grammar && lesson.grammar.rule){
      ...
      if(/possessive/.test(r)) add('poss2', 'كلمات الملكيه', 'my = حقتي، your = حقتك، his = حقه، her = حقها');
  ...
  function wordTypeFor(word, lesson){
    ...
    if(/^(my|your|his|her|its|our|their)$/.test(w)) return 'كلمه ملكيه';
  ...
  const RENDERERS = {
    ...
    mistake_coach(inner, act, ctx){
      // Mistake Coach — shows a common learner mistake with
      ...
      const renderTip = () => {
        inner.innerHTML = `
          <div class="pel-act-prompt">${L('Common Mistake','غلطه شايعه عند ناس كثيرين')}</div>
  ...
  const TYPE_LABELS_DEF = {
    ...
    mistake_coach:['Dialect Tip','نصيحه لهجيه'],
