...
window.PEL_STAGE_FACTORY = function (Deps) {
  ...
  const PEL_BEGINNER = {
    'greetings-goodbye': {
      title: { en: 'Greetings & Goodbye', ar: 'التحيه والوداع' },
      items: [
        {
          en: 'hello', ar: 'هلا', translit: 'هلو', pos: 'greeting',
          ipa: '/həˈloʊ/',
          example: { en: 'Hello, how are you?', ar: 'هلا، عشانفك؟', translit: 'هلو، هاو ار يو؟' },
          usage: { en: 'Say "hello" any time of day to start a friendly conversation.', ar: 'قول "هلو" اي وقت باليوم عشان تفتح محادثه.' },
          sentences: [
            { en: 'Hello.', ar: 'هلا.', translit: 'هلو.' },
            { en: 'Hello, how are you?', ar: 'هلا، عشانفك؟', translit: 'هلو، هاو ار يو؟' },
            { en: 'Hello, are you free today?', ar: 'هلا، انت فاضي اليوم؟', translit: 'هلو، ار يو فري توداي؟' },
          ],
        },
        {
          en: 'goodbye', ar: 'مع السلامه', translit: 'غود باي', pos: 'greeting',
          ipa: '/ɡʊdˈbaɪ/',
          example: { en: 'Goodbye, see you tomorrow.', ar: 'مع السلامه، اشوفك بكره.', translit: 'غود باي، سي يو تومورو.' },
          usage: { en: 'Use "goodbye" when parting. "See you" is more casual.', ar: 'استخدم "غود باي" وقت الوداع. "سي يو" اخف.' },
          sentences: [
            { en: 'Goodbye.', ar: 'مع السلامه.', translit: 'غود باي.' },
            { en: 'Goodbye, see you tomorrow.', ar: 'مع السلامه، اشوفك بكره.', translit: 'غود باي، سي يو تومورو.' },
            { en: 'Are you leaving? Goodbye!', ar: 'بتروح؟ مع السلامه!', translit: 'ار يو ليفينق؟ غود باي!' },
          ],
        },
        {
          en: 'how are you', ar: 'عشانفك', translit: 'هاو ار يو', pos: 'phrase',
          ipa: '/haʊ ɑːr juː/',
          example: { en: 'Hi, how are you today?', ar: 'هلا، عشانفك اليوم؟', translit: 'هاي، هاو ار يو توداي؟' },
          usage: { en: 'A friendly check-in. Reply with "I am fine, thank you."', ar: 'سوال ودّي. جاوب بـ "تمام، شكرا".' },
          sentences: [
            { en: 'How are you?', ar: 'عشانفك؟', translit: 'هاو ار يو؟' },
            { en: 'How are you today?', ar: 'عشانفك اليوم؟', translit: 'هاو ار يو توداي؟' },
            { en: 'Hello, how are you doing today?', ar: 'هلا، عشانفك اليوم؟', translit: 'هلو، هاو ار يو دوينق توداي؟' },
          ],
        },
      ],
      dialogue: [
        { who: 'A', en: 'Hello! How are you today?', ar: 'هلا! عشانفك اليوم؟', translit: 'هلو! هاو ار يو توداي؟' },
        { who: 'B', en: 'I am fine, thank you. And you?', ar: 'تمام، شكرا. وانت؟', translit: 'اي ام فوين، ثانك يو. اند يو؟' },
        { who: 'A', en: 'I am good. See you tomorrow.', ar: 'بخير. اشوفك بكره.', translit: 'اي ام غود. سي يو تومورو.' },
        { who: 'B', en: 'Goodbye!', ar: 'مع السلامه!', translit: 'غود باي!' },
      ],
    },
    'introducing-yourself': {
      ...
      items: [
        ...
        {
          en: 'nice to meet you', ar: 'فرحت بلقياك', translit: 'نايس تو ميت يو', pos: 'phrase',
          ipa: '/naɪs tə miːt juː/',
          example: { en: 'Nice to meet you, Sara.', ar: 'فرحت بلقياك، ساره.', translit: 'نايس تو ميت يو، ساره.' },
          usage: { en: 'Say this right after you hear someone\'s name.', ar: 'قولها اول ما تسمع اسم الشخص.' },
          sentences: [
            { en: 'Nice to meet you.', ar: 'فرحت بلقياك.', translit: 'نايس تو ميت يو.' },
            { en: 'Nice to meet you too.', ar: 'فرحت بلقياك لسه.', translit: 'نايس تو ميت يو تو.' },
          ],
        },
        {
          en: 'I am from', ar: 'انا من', translit: 'اي ام فرام', pos: 'phrase',
          ipa: '/aɪ æm frʌm/',
          example: { en: 'I am from Saudi Arabia.', ar: 'انا من السعوديه.', translit: 'اي ام فرام سعودي ارابيا.' },
          usage: { en: 'Say where you are from.', ar: 'قول من وين انت.' },
          sentences: [
            { en: 'I am from Jeddah.', ar: 'انا من جده.', translit: 'اي ام فرام جدّه.' },
            { en: 'I am from Saudi Arabia.', ar: 'انا من السعوديه.', translit: 'اي ام فرام سعودي ارابيا.' },
      ...
      dialogue: [
        ...
        { who: 'B', en: 'My name is Sara. Nice to meet you.', ar: 'اسمي ساره. فرحت بلقياك.', translit: 'ماي نيم ايز ساره. نايس تو ميت يو.' },
        { who: 'A', en: 'Nice to meet you too. I am from Jeddah.', ar: 'فرحت بلقياك لسه. انا من جده.', translit: 'نايس تو ميت يو تو. اي ام فرام جدّه.' },
        { who: 'B', en: 'I am from Riyadh. Welcome!', ar: 'انا من الرياض. اهلا وسهلا!', translit: 'اي ام فرام الرياض. ويلكم!' },
      ],
    },
    'doctor-appointment': {
      ...
      items: [
        {
          ...
          ipa: '/əˈpɔɪntmənt/',
          example: { en: 'I have an appointment tomorrow.', ar: 'عندي موعد بكره.', translit: 'اي هاف ان ابوينتمنت تومورو.' },
          usage: { en: 'A scheduled meeting with a doctor, office, or service.', ar: 'موعد مع دكتور او جهه.' },
          sentences: [
            { en: 'I have an appointment.', ar: 'عندي موعد.', translit: 'اي هاف ان ابوينتمنت.' },
            { en: 'I have an appointment tomorrow.', ar: 'عندي موعد بكره.', translit: 'اي هاف ان ابوينتمنت تومورو.' },
            { en: 'Do you have an appointment tomorrow?', ar: 'عندك موعد بكره؟', translit: 'دو يو هاف ان ابوينتمنت تومورو؟' },
          ],
        },
        {
          ...
          usage: { en: 'Polite way to say what you want. "I want" is more direct.', ar: 'طريقه مهذبه تبي فيها شي. "اي ونت" اكثر مباشره.' },
          sentences: [
        ...
        },
        {
          ...
          usage: { en: 'Free, not busy. Use it to ask about times.', ar: 'فاضي، مو مشغول. تجي تسال عن الاوقات.' },
          sentences: [
      ...
      dialogue: [
        ...
        { who: 'B', en: 'Sure. Is the doctor available tomorrow?', ar: 'تمام. الدكتور متاح بكره؟', translit: 'شر. ايز ذا دوكتور افيلابول تومورو؟' },
        { who: 'A', en: 'Yes. I have an appointment tomorrow at ten.', ar: 'ايه. عندي موعد بكره الساعه عشر.', translit: 'يس. اي هاف ان ابوينتمنت تومورو ات تن.' },
        { who: 'B', en: 'Great. See you tomorrow!', ar: 'تمام. اشوفك بكره!', translit: 'غريت. سي يو تومورو!' },
      ],
    },
    'numbers-1-10': {
      title: { en: 'One to Ten', ar: 'من وواحد لعشره' },
      items: [
        {
          en: 'one', ar: 'وواحد', translit: 'ون', pos: 'number',
          ipa: '/wʌn/',
          example: { en: 'I have one brother.', ar: 'عندي اخ وواحد.', translit: 'اي هاف ون برذر.' },
          usage: { en: 'The first number. Say it before a single thing.', ar: 'اول رقم. قولها قبل شي وواحد.' },
          sentences: [
            { en: 'One.', ar: 'وواحد.', translit: 'ون.' },
            { en: 'I have one book.', ar: 'عندي كتاب وواحد.', translit: 'اي هاف ون بوك.' },
            { en: 'Give me one, please.', ar: 'عطني وواحد، من فضلك.', translit: 'جيف مي ون، بليز.' },
          ],
        },
        {
          ...
          usage: { en: 'The number after one.', ar: 'الرقم اللي لسه وواحد.' },
          sentences: [
        ...
        {
          en: 'three', ar: 'ثلاثه', translit: 'ثري', pos: 'number',
          ipa: '/θriː/',
          example: { en: 'Three people are coming.', ar: 'ثلاثه اشخاص جايين.', translit: 'ثري بيبل ار كامينق.' },
          usage: { en: 'The number after two.', ar: 'الرقم اللي لسه اثنين.' },
          sentences: [
            { en: 'Three.', ar: 'ثلاثه.', translit: 'ثري.' },
            { en: 'I have three.', ar: 'عندي ثلاثه.', translit: 'اي هاف ثري.' },
            { en: 'Three days.', ar: 'ثلاثه ايام.', translit: 'ثري دايز.' },
          ],
        },
      ],
      dialogue: [
        { who: 'A', en: 'How many?', ar: 'كم؟', translit: 'هاو ماني؟' },
        { who: 'B', en: 'Three.', ar: 'ثلاثه.', translit: 'ثري.' },
        { who: 'A', en: 'Only three?', ar: 'ثلاثه بس؟', translit: 'اونلي ثري؟' },
        { who: 'B', en: 'Yes, three.', ar: 'ايه، ثلاثه.', translit: 'يس، ثري.' },
      ],
    },
    'colors': {
      ...
      items: [
        {
          ...
          ipa: '/red/',
          example: { en: 'The car is red.', ar: 'السياره حمرا.', translit: 'ذا كار ايز رد.' },
          usage: { en: 'A common color. Also used for the traffic light that means stop.', ar: 'لون شايع. مثلن يستخدم للاشاره اللي تعني قف.' },
          sentences: [
        ...
        },
        {
          ...
          usage: { en: 'The color of plants and the go light.', ar: 'لون النباتات والاشاره الخضرا.' },
          sentences: [
            { en: 'Green.', ar: 'اخضر.', translit: 'غرين.' },
            { en: 'Green light.', ar: 'اشاره خضرا.', translit: 'غرين لايت.' },
      ...
      items: [
        {
          ...
          usage: { en: 'The day that is happening now.', ar: 'اليوم اللي احنا فيه.' },
          sentences: [
        ...
        {
          en: 'tomorrow', ar: 'بكره', translit: 'تومورو', pos: 'time',
          ipa: '/təˈmɔːroʊ/',
          example: { en: 'See you tomorrow.', ar: 'اشوفك بكره.', translit: 'سي يو تومورو.' },
          usage: { en: 'The day after today.', ar: 'اليوم اللي لسه اليوم.' },
          sentences: [
            { en: 'Tomorrow.', ar: 'بكره.', translit: 'تومورو.' },
            { en: 'Tomorrow morning.', ar: 'بكره الصبح.', translit: 'تومورو مورنينق.' },
            { en: 'I will come tomorrow.', ar: 'بجي بكره.', translit: 'اي ويل كام تومورو.' },
          ],
        },
        {
          en: 'week', ar: 'اسبوع', translit: 'ويك', pos: 'time',
          ipa: '/wiːk/',
          example: { en: 'A week has seven days.', ar: 'الاسبوع سبعه ايام.', translit: 'ا ويك هاف سيفن دايز.' },
          usage: { en: 'Seven days, from Sunday to Saturday.', ar: 'سبعه ايام، من الواحد للسبت.' },
          sentences: [
            { en: 'One week.', ar: 'اسبوع.', translit: 'ون ويك.' },
            { en: 'Next week.', ar: 'الاسبوع الجاي.', translit: 'نكست ويك.' },
            { en: 'This week.', ar: 'ذا الاسبوع.', translit: 'ذس ويك.' },
          ],
        },
      ],
      dialogue: [
        { who: 'A', en: 'Today or tomorrow?', ar: 'اليوم ولا بكره؟', translit: 'توداي اور تومورو؟' },
        { who: 'B', en: 'Tomorrow.', ar: 'بكره.', translit: 'تومورو.' },
        { who: 'A', en: 'OK, see you tomorrow.', ar: 'تمام، اشوفك بكره.', translit: 'اوعشان، سي يو تومورو.' },
        { who: 'B', en: 'Goodbye!', ar: 'مع السلامه!', translit: 'غود باي!' },
      ],
    },
    'family-members': {
      title: { en: 'Family', ar: 'العايله' },
      items: [
        {
          en: 'mother', ar: 'امي', translit: 'ماذر', pos: 'family',
          ipa: '/ˈmʌðər/',
          example: { en: 'My mother is kind.', ar: 'امي طيبه.', translit: 'ماي ماذر ايز كويند.' },
        ...
        },
        {
          ...
          sentences: [
            ...
            { en: 'This is my brother.', ar: 'ذا اخوي.', translit: 'ذس ايز ماي برذر.' },
            { en: 'Your brother.', ar: 'اخوك.', translit: 'يور برذر.' },
          ],
        },
      ],
      dialogue: [
        { who: 'A', en: 'Is this your brother?', ar: 'ذا اخوك؟', translit: 'ايز ذس يور برذر؟' },
        { who: 'B', en: 'Yes, my brother.', ar: 'ايه، اخوي.', translit: 'يس، ماي برذر.' },
        { who: 'A', en: 'Nice to meet you.', ar: 'فرحت بلقياك.', translit: 'نايس تو ميت يو.' },
        { who: 'B', en: 'Nice to meet you too.', ar: 'فرحت بلقياك لسه.', translit: 'نايس تو ميت يو تو.' },
      ],
    },
    'telling-time': {
      title: { en: 'Telling Time', ar: 'الساعه' },
      items: [
        {
          en: 'time', ar: 'وقت', translit: 'تايم', pos: 'noun',
          ipa: '/taɪm/',
          example: { en: 'What time is it?', ar: 'كم الساعه؟', translit: 'وات تايم ايز ات؟' },
          usage: { en: 'The hour of the day.', ar: 'ساعه اليوم.' },
          sentences: [
            { en: 'What time?', ar: 'كم الساعه؟', translit: 'وات تايم؟' },
            { en: 'The time is now.', ar: 'الوقت الحين.', translit: 'ذا تايم ايز ناو.' },
            { en: 'What time is it?', ar: 'كم الساعه؟', translit: 'وات تايم ايز ات؟' },
          ],
        },
        {
          en: 'o\'clock', ar: 'الساعه', translit: 'اكلوك', pos: 'time',
          ipa: '/əˈklɑːk/',
          example: { en: 'It is three o\'clock.', ar: 'الساعه ثلاثه.', translit: 'ات ايز ثري اكلوك.' },
          usage: { en: 'Used for exact hours, like three o\'clock.', ar: 'للساعات المضبوطه، مثل ثلاثه.' },
          sentences: [
            { en: 'One o\'clock.', ar: 'الساعه وواحده.', translit: 'ون اكلوك.' },
            { en: 'It is two o\'clock.', ar: 'الساعه اثنين.', translit: 'ات ايز تو اكلوك.' },
            { en: 'Three o\'clock.', ar: 'الساعه ثلاثه.', translit: 'ثري اكلوك.' },
          ],
        },
        {
          ...
          usage: { en: 'After the agreed time. The opposite is early.', ar: 'لسه الوقت المتفق عليه. العكس مبكر.' },
          sentences: [
            { en: 'I am late.', ar: 'تاخرت.', translit: 'اي ام ليت.' },
            { en: 'Are you late?', ar: 'متاخر؟', translit: 'ار يو ليت؟' },
            { en: 'Sorry, I am late.', ar: 'المعذره، تاخرت.', translit: 'سوري، اي ام ليت.' },
          ],
        },
      ],
      dialogue: [
        { who: 'A', en: 'What time is it?', ar: 'كم الساعه؟', translit: 'وات تايم ايز ات؟' },
        { who: 'B', en: 'It is two o\'clock.', ar: 'الساعه اثنين.', translit: 'ات ايز تو اكلوك.' },
        { who: 'A', en: 'I am late!', ar: 'تاخرت!', translit: 'اي ام ليت!' },
        { who: 'B', en: 'No, you are fine.', ar: 'لا، تمام.', translit: 'نو، يو ار فوين.' },
      ],
    },
    'food-and-drinks': {
      ...
      items: [
        {
          ...
          sentences: [
            ...
            { en: 'A glass of water.', ar: 'كاسه ماي.', translit: 'ا غلاس اوف ووتر.' },
        ...
        {
          en: 'coffee', ar: 'قهوه', translit: 'كوفي', pos: 'noun',
          ipa: '/ˈkɔːfi/',
          example: { en: 'I drink coffee.', ar: 'اشرب قهوه.', translit: 'اي درينك كوفي.' },
          usage: { en: 'A hot drink, very common in Saudi Arabia.', ar: 'مشروب حار، شايع بالسعوديه.' },
          sentences: [
            { en: 'Coffee.', ar: 'قهوه.', translit: 'كوفي.' },
            { en: 'A cup of coffee.', ar: 'فنجان قهوه.', translit: 'ا كب اوف كوفي.' },
            { en: 'Do you want coffee?', ar: 'تبغى قهوه؟', translit: 'دو يو وانت كوفي؟' },
          ],
        },
      ],
      dialogue: [
        { who: 'A', en: 'Do you want coffee?', ar: 'تبغى قهوه؟', translit: 'دو يو وانت كوفي؟' },
        { who: 'B', en: 'Yes, please.', ar: 'ايه، من فضلك.', translit: 'يس، بليز.' },
        { who: 'A', en: 'With water?', ar: 'مع ماي؟', translit: 'وذ ووتر؟' },
        { who: 'B', en: 'No, thank you.', ar: 'لا، شكرا.', translit: 'نو، ثانك يو.' },
      ],
    },
    'classroom-words': {
      title: { en: 'In Class', ar: 'في الينصل' },
      items: [
        {
          ...
          sentences: [
            ...
            { en: 'This is my book.', ar: 'ذا كتابي.', translit: 'ذس ايز ماي بوك.' },
        ...
        },
        {
          ...
          sentences: [
            ...
            { en: 'Is this your pen?', ar: 'ذا قلمك؟', translit: 'ايز ذس يور بن؟' },
          ],
        },
        {
          en: 'teacher', ar: 'معلم', translit: 'تيتشر', pos: 'noun',
          ipa: '/ˈtiːtʃər/',
          example: { en: 'The teacher is good.', ar: 'الاستاذ زين.', translit: 'ذا تيتشر ايز غود.' },
          usage: { en: 'The person who teaches you.', ar: 'الشخص اللي يعلمك.' },
          sentences: [
            { en: 'The teacher.', ar: 'الاستاذ.', translit: 'ذا تيتشر.' },
            { en: 'My teacher.', ar: 'معلمي.', translit: 'ماي تيتشر.' },
            { en: 'Ask the teacher.', ar: 'اسال الاستاذ.', translit: 'اسك ذا تيتشر.' },
          ],
        },
      ],
      dialogue: [
        ...
        { who: 'B', en: 'Which page?', ar: 'اي صفحه؟', translit: 'ويتش بيج؟' },
      ],
    },
    'asking-directions': {
      ...
      items: [
        {
          ...
          ipa: '/wer/',
          example: { en: 'Where is the school?', ar: 'وين الاستاذه؟', translit: 'وير ايز ذا سكول؟' },
      ...
      dialogue: [
        { who: 'A', en: 'Where is the school?', ar: 'وين الاستاذه؟', translit: 'وير ايز ذا سكول؟' },
        { who: 'B', en: 'Turn right.', ar: 'لف يمين.', translit: 'ترن رايت.' },
        { who: 'A', en: 'Then left?', ar: 'ولسهين يسار؟', translit: 'ذن لفت؟' },
        { who: 'B', en: 'Yes, then left.', ar: 'ايه، لسهين يسار.', translit: 'يس، ذن لفت.' },
      ],
    },
    'shopping-and-money': {
      title: { en: 'Shopping & Money', ar: 'التسوق والينلوس' },
      items: [
        {
          ...
          sentences: [
            ...
            { en: 'How much is this?', ar: 'كم ذا؟', translit: 'هاو موتش ايز ذس؟' },
        ...
        },
        {
          ...
          usage: { en: 'How much something costs.', ar: 'يمكنّيش شي يكلف.' },
          sentences: [
      ...
      dialogue: [
        { who: 'A', en: 'How much is this?', ar: 'كم ذا؟', translit: 'هاو موتش ايز ذس؟' },
        { who: 'B', en: 'Ten riyals.', ar: 'عشره ريالات.', translit: 'تن ريالز.' },
        { who: 'A', en: 'Too much!', ar: 'كثير!', translit: 'تو موتش!' },
        { who: 'B', en: 'OK, eight.', ar: 'تمام، لسهينانيه.', translit: 'اوعشان، ايت.' },
      ],
    },
    'daily-routine': {
      ...
      items: [
        ...
        },
        {
          ...
          ipa: '/iːt/',
          example: { en: 'I eat breakfast.', ar: 'اكل الينطار.', translit: 'اي ايت بريكفاست.' },
        ...
        },
        {
          ...
          usage: { en: 'To rest with your eyes closed. The opposite of wake up.', ar: 'ترتاح وعيونك مغمضه. عكس تصحى.' },
          sentences: [
      ...
      dialogue: [
        ...
        { who: 'B', en: 'I wake up at six.', ar: 'اصحى الساعه سته.', translit: 'اي ويك اب ات سيكس.' },
        { who: 'A', en: 'Do you eat breakfast?', ar: 'تفطر؟', translit: 'دو يو ايت بريكفاست؟' },
        { who: 'B', en: 'Yes, then I work.', ar: 'ايه، ولسهين اشتغل.', translit: 'يس، ذن اي ويرك.' },
      ],
    },
    'weather-words': {
      ...
      items: [
        {
          ...
          usage: { en: 'High temperature. The opposite is cold.', ar: 'حراره عاليه. العكس بارد.' },
          sentences: [
        ...
        },
        {
          ...
          usage: { en: 'Low temperature. The opposite is hot.', ar: 'حراره منخفضه. العكس حار.' },
          sentences: [
    ...
    'feelings-and-emotions': {
      ...
      items: [
        {
          ...
          usage: { en: 'A good feeling. The opposite is sad.', ar: 'احساس زين. العكس زعلان.' },
          sentences: [
        ...
        {
          en: 'sad', ar: 'زعلان', translit: 'ساد', pos: 'adjective',
          ipa: '/sæd/',
          example: { en: 'I am sad.', ar: 'انا زعلان.', translit: 'اي ام ساد.' },
          usage: { en: 'A bad feeling. The opposite is happy.', ar: 'احساس مو زين. العكس مبسوط.' },
          sentences: [
            { en: 'Sad.', ar: 'زعلان.', translit: 'ساد.' },
            { en: 'I am sad.', ar: 'انا زعلان.', translit: 'اي ام ساد.' },
            { en: 'Why are you sad?', ar: 'ليش زعلان؟', translit: 'واي ار يو ساد؟' },
          ],
        },
        {
          ...
          usage: { en: 'When you need rest or sleep.', ar: 'وقت ما تحتاج راحه او نوم.' },
          sentences: [
      ...
      dialogue: [
        { who: 'A', en: 'How are you?', ar: 'عشانفك؟', translit: 'هاو ار يو؟' },
    ...
    'subject-pronouns': {
      ...
      items: [
        {
          ...
          sentences: [
            ...
            { en: 'I like coffee.', ar: 'انا احب القهوه.', translit: 'اي لايك كوفي.' },
          ],
        },
        {
          en: 'you', ar: 'انت', translit: 'يو', pos: 'pronoun',
          ipa: '/juː/',
          example: { en: 'You are my friend.', ar: 'انت صاحبي.', translit: 'يو ار ماي فرند.' },
          usage: { en: 'Used to talk to someone.', ar: 'تستخدمها وقت ما تكلم شخص.' },
          sentences: [
            { en: 'You are kind.', ar: 'انت طيب.', translit: 'يو ار كويند.' },
            { en: 'Are you okay?', ar: 'انت بخير؟', translit: 'ار يو اوعشان؟' },
      ...
      dialogue: [
        ...
        { who: 'B', en: 'I am Sara. And you?', ar: 'انا ساره. وانت؟', translit: 'اي ام ساره. اند يو؟' },
    ...
    'be-verb': {
      ...
      items: [
        {
          ...
          ipa: '/æm/',
          example: { en: 'I am a student.', ar: 'انا طالب.', translit: 'اي ام ا ستودنت.' },
          usage: { en: 'Used with the word I.', ar: 'تستخدمها مع كلمه اي.' },
          sentences: [
            { en: 'I am here.', ar: 'انا هنا.', translit: 'اي ام هير.' },
            { en: 'I am happy.', ar: 'انا مبسوط.', translit: 'اي ام هابي.' },
        ...
        },
        {
          ...
          ipa: '/ɪz/',
          example: { en: 'He is my friend.', ar: 'هو صاحبي.', translit: 'هي ايز ماي فرند.' },
          ...
          sentences: [
            ...
            { en: 'Is he okay?', ar: 'هو بخير؟', translit: 'ايز هي اوعشان؟' },
          ],
        },
        {
          ...
          sentences: [
            { en: 'We are here.', ar: 'احنا هنا.', translit: 'وي ار هير.' },
      ...
      dialogue: [
        ...
        { who: 'A', en: 'No, I am a teacher. Is she a student?', ar: 'لا، انا معلم. هي طالبه؟', translit: 'نو، اي ام ا تيتشر. ايز شي ا ستودنت؟' },
        { who: 'B', en: 'Yes, she is.', ar: 'ايه، هي.', translit: 'يس، شي ايز.' },
      ],
    },
    'this-and-that': {
      title: { en: 'This and That', ar: 'ذا وذاك' },
      items: [
        {
          en: 'this', ar: 'ذا', translit: 'ذس', pos: 'pronoun',
          ipa: '/ðɪs/',
          example: { en: 'This is my book.', ar: 'ذا كتابي.', translit: 'ذس ايز ماي بوك.' },
          usage: { en: 'Used for something close to you.', ar: 'تستخدمها لشي قريب منك.' },
          sentences: [
            { en: 'This is mine.', ar: 'ذا حقي.', translit: 'ذس ايز موين.' },
            { en: 'What is this?', ar: 'وش ذا؟', translit: 'وات ايز ذس؟' },
            { en: 'This is good.', ar: 'ذا زين.', translit: 'ذس ايز غود.' },
          ],
        },
        {
          en: 'that', ar: 'ذاك', translit: 'ذات', pos: 'pronoun',
          ipa: '/ðæt/',
          example: { en: 'That is your bag.', ar: 'ذاك شنطتك.', translit: 'ذات ايز يور باق.' },
        ...
        },
        {
          ...
          usage: { en: 'Plural of this, for close things.', ar: 'جمع ذا، لاشيا قريبه.' },
          sentences: [
            { en: 'These are mine.', ar: 'هذي حقي.', translit: 'ذيس ار موين.' },
            { en: 'Are these yours?', ar: 'هذي حقك؟', translit: 'ار ذيس يورز؟' },
            { en: 'These are good.', ar: 'هذي زينه.', translit: 'ذيس ار غود.' },
          ],
        },
      ],
      dialogue: [
        { who: 'A', en: 'What is this?', ar: 'وش ذا؟', translit: 'وات ايز ذس؟' },
        { who: 'B', en: 'This is my pen. And that?', ar: 'ذا قلمي. وذاك؟', translit: 'ذس ايز ماي بن. اند ذات؟' },
        { who: 'A', en: 'That is my book.', ar: 'ذاك كتابي.', translit: 'ذات ايز ماي بوك.' },
        { who: 'B', en: 'Are these yours too?', ar: 'هذي حقك لسه؟', translit: 'ار ذيس يورز تو؟' },
      ],
    },
    'a-an-the': {
      ...
      items: [
        {
          en: 'a', ar: 'وواحد', translit: 'ا', pos: 'article',
          ipa: '/eɪ/',
          example: { en: 'I have a dog.', ar: 'عندي كلب.', translit: 'اي هاف ا دوغ.' },
          usage: { en: 'Used before a word starting with a consonant sound.', ar: 'تستخدمها قبل كلمه تبدا بصوت ساكن.' },
          sentences: [
            { en: 'A cat.', ar: 'قط.', translit: 'ا كات.' },
            { en: 'I have a car.', ar: 'عندي سياره.', translit: 'اي هاف ا كار.' },
            { en: 'It is a book.', ar: 'ذا كتاب.', translit: 'ات ايز ا بوك.' },
          ],
        },
        {
          en: 'an', ar: 'وواحد', translit: 'ان', pos: 'article',
          ipa: '/æn/',
          example: { en: 'I have an apple.', ar: 'عندي تفاحه.', translit: 'اي هاف ان ابل.' },
          usage: { en: 'Used before a word starting with a vowel sound.', ar: 'تستخدمها قبل كلمه تبدا بصوت متحرك.' },
          sentences: [
            { en: 'An egg.', ar: 'بيضه.', translit: 'ان اوق.' },
            { en: 'I have an orange.', ar: 'عندي برتقاله.', translit: 'اي هاف ان اورنج.' },
            { en: 'It is an egg.', ar: 'هذي بيضه.', translit: 'ات ايز ان اوق.' },
          ],
        },
        {
          ...
          usage: { en: 'Used for a specific thing both people know.', ar: 'تستخدمها لشي معاين يعرفه الطرفان.' },
          sentences: [
            { en: 'The door is open.', ar: 'الباب مفتوح.', translit: 'ذا دور ايز اوبن.' },
            { en: 'Close the door.', ar: 'قفل الباب.', translit: 'كلوز ذا دور.' },
            { en: 'The book is mine.', ar: 'الكتاب حقي.', translit: 'ذا بوك ايز موين.' },
          ],
        },
      ],
      dialogue: [
        { who: 'A', en: 'I have a car and an idea.', ar: 'عندي سياره وفكره.', translit: 'اي هاف ا كار اند ان ايديا.' },
        { who: 'B', en: 'What is the idea?', ar: 'وش الينكره؟', translit: 'وات ايز ذا ايديا؟' },
      ...
      items: [
        {
          ...
          sentences: [
            ...
            { en: 'These books are mine.', ar: 'هذي الكتب حقي.', translit: 'ذيس بوكس ار موين.' },
          ],
        },
        {
          en: 'cat', ar: 'قط', translit: 'كات', pos: 'noun',
          ipa: '/kæt/',
          example: { en: 'The cats are sleeping.', ar: 'القطط نايمه.', translit: 'ذا كاتس ار سليبينق.' },
          usage: { en: 'Regular plural adds an s.', ar: 'جمع عادي يزيد حرف s.' },
          sentences: [
        ...
        },
        {
          ...
          sentences: [
            ...
            { en: 'The men are working.', ar: 'الرجال يشتغلون.', translit: 'ذا من ار ويرعشاننق.' },
          ],
        },
      ],
      dialogue: [
    ...
    'common-verbs': {
      title: { en: 'Common Verbs', ar: 'افعال شايعه' },
      items: [
        {
        ...
        },
        {
          ...
          ipa: '/wɜːrk/',
          example: { en: 'I work in Jeddah.', ar: 'اشتغل بجده.', translit: 'اي ويرك ان جدّه.' },
      ...
      dialogue: [
        ...
        { who: 'B', en: 'I work in a school. And you?', ar: 'اشتغل بمدرسه. وانت؟', translit: 'اي ويرك ان ا سكول. اند يو؟' },
    ...
    'places-in-town': {
      title: { en: 'Places in Town', ar: 'اماكن بالمدينه' },
      items: [
        {
          en: 'school', ar: 'مدرسه', translit: 'سكول', pos: 'place',
          ipa: '/skuːl/',
          example: { en: 'The school is near.', ar: 'الاستاذه قريبه.', translit: 'ذا سكول ايز نير.' },
          usage: { en: 'Where children learn.', ar: 'مكان يتعلم فيه الاطفال.' },
          sentences: [
            { en: 'I go to school.', ar: 'اروح الاستاذه.', translit: 'اي قو تو سكول.' },
            { en: 'The school is big.', ar: 'الاستاذه كبيره.', translit: 'ذا سكول ايز بيغ.' },
            { en: 'Where is the school?', ar: 'وين الاستاذه؟', translit: 'وير ايز ذا سكول؟' },
          ],
        },
        {
          ...
          usage: { en: 'Where sick people get help.', ar: 'مكان المرضى ياخذون فيه علاج ومساعده.' },
          sentences: [
      ...
      dialogue: [
        ...
        { who: 'B', en: 'It is near the school.', ar: 'قريب من الاستاذه.', translit: 'ات ايز نير ذا سكول.' },
    ...
    'transport': {
      ...
      items: [
        {
          en: 'car', ar: 'سياره', translit: 'كار', pos: 'noun',
          ipa: '/kɑːr/',
          example: { en: 'I have a car.', ar: 'عندي سياره.', translit: 'اي هاف ا كار.' },
          usage: { en: 'A vehicle you drive.', ar: 'مركبه تسوقها.' },
          sentences: [
            { en: 'My car is red.', ar: 'سيارتي حمرا.', translit: 'ماي كار ايز ريد.' },
            { en: 'Where is my car?', ar: 'وين سيارتي؟', translit: 'وير ايز ماي كار؟' },
            { en: 'I drive a car.', ar: 'اسوق سياره.', translit: 'اي درايف ا كار.' },
          ],
        },
        {
          en: 'bus', ar: 'حافله', translit: 'باص', pos: 'noun',
          ipa: '/bʌs/',
          example: { en: 'I take the bus.', ar: 'اركب الباص.', translit: 'اي تيك ذا باص.' },
          usage: { en: 'A big vehicle for many people.', ar: 'مركبه كبيره لناس كثر.' },
          sentences: [
        ...
        },
        {
          ...
          usage: { en: 'A long vehicle on tracks.', ar: 'مركبه طويله على سكه.' },
          sentences: [
      ...
      dialogue: [
        { who: 'A', en: 'Do you have a car?', ar: 'عندك سياره؟', translit: 'دو يو هاف ا كار؟' },
    ...
    'home-and-rooms': {
      ...
      items: [
        ...
        {
          en: 'bedroom', ar: 'غرفه نوم', translit: 'بيدروم', pos: 'room',
          ipa: '/ˈbedruːm/',
          example: { en: 'I sleep in my bedroom.', ar: 'انام بغرفتي.', translit: 'اي سليب ان ماي بيدروم.' },
          usage: { en: 'Where you sleep.', ar: 'مكان تنام فيه.' },
          sentences: [
            { en: 'My bedroom is quiet.', ar: 'غرفتي هاديه.', translit: 'ماي بيدروم ايز كوايت.' },
            { en: 'Where is the bedroom?', ar: 'وين غرفه النوم؟', translit: 'وير ايز ذا بيدروم؟' },
            { en: 'I clean my bedroom.', ar: 'انضف غرفتي.', translit: 'اي كلين ماي بيدروم.' },
          ],
        },
        {
          en: 'bathroom', ar: 'دوره مياه', translit: 'باثروم', pos: 'room',
          ipa: '/ˈbæθruːm/',
          example: { en: 'The bathroom is here.', ar: 'الدوره هنا.', translit: 'ذا باثروم ايز هير.' },
          usage: { en: 'Where you wash.', ar: 'مكان تغتسل فيه.' },
          sentences: [
            { en: 'Where is the bathroom?', ar: 'وين الدوره؟', translit: 'وير ايز ذا باثروم؟' },
            { en: 'The bathroom is clean.', ar: 'الدوره نظيفه.', translit: 'ذا باثروم ايز كلين.' },
            { en: 'I need the bathroom.', ar: 'محتاج الدوره.', translit: 'اي نيد ذا باثروم.' },
          ],
        },
      ],
      dialogue: [
        { who: 'A', en: 'Where is the kitchen?', ar: 'وين المطبخ؟', translit: 'وير ايز ذا كتشن؟' },
        { who: 'B', en: 'It is next to the bathroom.', ar: 'جنب الدوره.', translit: 'ات ايز ناكست تو ذا باثروم.' },
        { who: 'A', en: 'Is the bedroom upstairs?', ar: 'غرفه النوم فوق؟', translit: 'ايز ذا بيدروم ابستيرز؟' },
        { who: 'B', en: 'Yes, and it is quiet.', ar: 'ايه، وهي هاديه.', translit: 'يس، اند ات ايز كوايت.' },
      ],
    },
    'clothes': {
      ...
      items: [
        {
          ...
          usage: { en: 'You wear it on your upper body.', ar: 'تلبسه بجسمك ايمكنوي.' },
          sentences: [
            { en: 'I buy a shirt.', ar: 'اشتري قميص.', translit: 'اي باي ا شيرت.' },
            { en: 'This shirt is new.', ar: 'ذا القميص جديد.', translit: 'ذس شيرت ايز نيو.' },
            { en: 'Where is my shirt?', ar: 'وين قميصي؟', translit: 'وير ايز ماي شيرت؟' },
          ],
        },
        {
          en: 'shoes', ar: 'جزمه', translit: 'شوز', pos: 'clothing',
          ipa: '/ʃuːz/',
          example: { en: 'My shoes are black.', ar: 'جزمتي سود.', translit: 'ماي شوز ار بلاك.' },
          usage: { en: 'You wear them on your feet.', ar: 'تلبسها برجليك.' },
          sentences: [
            { en: 'I need new shoes.', ar: 'محتاج جزم جديده.', translit: 'اي نيد نيو شوز.' },
            { en: 'These shoes are old.', ar: 'هذي الجزم يمكنيمه.', translit: 'ذيس شوز ار اولد.' },
            { en: 'Where are my shoes?', ar: 'وين جزمي؟', translit: 'وير ار ماي شوز؟' },
          ],
        },
        {
          en: 'hat', ar: 'قبعه', translit: 'هات', pos: 'clothing',
          ipa: '/hæt/',
          example: { en: 'I wear a hat.', ar: 'البس قبعه.', translit: 'اي وير ا هات.' },
          usage: { en: 'You wear it on your head.', ar: 'تلبسها براسك.' },
          sentences: [
            { en: 'This hat is nice.', ar: 'هذي القبعه حلوه.', translit: 'ذس هات ايز نايس.' },
            { en: 'I buy a hat.', ar: 'اشتري قبعه.', translit: 'اي باي ا هات.' },
            { en: 'Where is my hat?', ar: 'وين قبعتي؟', translit: 'وير ايز ماي هات؟' },
          ],
        },
      ],
      dialogue: [
        { who: 'A', en: 'Is this shirt new?', ar: 'ذا القميص جديد؟', translit: 'ايز ذس شيرت نيو؟' },
        { who: 'B', en: 'Yes, and my shoes are new too.', ar: 'ايه، وجزمي جديده لسه.', translit: 'يس، اند ماي شوز ار نيو تو.' },
        { who: 'A', en: 'Where is your hat?', ar: 'وين قبعتك؟', translit: 'وير ايز يور هات؟' },
        { who: 'B', en: 'I do not have a hat.', ar: 'ما عندي قبعه.', translit: 'اي دو نات هاف ا هات.' },
      ],
    },
    'body-parts': {
      ...
      items: [
        ...
        },
        {
          ...
          sentences: [
            { en: 'My hand is small.', ar: 'يدي صغيره.', translit: 'ماي هاند ايز سمول.' },
        ...
        },
        {
          ...
          ipa: '/aɪ/',
          example: { en: 'My eyes are tired.', ar: 'عيني تعبانه.', translit: 'ماي ايز ار تايرد.' },
      ...
      dialogue: [
        ...
        { who: 'B', en: 'Yes, and my eyes are tired.', ar: 'ايه، وعيني تعبانه.', translit: 'يس، اند ماي ايز ار تايرد.' },
        { who: 'A', en: 'Wash your hands and rest.', ar: 'اغسل يديك وارتاح.', translit: 'واش يور هاندز اند ريست.' },
        { who: 'B', en: 'Okay, thank you.', ar: 'تمام، شكرا.', translit: 'اوعشان، ثانك يو.' },
      ],
    },
    'hobbies-likes': {
      title: { en: 'Hobbies and Likes', ar: 'الهوايات والاهتمامت' },
      items: [
        {
        ...
        },
        {
          ...
          ipa: '/pleɪ/',
          example: { en: 'I play football.', ar: 'العب كره.', translit: 'اي بلاي فوتبول.' },
          usage: { en: 'To do a game for fun.', ar: 'تمارس لعبه للتسليه.' },
          sentences: [
        ...
        },
        {
          ...
          ipa: '/laɪk/',
          example: { en: 'I like coffee.', ar: 'احب القهوه.', translit: 'اي لايك كوفي.' },
      ...
      dialogue: [
        ...
        { who: 'A', en: 'I play football. Do you play?', ar: 'العب كره. تلعب؟', translit: 'اي بلاي فوتبول. دو يو بلاي؟' },
    ...
    'at-the-restaurant': {
      ...
      items: [
        {
          ...
          usage: { en: 'The list of food and prices. Ask for it when you sit down.', ar: 'قايمه الاكل والاسعار. اطلبها اول ما تقعد.' },
          sentences: [
        ...
        },
        {
          ...
          usage: { en: 'To ask for your food. "I would like to order" is polite.', ar: 'عشان تطلب اكلك. "ابغى اطلب" مهذبه.' },
          sentences: [
            ...
            { en: 'I will order coffee.', ar: 'باطلب قهوه.', translit: 'اي ويل اوردر كوفي.' },
          ],
        },
        {
          ...
          usage: { en: 'The paper that shows what to pay. Also called the check.', ar: 'الورقه اللي تبين وش تدفع. مثلن يسمونها تشيك.' },
          sentences: [
      ...
      dialogue: [
        ...
        { who: 'B', en: 'Of course. Are you ready to order?', ar: 'اعشاند. جاهز تطلب؟', translit: 'اوف كورس. ار يو ريدي تو اوردر؟' },
        { who: 'A', en: 'Yes, I want coffee and bread.', ar: 'ايه، ابغى قهوه وخبز.', translit: 'يس، اي وانت كوفي اند بريد.' },
        { who: 'B', en: 'Great. I will bring the bill soon.', ar: 'تمام. بجيب الحساب بسرعه.', translit: 'غريت. اي ويل برينق ذا بيل سون.' },
      ],
    },
    'at-the-airport': {
      ...
      items: [
        {
          en: 'gate', ar: 'بوابه', translit: 'غيت', pos: 'noun',
          ipa: '/ɡeɪt/',
          example: { en: 'My gate is number ten.', ar: 'بوابتي رقم عشره.', translit: 'ماي غيت ايز نمبر تن.' },
          usage: { en: 'The door you go through to get on the plane.', ar: 'الباب اللي تدخله عشان تركب الطياره.' },
          sentences: [
            { en: 'Where is the gate?', ar: 'وين البوابه؟', translit: 'وير ايز ذا غيت؟' },
            { en: 'Gate ten.', ar: 'بوابه عشره.', translit: 'غيت تن.' },
            { en: 'My gate is open.', ar: 'بوابتي مفتوحه.', translit: 'ماي غيت ايز اوبن.' },
          ],
        },
        {
          en: 'boarding pass', ar: 'بطاقه الصعود', translit: 'بوردنق باس', pos: 'noun',
          ipa: '/ˈbɔːrdɪŋ pæs/',
          example: { en: 'Here is your boarding pass.', ar: 'هذي بطاقه صعودك.', translit: 'هير ايز يور بوردنق باس.' },
          usage: { en: 'The paper that lets you board the plane.', ar: 'الورقه اللي تخليك تركب الطياره.' },
          sentences: [
            { en: 'My boarding pass.', ar: 'بطاقه صعودي.', translit: 'ماي بوردنق باس.' },
            { en: 'Do you have a boarding pass?', ar: 'عندك بطاقه صعود؟', translit: 'دو يو هاف ا بوردنق باس؟' },
            { en: 'Show your boarding pass.', ar: 'ورني بطاقه صعودك.', translit: 'شو يور بوردنق باس.' },
          ],
        },
        {
          en: 'luggage', ar: 'شنط', translit: 'لاقیج', pos: 'noun',
          ipa: '/ˈlʌɡɪdʒ/',
          example: { en: 'My luggage is heavy.', ar: 'شنطي ثقيله.', translit: 'ماي لاگیج ايز هيفي.' },
          usage: { en: 'Your bags and suitcases. Saudis say شنط for bags.', ar: 'فعلايبك. السعوديين يقولون شنط.' },
          sentences: [
      ...
      dialogue: [
        ...
        { who: 'B', en: 'Gate ten, on the left.', ar: 'بوابه عشره، على اليسار.', translit: 'غيت تن، اون ذا لفت.' },
        { who: 'A', en: 'Here is my boarding pass.', ar: 'هذي بطاقه صعودي.', translit: 'هير ايز ماي بوردنق باس.' },
        { who: 'B', en: 'Thank you. Is your luggage checked?', ar: 'يعطيك العافيه. سجلت شنطك؟', translit: 'ثانك يو. ايز يور لاگیج چکت؟' },
      ],
    },
    'at-the-market': {
      ...
      items: [
        ...
        },
        {
          ...
          ipa: '/tʃiːp/',
          example: { en: 'This is cheap.', ar: 'ذا رخيص.', translit: 'ذس ايز چیپ.' },
          ...
          sentences: [
            ...
            { en: 'A cheap one, please.', ar: 'وواحد رخيص، لو سمحت.', translit: 'ا چیپ وان، بلیز.' },
          ],
        },
        {
          en: 'expensive', ar: 'غالي', translit: 'اکسپنسیو', pos: 'adjective',
          ipa: '/ɪkˈspensɪv/',
          example: { en: 'This is too expensive.', ar: 'ذا غالي مرّه.', translit: 'ذس ایز تو اکسپنسیو.' },
          usage: { en: 'High price. Say "too expensive" to ask for less.', ar: 'سعره عالي. قول "غالی مرّه" عشان يتنازل.' },
          sentences: [
            { en: 'It is expensive.', ar: 'غالي.', translit: 'ات ایز اکسپنسیو.' },
            { en: 'Too expensive.', ar: 'غالي مرّه.', translit: 'تو اکسپنسیو.' },
            { en: 'Is it expensive?', ar: 'غالي؟', translit: 'ايز ات اکسپنسیو؟' },
          ],
        },
      ],
      dialogue: [
        { who: 'A', en: 'How much is this?', ar: 'كم ذا؟', translit: 'هاو مچ ایز ذس؟' },
        { who: 'B', en: 'Fifty riyals.', ar: 'خمسين ريال.', translit: 'فیفتی ریالز.' },
        { who: 'A', en: 'That is too expensive.', ar: 'غالي مرّه.', translit: 'ذات ایز تو اکسپنسیو.' },
        { who: 'B', en: 'OK, forty for you.', ar: 'تمام، اربعين لك.', translit: 'اوکی، فورتی فور یو.' },
      ],
    },
    'weather-and-seasons': {
      title: { en: 'Weather & Seasons', ar: 'الطقس والينصول' },
      items: [
        {
          en: 'hot', ar: 'حار', translit: 'هات', pos: 'adjective',
          ipa: '/hɒt/',
          example: { en: 'It is hot today.', ar: 'الجو حار اليوم.', translit: 'ات ایز هات تودای.' },
          usage: { en: 'High temperature. Very common in Saudi summer.', ar: 'حرارته عاليه. شايع بصيف السعوديه.' },
          sentences: [
        ...
        },
        {
          ...
          usage: { en: 'Low temperature. The opposite is hot.', ar: 'حرارته واطيه. العكس حار.' },
          sentences: [
      ...
      dialogue: [
        ...
        { who: 'B', en: 'Yes, very hot.', ar: 'ايه، حار مرّه.', translit: 'یس، ویری هات.' },
    ...
    'southern-saudi-phrases': {
      title: { en: 'Southern Saudi Phrases', ar: 'عبارات جنوبيه' },
      items: [
        {
          ...
          usage: { en: 'A warm southern way to ask how someone is.', ar: 'طريقه جنوبيه دافيه تسال فيها عن حال الشخص.' },
          sentences: [
        ...
        },
        {
          ...
          ipa: '/ɪt ɪz faɪn/',
          example: { en: 'It is fine, no problem.', ar: 'ماشي، ما في مشكله.', translit: 'ات ایز فاین، نو پرابلم.' },
          usage: { en: 'Southern "ماشي" means okay, it works, no worries.', ar: 'باللهجه الجنوبيه "ماشي" يعني تمام، ما في مشكله.' },
          sentences: [
            { en: 'It is fine.', ar: 'ماشي.', translit: 'ات ایز فاین.' },
            { en: 'It is fine, thank you.', ar: 'ماشي، شكرا.', translit: 'ات ایز فاین، ثانک یو.' },
        ...
        },
        {
          ...
          usage: { en: 'Add something extra. Southern "ترى" softens a point.', ar: 'تضيف شي. "ترى" بالجنوب تلطف اللام.' },
          sentences: [
      ...
      dialogue: [
        ...
        { who: 'B', en: 'It is fine, thank you.', ar: 'ماشي، شكرا.', translit: 'ات ایز فاین، ثانک یو.' },
        { who: 'A', en: 'By the way, are you free today?', ar: 'ترى، فاضي اليوم؟', translit: 'بای ذا وای، ار یو فری تودای؟' },
        { who: 'B', en: 'Yes, see you later.', ar: 'ايه، اشوفك لسهين.', translit: 'یس، سی یو لیتر.' },
      ],
    },
    'work-and-jobs': {
      ...
      dialogue: [
        ...
        { who: 'B', en: 'Yes, see you after the meeting.', ar: 'ايه، اشوفك لسه الاجتماع.', translit: 'یس، سی یو افتر ذا میتینق.' },
      ],
    },
    'at-the-hotel': {
      title: { en: 'At the Hotel', ar: 'في الينندق' },
      items: [
        { en: 'reservation', ar: 'حجز', translit: 'ريزيرفيشن', pos: 'noun', ipa: '/ˌrezərˈveɪʃən/',
          ...
          sentences: [
            ...
            { en: 'I have a reservation for tonight.', ar: 'عندي حجز الليله.', translit: 'اي هاف ا ريزيرفيشن فور تونايت.' },
        ...
        { en: 'check in', ar: 'تسجيل دخول', translit: 'تشيك ان', pos: 'phrase', ipa: '/tʃɛk ɪn/',
          ...
          sentences: [
            ...
            { en: 'Can I check in now?', ar: 'ايمكنر اسجل دخول الحين؟', translit: 'كان اي تشيك ان ناو؟' },
            { en: 'Check in is at two.', ar: 'التسجيل الساعه اثنين.', translit: 'تشيك ان ايز ات تو.' },
          ],
        },
        { en: 'room key', ar: 'مفتاح الغرفه', translit: 'روم عشان', pos: 'phrase', ipa: '/ruːm kiː/',
          example: { en: 'Where is my room key?', ar: 'وين مفتاح غرفتي؟', translit: 'وير از ماي روم عشان؟' },
          usage: { en: 'Ask for the card that opens your room.', ar: 'اطلب الكرت اللي يفتح غرفتك.' },
          sentences: [
            { en: 'Where is my room key?', ar: 'وين مفتاح غرفتي؟', translit: 'وير از ماي روم عشان؟' },
            { en: 'I lost my room key.', ar: 'ضيعت مفتاح غرفتي.', translit: 'اي لوست ماي روم عشان.' },
            { en: 'Can I have a new room key?', ar: 'تعطيني مفتاح جديد؟', translit: 'كان اي هاف ا نيو روم عشان؟' },
          ],
        },
      ],
      dialogue: [
        ...
        { who: 'B', en: 'Here is your room key. Enjoy your stay.', ar: 'ذا مفتاح غرفتك. نورت.', translit: 'هير از يور روم عشان. انجوي يور ستاي.' },
      ],
    },
    'at-the-pharmacy': {
      title: { en: 'At the Pharmacy', ar: 'في الصيدليه' },
      items: [
        ...
        { en: 'medicine', ar: 'دوا', translit: 'ميديسن', pos: 'noun', ipa: '/ˈmɛdɪsən/',
          ...
          sentences: [
            ...
            { en: 'Do you have medicine for a fever?', ar: 'عندك دوا للحراره؟', translit: 'دو يو هاف ميديسن فور ا فيفر؟' },
            { en: 'Take this medicine twice a day.', ar: 'خذ ذا الدوا مرتين باليوم.', translit: 'تيك ذس ميديسن تويس ا داي.' },
          ],
        },
        { en: 'prescription', ar: 'وصفه', translit: 'بريسكريبشن', pos: 'noun', ipa: '/prɪˈskrɪpʃən/',
          example: { en: 'I have a prescription.', ar: 'عندي وصفه.', translit: 'اي هاف ا بريسكريبشن.' },
          usage: { en: 'A paper from the doctor that lets you get medicine.', ar: 'ورقه من الطبيب تيمكنر تجيب منها الدوا.' },
          sentences: [
            { en: 'I have a prescription.', ar: 'عندي وصفه.', translit: 'اي هاف ا بريسكريبشن.' },
            { en: 'Here is my prescription.', ar: 'هذي وصفتي.', translit: 'هير از ماي بريسكريبشن.' },
            { en: 'Do I need a prescription?', ar: 'لازم وصفه؟', translit: 'دو اي نيد ا بريسكريبشن؟' },
          ],
        },
      ],
      dialogue: [
        ...
        { who: 'B', en: 'Take this medicine twice a day.', ar: 'خذ ذا الدوا مرتين باليوم.', translit: 'تيك ذس ميديسن تويس ا داي.' },
      ],
    },
    'at-the-bank': {
      ...
      items: [
        { en: 'deposit', ar: 'ايداع', translit: 'ديبوزيت', pos: 'noun', ipa: '/dɪˈpɒzɪt/',
          ...
          sentences: [
            ...
            { en: 'Can I deposit a cheque?', ar: 'ايمكنر اودع شيك؟', translit: 'كان اي ديبوزيت ا تشيك؟' },
          ],
        },
        { en: 'withdraw', ar: 'سحب', translit: 'ويذ درو', pos: 'verb', ipa: '/wɪθˈdrɔː/',
          ...
          sentences: [
            ...
            { en: 'Withdraw five hundred riyals.', ar: 'اسحب خمسميه ريال.', translit: 'ويذ درو فايف هندرد ريالز.' },
            { en: 'Where can I withdraw cash?', ar: 'وين ايمكنر اسحب كاش؟', translit: 'وير كان اي ويذ درو كاش؟' },
          ],
        },
        { en: 'transfer', ar: 'تحويل', translit: 'ترانسفر', pos: 'verb', ipa: '/ˈtrænsfɜːr/',
          ...
          sentences: [
            ...
            { en: 'Transfer it to this account.', ar: 'حوله لذلك الحساب.', translit: 'ترانسفر ات تو ذس اكونت.' },
      ...
      dialogue: [
        ...
        { who: 'A', en: 'One thousand riyals.', ar: 'الين ريال.', translit: 'وان ثاوزند ريالز.' },
        { who: 'B', en: 'Please sign here. Done.', ar: 'وقّع هنا. تم.', translit: 'بليز سوين هير. بدون.' },
      ],
    },
    'phone-calls': {
      title: { en: 'Phone Calls', ar: 'المكالمات' },
      items: [
        { en: 'call back', ar: 'اتصل لافعلاً', translit: 'كول باك', pos: 'phrase', ipa: '/kɔːl bæk/',
          example: { en: 'I will call you back.', ar: 'برد عليك.', translit: 'اي ويل كول يو باك.' },
          usage: { en: 'Say this when you cannot talk now.', ar: 'تقولها اذا ما تيمكنر ت تكلم الحين.' },
          sentences: [
            { en: 'I will call you back.', ar: 'برد عليك.', translit: 'اي ويل كول يو باك.' },
            { en: 'Can I call you back?', ar: 'ايمكنر ارد عليك؟', translit: 'كان اي كول يو باك؟' },
            { en: 'Please call me back later.', ar: 'رد عليّ لسهين.', translit: 'بليز كول مي باك ليتير.' },
          ],
        },
        { en: 'leave a message', ar: 'ترك رساله', translit: 'ليف ا مسيج', pos: 'phrase', ipa: '/liːv ə ˈmɛsɪdʒ/',
          example: { en: 'Can I leave a message?', ar: 'ايمكنر اترك رساله؟', translit: 'كان اي ليف ا مسيج؟' },
          usage: { en: 'Ask to leave words for someone who is busy.', ar: 'تطلب تترك لام لشخص مشغول.' },
          sentences: [
            { en: 'Can I leave a message?', ar: 'ايمكنر اترك رساله؟', translit: 'كان اي ليف ا مسيج؟' },
            { en: 'I will leave a message.', ar: 'بترك رساله.', translit: 'اي ويل ليف ا مسيج.' },
            { en: 'Please leave a message after the beep.', ar: 'اترك رساله لسه الصفير.', translit: 'بليز ليف ا مسيج افتر ذا بيب.' },
          ],
        },
        { en: 'the line is bad', ar: 'الاشاره ضعيفه', translit: 'ذا لوين ايز باد', pos: 'phrase', ipa: '/ðə laɪn ɪz bæd/',
          example: { en: 'Sorry, the line is bad.', ar: 'عذراً، الاشاره ضعيفه.', translit: 'سوري، ذا لوين ايز باد.' },
          usage: { en: 'Say this when you cannot hear well.', ar: 'تقولها اذا ما تسمع زين.' },
          sentences: [
            { en: 'Sorry, the line is bad.', ar: 'عذراً، الاشاره ضعيفه.', translit: 'سوري، ذا لوين ايز باد.' },
            { en: 'The line is bad, call me back.', ar: 'الاشاره ضعيفه، رد عليّ.', translit: 'ذا لوين ايز باد، كول مي باك.' },
            { en: 'Can you hear me? The line is bad.', ar: 'تسمعني؟ الاشاره ضعيفه.', translit: 'كان يو هير مي؟ ذا لوين ايز باد.' },
          ],
        },
      ],
      dialogue: [
        { who: 'A', en: 'Hello, is Firas there?', ar: 'هلا، فراس موجود؟', translit: 'هلو، از فراس ذير؟' },
        { who: 'B', en: 'He is busy. Can I leave a message?', ar: 'مشغول. ايمكنر اترك رساله؟', translit: 'ه ايز بيزي. كان اي ليف ا مسيج؟' },
        { who: 'A', en: 'Yes, I will call back later.', ar: 'ايه، برد لسهين.', translit: 'یس، اي ويل كول باك ليتیر.' },
        { who: 'B', en: 'Sorry, the line is bad. Say that again.', ar: 'عذراً، الاشاره ضعيفه. كرر.', translit: 'سوری، ذا لوين ایز باد. سی ذات اقیین.' },
      ],
    },
    'at-the-barber': {
      ...
      items: [
        ...
        { en: 'just a trim', ar: 'تخفيف بس', translit: 'جاست ا ترم', pos: 'phrase', ipa: '/dʒʌst ə trɪm/',
          ...
          usage: { en: 'Cut only a little, not a big change.', ar: 'قص بسيط، ببدون تغيير كبير.' },
          sentences: [
        ...
        { en: 'shorter on the sides', ar: 'قص الاطراف', translit: 'شورتر اون ذا سايدز', pos: 'phrase', ipa: '/ˈʃɔːrtər ɒn ðə saɪdz/',
          ...
          sentences: [
            ...
            { en: 'Shorter on top, not the sides.', ar: 'قص الينوق، مو الاطراف.', translit: 'شورتر اون توب، نات ذا سایدز.' },
          ],
        },
      ],
      dialogue: [
        ...
        { who: 'A', en: 'Shorter on the sides too?', ar: 'نقص الاطراف لسه؟', translit: 'شورتر اون ذا سایدز تو؟' },
        { who: 'B', en: 'Yes, and short on top.', ar: 'ايه، وقص الينوق.', translit: 'یس، اند شورت اون توب.' },
      ],
    },
    'technology-and-phone': {
      ...
      items: [
        { en: 'wifi', ar: 'واي فاي', translit: 'واي فاي', pos: 'noun', ipa: '/ˈwaɪ faɪ/',
          ...
          usage: { en: 'The wireless internet in a place.', ar: 'النت اللاسعشان في المكان.' },
          sentences: [
        ...
        { en: 'password', ar: 'كلمه المرور', translit: 'باسوورد', pos: 'noun', ipa: '/ˈpæswɜːrd/',
          example: { en: 'I forgot my password.', ar: 'نسيت كلمه المرور.', translit: 'اي فورقوت ماي باسوورد.' },
          usage: { en: 'The secret word that unlocks your phone or account.', ar: 'الكلمه السر اللي يفتح جوالك او حسابك.' },
          sentences: [
            { en: 'I forgot my password.', ar: 'نسيت كلمه المرور.', translit: 'اي فورقوت ماي باسوورد.' },
            { en: 'What is the password?', ar: 'وش الرقم؟', translit: 'وات از ذا باسوورد؟' },
            { en: 'Reset your password here.', ar: 'اعاده ضبط الرقم هنا.', translit: 'ریست یور باسوورد هیر.' },
          ],
        },
        { en: 'charge my phone', ar: 'اشحن جوالي', translit: 'تشارج ماي فون', pos: 'phrase', ipa: '/tʃɑːrdʒ maɪ foʊn/',
          ...
          usage: { en: 'When the battery is low and you need power.', ar: 'اذا البطاريه ضعيفه وابغى كهربه.' },
          sentences: [
      ...
      dialogue: [
        ...
        { who: 'A', en: 'I forgot my password too.', ar: 'نسيت رقمي لسه.', translit: 'اي فورقوت ماي باسوورد تو.' },
        { who: 'B', en: 'No problem. Charge my phone first.', ar: 'ولا يهمك. اشحن جوالي اول.', translit: 'نو پروبلم. تشارج ماي فون فیرست.' },
      ],
    },
    'job-interview': {
      title: { en: 'Job Interview', ar: 'مقابله عمل' },
      items: [
        { en: 'experience', ar: 'خبره', translit: 'اكسبيرينس', pos: 'noun', ipa: '/ɪkˈspɪriəns/',
          example: { en: 'I have two years of experience.', ar: 'عندي سنتين خبره.', translit: 'اي هاف تو ييرز اوف اكسبيرينس.' },
          usage: { en: 'The work you have done before.', ar: 'الشغل اللي اشتغلته قبل.' },
          sentences: [
            { en: 'I have two years of experience.', ar: 'عندي سنتين خبره.', translit: 'اي هاف تو يیرز اوف اكسبيرینس.' },
            { en: 'I have sales experience.', ar: 'عندي خبره مبيعات.', translit: 'اي هاف سیلز اكسبيرینس.' },
            { en: 'Do you have experience?', ar: 'عندك خبره؟', translit: 'دو يو هاف اكسبيرینس؟' },
          ],
        },
        { en: 'strengths', ar: 'نقاط قوه', translit: 'سترونقثس', pos: 'noun', ipa: '/strɛŋθs/',
        ...
        { en: 'I am good at', ar: 'انا ممتاز في', translit: 'اي ام غود ات', pos: 'phrase', ipa: '/aɪ æm ɡʊd æt/',
          example: { en: 'I am good at English.', ar: 'ممتاز بالحينجليزي.', translit: 'اي ام غود ات انقلیش.' },
          usage: { en: 'Say what skill you do well.', ar: 'قل وش المهاره اللي تبدع فيها.' },
          sentences: [
            { en: 'I am good at English.', ar: 'ممتاز بالحينجليزي.', translit: 'اي ام غود ات انقلیش.' },
      ...
      dialogue: [
        ...
        { who: 'B', en: 'I have two years of experience.', ar: 'عندي سنتين خبره.', translit: 'اي هاف تو ییرز اوف اكسبيرینس.' },
        { who: 'A', en: 'What are your strengths?', ar: 'وش نقاط قوتك؟', translit: 'وات ار یور سترونقثس؟' },
        { who: 'B', en: 'I am good at teamwork and English.', ar: 'ممتاز بالشغل الجماعي والحينجليزي.', translit: 'اي ام غود ات تیموورك اند انقلیش.' },
      ],
    },
    'emergency-and-help': {
      title: { en: 'Emergencies & Help', ar: 'الطواري والنجده' },
      items: [
        { en: 'help', ar: 'نجده', translit: 'هيلب', pos: 'phrase', ipa: '/hɛlp/',
          example: { en: 'I need help!', ar: 'ابغى مساعده!', translit: 'اي نید هيلب!' },
          usage: { en: 'Call this when you are in danger.', ar: 'نادهيها اذا كنت بخطر.' },
          sentences: [
            { en: 'I need help!', ar: 'ابغى مساعده!', translit: 'اي نید هیلب!' },
            { en: 'Can you help me?', ar: 'تيمكنر تساعدني؟', translit: 'كان يو هیلب مي؟' },
        ...
        { en: 'call an ambulance', ar: 'اتصل بالاسعاف', translit: 'كول ان امبولانس', pos: 'phrase', ipa: '/kɔːl ən ˈæmbjələns/',
          ...
          usage: { en: 'When someone is badly hurt or sick.', ar: 'اذا في واحد متوعك او مصاب.' },
          sentences: [
        ...
        { en: 'where is the nearest', ar: 'وين اقرب', translit: 'وير از ذا نيرست', pos: 'phrase', ipa: '/wɛər ɪz ðə ˈnɪrəst/',
          ...
          sentences: [
            ...
            { en: 'Where is the nearest pharmacy?', ar: 'وين اقرب صيدليه؟', translit: 'ویر از ذا نیرست فارماسی؟' },
            { en: 'Where is the nearest exit?', ar: 'وين اقرب مخرج؟', translit: 'ویر از ذا نیرست اكزیت؟' },
          ],
        },
      ],
      dialogue: [
        { who: 'A', en: 'Are you okay? You need help?', ar: 'انت بخير؟ تبغى مساعده؟', translit: 'ار يو اوكاي؟ يو نید هیلب؟' },
  ...
  const PEL_BEGINNER_PHASES = [
    ...
    { id:'phase-2', title:{en:'People & Family', ar:'الناس والعايله'}, lessons:['family-members','feelings-and-emotions','subject-pronouns','be-verb','this-and-that'] },
    { id:'phase-3', title:{en:'Everyday Words', ar:'كلمات يوميه'}, lessons:['food-and-drinks','classroom-words','body-parts','clothes','home-and-rooms'] },
    ...
    { id:'phase-8', title:{en:'Real-Life Situations', ar:'مواقف الحياه'}, lessons:['at-the-hotel','at-the-pharmacy','at-the-bank','phone-calls','at-the-barber','technology-and-phone','job-interview','emergency-and-help'] },
  ];

  /* Generic starter set used when a lesson has no vocab at all. */
  const PEL_STARTER_ITEMS = [
    {
      en: 'thank you', ar: 'شكرا', translit: 'ثانك يو', pos: 'phrase',
      example: { en: 'Thank you for your help.', ar: 'شكرا على مساعدتك.', translit: 'ثانك يو فور يور هيلب.' },
      usage: { en: 'Polite way to show gratitude.', ar: 'طريقه مهذبه تشكر فيها.' },
      sentences: [
        { en: 'Thank you.', ar: 'شكرا.', translit: 'ثانك يو.' },
        { en: 'Thank you very much.', ar: 'شكرا جزيلاً.', translit: 'ثانك يو فري موتش.' },
        { en: 'Are you saying thank you?', ar: 'تقول شكرا؟', translit: 'ار يو سيينق ثانك يو؟' },
      ],
    },
    {
      en: 'please', ar: 'من فضلك', translit: 'بليز', pos: 'phrase',
      example: { en: 'Please, can you help me?', ar: 'من فضلك، تيمكنر تساعدني؟', translit: 'بليز، كان يو هيلب مي؟' },
      usage: { en: 'Makes a request polite.', ar: 'تخلي الطلب مهذب.' },
      sentences: [
        { en: 'Please help me.', ar: 'ساعدني من فضلك.', translit: 'بليز هيلب مي.' },
        { en: 'Can you help me, please?', ar: 'تيمكنر تساعدني، من فضلك؟', translit: 'كان يو هيلب مي، بليز؟' },
      ],
    },
  ];
...
.pel-stage-top{display:flex;align-items:center;gap:14px;padding:16px 22px;border-bottom:1px solid var(--stage-bar-border);background:var(--stage-bar-bg);backdrop-filter:blur(8px);flex-shrink:0;}
...
.pel-stage-body{flex:1;overflow-y:auto;display:flex;flex-direction:column;align-items:center;justify-content:flex-start;padding:30px 20px 90px;}
.pel-activity-card{width:100%;max-width:680px;position:relative;margin:0 auto;}
...
.pel-stage-foot{flex-shrink:0;border-top:1px solid var(--stage-bar-border);background:var(--stage-bar-bg);backdrop-filter:blur(8px);padding:16px 22px;display:flex;align-items:center;gap:14px;}
...
/* ---- Light mode overrides for lesson stage ---- */
html[data-theme="light"] .pel-act-card-inner{background:linear-gradient(180deg, rgba(0,0,0,.006), transparent 40%), var(--card);border-color:var(--border);box-shadow:0 1px 2px rgba(0,0,0,.04), 0 4px 16px -8px rgba(0,0,0,.06);}
html[data-theme="light"] .pel-teach-word{background:linear-gradient(135deg, rgba(0,113,227,.04), transparent 60%), var(--card-elevated);border-color:var(--border);}
html[data-theme="light"] .pel-teach-grammar{background:rgba(0,113,227,.05);border-color:rgba(0,113,227,.12);}
html[data-theme="light"] .pel-act-hint{background:linear-gradient(180deg, rgba(0,0,0,.008), transparent 50%), var(--card-elevated);}
html[data-theme="light"] .pel-option{background:linear-gradient(180deg, rgba(0,0,0,.006), transparent 50%), var(--card-elevated);border-color:var(--border);}
html[data-theme="light"] .pel-option:hover{border-color:rgba(0,113,227,.35);background:linear-gradient(180deg, rgba(0,113,227,.04), transparent 50%), var(--card);}
html[data-theme="light"] .pel-option.correct{border-color:var(--success);background:linear-gradient(180deg, rgba(29,122,78,.06), transparent 50%), var(--card-elevated);}
html[data-theme="light"] .pel-option.wrong{border-color:var(--danger);background:linear-gradient(180deg, rgba(184,68,46,.06), transparent 50%), var(--card-elevated);}
html[data-theme="light"] .pel-act-primary{background:linear-gradient(135deg, #9A7B3E, var(--gold) 50%, var(--bronze));color:#FFFFFF;box-shadow:inset 0 1px 0 rgba(255,255,255,.2), 0 4px 14px -6px rgba(0,113,227,.4);}
html[data-theme="light"] .pel-act-primary:hover{filter:brightness(1.03);box-shadow:inset 0 1px 0 rgba(255,255,255,.25), 0 0 32px -8px rgba(0,113,227,.3), 0 8px 24px -8px rgba(0,113,227,.45);}
html[data-theme="light"] .pel-stage-back:hover{background:linear-gradient(180deg, rgba(0,0,0,.008), transparent 50%), var(--card-elevated);}
html[data-theme="light"] .pel-conv-line.A{background:linear-gradient(180deg, rgba(0,0,0,.008), transparent 50%), var(--card-elevated);}
html[data-theme="light"] .pel-conv-line.B{background:linear-gradient(180deg, rgba(0,113,227,.06), transparent 50%), var(--card-elevated);border-color:rgba(0,113,227,.12);}
html[data-theme="light"] .pel-token{background:linear-gradient(135deg, #F5F5F7, #EFEFF2 60%, #EBEBEE);border-color:var(--border);box-shadow:inset 0 1px 0 rgba(255,255,255,.8);}
html[data-theme="light"] .pel-tile{background:linear-gradient(135deg, #F5F5F7, #EFEFF2 60%, #EBEBEE);border-color:var(--border);box-shadow:inset 0 1px 0 rgba(255,255,255,.8);}
html[data-theme="light"] .pel-input{background:linear-gradient(180deg, rgba(0,0,0,.006), transparent 50%), var(--card-elevated);border-color:var(--border);}
html[data-theme="light"] .pel-arrange-drop{border-color:var(--border);background:rgba(0,0,0,.006);}
html[data-theme="light"] .pel-concept-ex{background:rgba(0,113,227,.04);border-color:rgba(0,113,227,.1);}
html[data-theme="light"] .pel-concept-step{background:linear-gradient(180deg, rgba(0,0,0,.006), transparent 50%), var(--card-elevated);border-color:var(--border);}
html[data-theme="light"] .pel-teach-glossary-item{background:linear-gradient(180deg, rgba(0,0,0,.006), transparent 50%), var(--card-elevated);border-color:var(--border);}
html[data-theme="light"] .pel-stage-done .pel-done-row .pel-tool-link{background:linear-gradient(180deg, rgba(0,0,0,.006), transparent 50%), var(--card-elevated);border-color:var(--border);}
html[data-theme="light"] .pel-act-primary.ghost{background:linear-gradient(180deg, rgba(0,0,0,.008), transparent 60%);color:var(--text);border-color:var(--border);}
html[data-theme="light"] .pel-act-en{color:var(--text);}
html[data-theme="light"] .pel-feedback.ok{color:var(--success);}
html[data-theme="light"] .pel-feedback.no{color:var(--danger);}
@media(max-width:900px){
  .pel-act-card-inner{padding:28px 22px 26px;}
  .pel-stage-body{padding:26px 16px 80px;}
...
@media(max-width:680px){
  ...
  .pel-stage-body{padding:22px 14px 80px;}
}`;
  ...
  function usageHtml(u){
    ...
    const en = u.en?`<div class="pel-act-hint" dir="ltr">${esc(u.en)}</div>`:'';
  ...
  function makeWrongSentence(it){
    ...
    const rules = [
      ...
      [/^(he|she|it) doesn't\b/i, (m,p)=>p+" don't"],
      [/^(i|you|we|they) don't\b/i, (m,p)=>p+" doesn't"],
      // Article errors: flip correct a/an to wrong a/an
      [/^an ([aeiou])/i, 'A $1'],
      [/^a ([^aeiou])/i, 'An $1']
    ];
  ...
  function sayNo(){ return L('Try again','حاول مره ثانيه'); }
  ...
  function buildConversation(lesson, lessonId){
    ...
    if(!conv) conv = [{who:'A',en:'Hello!',ar:'هلا!',translit:'هلو!'},{who:'B',en:'Hi, how are you?',ar:'هلا، عشانفك؟',translit:'هاي، هاو ار يو؟'}];
  ...
  const PEL_MIN_PAIRS = [
    { contrast:'/p/ vs /b/', target:'pen', confusion:'ben', ar:'قلم', tipAr:'صوت P يطلع بهوا من الشفايف، B صوتها من الحلق. جرب قول بن لسهين پن.' },
    { contrast:'/p/ vs /b/', target:'park', confusion:'bark', ar:'متنزه', tipAr:'P فيها هوا، B ما فيها. حط يدك على شفايفك وحس بالينرق.' },
    { contrast:'/f/ vs /v/', target:'very', confusion:'fery', ar:'مره', tipAr:'V فيها اهتزاز بالشفه، F ما فيها. حط يدك على حنجرتك حس الاهتزاز.' },
    { contrast:'/f/ vs /v/', target:'five', confusion:'fife', ar:'خمسه', tipAr:'اخرها V خفيفه مع اهتزاز، مو F قويه.' },
    { contrast:'th vs s', target:'think', confusion:'sink', ar:'افكر', tipAr:'TH يطلع من بين الاسنان، S من ورا الاسنان. حط لسانك بين اسنانك.' },
    { contrast:'th vs s', target:'thank', confusion:'sank', ar:'شكرا', tipAr:'نفس الينكره، اللسان يطلع برا بين الاسنان.' },
    { contrast:'th vs z', target:'this', confusion:'zis', ar:'ذا', tipAr:'TH الصوت الثاني (ذ) يطلع من بين الاسنان، Z من وراها.' },
    { contrast:'/t/ vs /d/', target:'time', confusion:'dime', ar:'وقت', tipAr:'T ببدون صوت، D بصوت. حط يدك على حنجرتك.' },
    { contrast:'/ch/ vs /sh/', target:'chair', confusion:'share', ar:'كرسي', tipAr:'CH قويه مثل تش، SH ناعمه مثل ش.' },
    { contrast:'/r/ vs /l/', target:'red', confusion:'led', ar:'احمر', tipAr:'R يلف اللسان، L يلمس سقف الينم.' },
  ];
  ...
  const PEL_INTONATION_EX = [
    { sentence:'Are you coming', question:'Are you coming?', statement:'You are coming.',
      ar:'انت جاي', questionMeaning:'سوال', statementMeaning:'جمله خبريه' },
    { sentence:'Is she here', question:'Is she here?', statement:'She is here.',
      ar:'هي هنا', questionMeaning:'سوال', statementMeaning:'جمله خبريه' },
    { sentence:'Do you like it', question:'Do you like it?', statement:'You like it.',
      ar:'يعجبك', questionMeaning:'سوال', statementMeaning:'جمله خبريه' },
    { sentence:'Are they ready', question:'Are they ready?', statement:'They are ready.',
      ar:'هم جاهزين', questionMeaning:'سوال', statementMeaning:'جمله خبريه' },
  ];
  ...
  const PEL_WRITING_PROMPTS = [
    { ar:'رتب: اسمي احمد.', en:'My name is Ahmed.', answer:'My name is Ahmed.', hint:'Start with capital letter.', keywords:['name','اسم','احمد'] },
    { ar:'رتب: انا من السعوديه.', en:'I am from Saudi Arabia.', answer:'I am from Saudi Arabia.', hint:'Capitalize country name.', keywords:['saudi','arabia','السعوديه','country','بلد'] },
    { ar:'رتب: عشانفك؟', en:'How are you?', answer:'How are you?', hint:'Question mark in English is ?', keywords:['how are you','عشانفك','greeting','تحيه'] },
    { ar:'رتب: شكرا كثير.', en:'Thank you very much.', answer:'Thank you very much.', hint:'Capitalize the first letter.', keywords:['thank','شكرا','grateful'] },
    { ar:'رتب: انا طالب.', en:'I am a student.', answer:'I am a student.', hint:'Use a before student.', keywords:['student','طالب','school','مدرسه'] },
    { ar:'رتب: انا ابي قهوه.', en:'I want coffee.', answer:'I want coffee.', hint:'No need for please here.', keywords:['coffee','قهوه','want','ابي','order','طلب'] },
    { ar:'رتب: وين الحمام؟', en:'Where is the bathroom?', answer:'Where is the bathroom?', hint:'Start with Where.', keywords:['bathroom','حمام','where','وين','direction'] },
    { ar:'رتب: كم الساعه؟', en:'What time is it?', answer:'What time is it?', hint:'Question form.', keywords:['time','ساعه','clock','time is it'] },
  ];
  ...
  const PEL_SCENARIO_TASKS = [
    {
      ...
      contextAr:'انت تتصل بعياده الدكتور. الموظفه ردت على الاتصال. لازم تحجز موعد.',
      turns:[
        {
          npc:'Receptionist: "Hello, doctor office. How can I help you?"',
          promptAr:'وش تقول؟',
          options:[
            { text:'I want see doctor.', ok:false, whyAr:'ناقص فعل. قل: I want to see the doctor. لازم to قبل الينعل.', outcomeAr:'الموظفه: "Sorry? Can you say that again?"' },
            { text:'I would like to make an appointment, please.', ok:true, whyAr:'ممتاز! قلت would like to + فعل + please. مهذب وواضح.', outcomeAr:'الموظفه: "Sure! What day works for you?"' },
            { text:'Doctor. Me. Now.', ok:false, whyAr:'جمله غير مفهومه. الحينجليزي يحتاج فاعل + فعل. قل: I need to see the doctor.', outcomeAr:'الموظفه: "Im sorry, I didnt understand."' },
          ],
        },
        {
          ...
          promptAr:'اختار موعد:',
          options:[
            { text:'Tuesday is good for me.', ok:true, whyAr:'كويس! قلت اليوم + is good for me. طريقه طبيعيه لاختيار الموعد.', outcomeAr:'الموظفه: "Great, Tuesday at 10. Whats your name?"' },
            { text:'I want Tuesday not Thursday I dont like Thursday.', ok:false, whyAr:'جمله طويله ببدون نقطه. قسمها: Tuesday, please. اسهل واوضح.', outcomeAr:'الموظفه: "So... Tuesday then?"' },
            { text:'Tuesday good.', ok:false, whyAr:'ناقص فعل. قل: Tuesday is good. لازم is.', outcomeAr:'الموظفه: "Im sorry, is Tuesday okay?"' },
          ],
        },
        {
          npc:'Receptionist: "Thank you. See you Tuesday at 10."',
          promptAr:'اختتم المكالمه:',
          options:[
            { text:'Thank you. Goodbye.', ok:true, whyAr:'ممتاز! شكرت وودعت. طريقه مهذبه لانها المكالمه.', outcomeAr:'تم حجز الموعد. احسنت!' },
            { text:'Bye.', ok:false, whyAr:'صح بس مو مهذب. زي رد بسرعه ببدون شكر. قل: Thank you, goodbye.', outcomeAr:'الموظفه: "...Goodbye."' },
            { text:'Nothing.', ok:false, whyAr:'لازم ترد. الصمت مو مهذب في الحينجليزي. قل: Thank you, goodbye.', outcomeAr:'الموظفه: "Hello? Are you there?"' },
          ],
        },
      ],
    },
    {
      id:'coffee',
      goal:{ en:'Order coffee at a cafe', ar:'اطلب قهوه في كافيه' },
      contextAr:'انت في كافيه. الكاشير سالك وش تبي. لازم تطلب قهوه.',
      turns:[
        {
          ...
          options:[
            ...
            { text:'Coffee.', ok:false, whyAr:'كلمه وحده ببدون فعل. قل: I want a coffee, please. اوضح واكثر مهذب.', outcomeAr:'الباريستا: "Sorry, one coffee?"' },
        ...
        },
        {
          ...
          options:[
            { text:'A medium, please.', ok:true, whyAr:'كويس! قلت a + حجم + please. طريقه طبيعيه.', outcomeAr:'الباريستا: "Medium! Coming right up."' },
        ...
        },
        {
          ...
          options:[
            { text:'Thank you! You too.', ok:true, whyAr:'ممتاز! شكرت وردت على الدعوه. طريقه مهذبه مره.', outcomeAr:'استلمنا القهوه. احسنت!' },
            { text:'OK.', ok:false, whyAr:'OK بس مو كافي. قل: Thank you. اظهر شكرك.', outcomeAr:'الباريستا: "...Thanks."' },
            { text:'Whatever.', ok:false, whyAr:'Whatever وقحه. قل: Thank you. مهذب دايما.', outcomeAr:'الباريستا: "...Have a nice day."' },
          ],
        },
      ],
    },
    {
      id:'directions',
      goal:{ en:'Ask for directions to the nearest pharmacy', ar:'اسال عن طريق اقرب صيدليه' },
      contextAr:'انت في الشارع. راح لشخص وسالته عن الصيدليه. لازم تعرف الوين.',
      turns:[
        {
          npc:'Stranger: "Oh, there is one on this street."',
          promptAr:'عشان تكمل، وش تسال؟',
          options:[
            { text:'Where is it exactly?', ok:true, whyAr:'ممتاز! سوال واضح ومهذب. where is + it + exactly.', outcomeAr:'الشخص: "Its next to the supermarket."' },
            { text:'Where?', ok:false, whyAr:'Where? وحده قصيره. قل: Where is it? اكمل السوال.', outcomeAr:'الشخص: "Sorry? Where what?"' },
        ...
        },
        {
          ...
          promptAr:'تاكدت من الينهم. وش تقول؟',
          options:[
            { text:'Thank you. Is it far from here?', ok:true, whyAr:'ممتاز! شكرت وسالت سوال متابع. طريقه طبيعيه للمحادثه.', outcomeAr:'الشخص: "No, just two minutes walk."' },
            { text:'How far?', ok:false, whyAr:'How far? قصيره. قل: How far is it? كمل السوال.', outcomeAr:'الشخص: "Not far."' },
            { text:'OK whatever close or far just tell me.', ok:false, whyAr:'جمله غير مفهومه وغير مهذبه. قل: How far is it from here?', outcomeAr:'الشخص: "...Its close."' },
          ],
        },
        {
          npc:'Stranger: "Just two minutes. You cant miss it!"',
          promptAr:'اختمن المحادثه:',
          options:[
            { text:'Thank you so much!', ok:true, whyAr:'ممتاز! شكرت بحراره. طريقه ممتازه لانها المحادثه.', outcomeAr:'وصلت الصيدليه. احسنت!' },
            { text:'Bye.', ok:false, whyAr:'Bye ببدون شكر. قل: Thank you. اظهر شكرك دايما.', outcomeAr:'الشخص: "...Bye."' },
    ...
    },
    {
      ...
      contextAr:'انت في المطار. راح لكاونتر الطيران. الموظف سالك عن الجواز.',
      turns:[
        {
          npc:'Agent: "Good morning! May I have your passport, please?"',
          promptAr:'وش تقول وانت تعطيه الجواز؟',
          options:[
            { text:'Here you are.', ok:true, whyAr:'ممتاز! Here you are طريقه مهذبه وطبيعيه لتيمكنيم شي.', outcomeAr:'الموظف: "Thank you. Where are you flying today?"' },
            { text:'Take.', ok:false, whyAr:'Take امر. مو مهذب. قل: Here you are. او Here it is.', outcomeAr:'الموظف: "...Thank you."' },
            { text:'This passport yes here take it now.', ok:false, whyAr:'جمله طويله ومشتته. قل: Here you are. بسيط وواضح.', outcomeAr:'الموظف: "Im sorry, your passport?"' },
          ],
        },
        {
          npc:'Agent: "Are you checking any bags today?"',
          promptAr:'عندك شنطه تشيك؟',
          options:[
            { text:'Yes, I have one bag to check.', ok:true, whyAr:'كويس! جمله كامله ومفهومه. Yes + I have + عدد + bag.', outcomeAr:'الموظف: "Great. Please put it on the scale."' },
            { text:'Yes bag one.', ok:false, whyAr:'ترتيب غلط. قل: I have one bag. فاعل + فعل + مفعول.', outcomeAr:'الموظف: "One bag?"' },
            { text:'Bag yes check.', ok:false, whyAr:'كلمات مفككه. قل: Yes, I have one bag to check.', outcomeAr:'الموظف: "Im sorry, how many bags?"' },
          ],
        },
        {
          ...
          options:[
            { text:'Thank you! Have a great day.', ok:true, whyAr:'ممتاز! شكرت وردت على الدعوه. طريقه مهذبه مره.', outcomeAr:'تم تسجيل الدخول. احسنت!' },
  ...
  var PRON_HINTS = {
    ...
    'the': { beats:1, ar:'قول كذا: ذا - خفيفه وسريعه', avoid:'مو كذا لانه غلط: ده او ذي' },
    ...
    'with': { beats:1, ar:'قول كذا: وِذ - اخرها TH ناعمه', avoid:'مو كذا لانه غلط: وِت' },
    'three': { beats:1, ar:'قول كذا: ثري - طرف اللسان بين الاسنان', avoid:'مو كذا لانه غلط: تري او سري' },
    'think': { beats:1, ar:'قول كذا: ثِنك - TH خفيفه من بين الاسنان', avoid:'مو كذا لانه غلط: تنك او سنك' },
    ...
    'people': { beats:2, ar:'قول كذا: پي-پل - ركز على P بالبدايه', avoid:'مو كذا لانه غلط: بيبل' },
    'please': { beats:1, ar:'قول كذا: پليز - P مو B', avoid:'مو كذا لانه غلط: بليز' },
    'park': { beats:1, ar:'قول كذا: پارك - P قويه بهوا', avoid:'مو كذا لانه غلط: بارك' },
    'paper': { beats:2, ar:'قول كذا: پي-پر - فيها P مرتين', avoid:'مو كذا لانه غلط: بيبر' },
    'problem': { beats:2, ar:'قول كذا: پرا-بلم - P بالبدايه', avoid:'مو كذا لانه غلط: بروبلم' },
    'speak': { beats:1, ar:'قول كذا: سپيك - SP مع بعض و P مو B', avoid:'مو كذا لانه غلط: اسبيك او سبيك' },

    // --- V vs F (Arabic has no V) ---
    'very': { beats:2, ar:'قول كذا: ڤي-ري - V اهتزاز خفيف في الشفه', avoid:'مو كذا لانه غلط: فيري' },
    ...
    'five': { beats:1, ar:'قول كذا: فايف - اخرها V خفيفه', avoid:'مو كذا لانه غلط: فايف بقوه F' },
    ...
    'school': { beats:1, ar:'قول كذا: سكول - ابدا بـ S مباشره', avoid:'مو كذا لانه غلط: اسكول' },
    'student': { beats:2, ar:'قول كذا: ستو-دنت - ابدا بـ ST مباشره', avoid:'مو كذا لانه غلط: استودنت' },
    ...
    // --- CH sound ---
    'chair': { beats:1, ar:'قول كذا: چير - CH مثل تش خفيفه', avoid:'مو كذا لانه غلط: شير' },
    'cheap': { beats:1, ar:'قول كذا: چيپ - CH لسهين P', avoid:'مو كذا لانه غلط: شيب' },
    'question': { beats:2, ar:'قول كذا: كوس-چن - اخرها چن', avoid:'مو كذا لانه غلط: كويستيون' },

    // --- Diphthongs and long vowels ---
    'name': { beats:1, ar:'قول كذا: نيم - A هنا مثل اي طويله', avoid:'مو كذا لانه غلط: نام' },
    'day': { beats:1, ar:'قول كذا: ديي - طويله شوي', avoid:'مو كذا لانه غلط: داي قصيره' },
    'rain': { beats:1, ar:'قول كذا: رين - AI مثل اي طويله', avoid:'مو كذا لانه غلط: روين' },
    'phone': { beats:1, ar:'قول كذا: فون - PH تنطق F', avoid:'مو كذا لانه غلط: پون' },
    'home': { beats:1, ar:'قول كذا: هوم - O طويله', avoid:'مو كذا لانه غلط: هُم' },
    'go': { beats:1, ar:'قول كذا: قو/گو - O طويله', avoid:'مو كذا لانه غلط: جُو قصيره' },
    ...
    'world': { beats:1, ar:'قول كذا: وِرلد - اربط RLD بسرعه', avoid:'مو كذا لانه غلط: وور-لد' },
    'girl': { beats:1, ar:'قول كذا: قِرل/گِرل - R خفيفه', avoid:'مو كذا لانه غلط: جيرل ' },
    ...
    'tired': { beats:1, ar:'قول كذا: تايرد - قلها بسرعه ببدون ما توقف بين الحروف', avoid:'مو كذا لانه غلط: تاي-رِد' },
    'water': { beats:2, ar:'قول كذا: وا-تر (الواو والتر مربوطين)', avoid:'مو كذا لانه غلط: وا-تر بسكته بينهم' },
    ...
    'film': { beats:1, ar:'قول كذا: فيلم - FL مع بعض ببدون ما تضيف حرف', avoid:'مو كذا لانه غلط: في-لم او افيلم' },
    ...
    'asked': { beats:1, ar:'قول كذا: اسكت - SKD مع بعض وسريعه', avoid:'مو كذا لانه غلط: اس-كد' },
    ...
    'parking': { beats:2, ar:'قول كذا: پار-عشاننق - P بالبدايه', avoid:'مو كذا لانه غلط: بارعشاننق' },
  ...
  var PRON_PATTERNS = [
    ...
    { test:/^str\w/i, hint:{ beats:1, ar:'STR مع بعض - ابدا بـ S لسهين T لسهين R بسرعه', avoid:'مو كذا لانه غلط: تضيف ا قبل الـ S' } },
    // s + stop clusters: Arabic speakers add ا/ا before s
    { test:/^(sp|st|sk|sm|sn)\w/i, hint:{ beats:1, ar:'ابدا بحرف S مع الحرف اللي لسهه مباشره ببدون ما تضيف صوت قبلها', avoid:'مو كذا لانه غلط: تضيف ا قبل الـ S' } },
    // ph → F
    { test:/^ph/i, hint:{ beats:1, ar:'PH تنطق F - لا تستخدم P', avoid:'مو كذا لانه غلط: تنطقها پ' } },
    // kn → silent K
    { test:/^kn/i, hint:{ beats:1, ar:'K ساكت - ابدا بالنون مباشره', avoid:'مو كذا لانه غلط: تنطق الـ K' } },
    // wr → silent W
    { test:/^wr/i, hint:{ beats:1, ar:'W ساكت - ابدا بالرا مباشره', avoid:'مو كذا لانه غلط: تنطق الـ W' } },
    // -tion ending → شن
  ...
  function buildSequence(lesson, lessonId){
    ...
    if(typeof PEL_INTONATION_EX !== 'undefined' && PEL_INTONATION_EX.length){
      ...
      if(/question|intonation|rise|fall|interrogat|سوال|نبره|استفسار/.test(_lessonTextInt)){
    ...
    if(typeof PEL_SCENARIO_TASKS !== 'undefined' && PEL_SCENARIO_TASKS.length){
      ...
      var _scenarioMatch = PEL_SCENARIO_TASKS.find(function(s){
        return s.id === 'doctor' && /doctor|appointment|عياده|دكتور|موعد/.test(_lessonText);
      }) || PEL_SCENARIO_TASKS.find(function(s){
        return s.id === 'coffee' && /coffee|cafe|قهوه|كافيه|باريستا/.test(_lessonText);
      }) || PEL_SCENARIO_TASKS.find(function(s){
        return s.id === 'directions' && /where|direction|pharmacy|صيدليه|شارع|طريق/.test(_lessonText);
      }) || PEL_SCENARIO_TASKS.find(function(s){
  ...
  const Stage = {
    el:null, state:null,
      ...
      $('#pelStgBack').querySelector('span').innerHTML = L('Save & Exit','حفظ وخروج');
    ...
    open(academyId, lessonId){
      ...
      if(!lesson){ // graceful: nothing to render
        if(typeof toast==='function') toast(L('Lesson not available yet.','الدرس غير متاح لسه.'));
        return false;
      }
      ...
      try{
        ...
        if(saved){
          if(typeof saved.i==='number' && saved.i>0 && saved.i<this.state.seq.length){
            ...
            // Show resume banner so the student knows their progress was saved.
            // Research: Users abandon apps when they fear losing progress.
            // A visible resume signal builds confidence to return.
            try{ if(typeof toast==='function'){ toast(L('Welcome back! Your progress was saved.','مرحباًرجوع! تيمكنّمك محفوظ.'), 'info'); } }catch(e){}
          }
      ...
      const backLbl = $('#pelStgBack').querySelector('span'); if(backLbl) backLbl.innerHTML = L('Save & Exit','حفظ وخروج');
    ...
    close(){
      ...
      // Save session before closing so progress is never lost.
      // The throttled click/input save may not have fired yet.
      try{ saveStageSession(); }catch(e){}
    ...
    render(){
      ...
      if(renderer){
        ...
        if(!isTeachingAct && TEACH_BEFORE[act.type] && !act._taught){
          ...
          try{
            ...
            inner.innerHTML = '<div class="pel-act-prompt">' + L('Learn first then practice','تعلم اول شي لسهين تمرن') + '</div>';
          }
          ...
          this.ready(ctx, L('Start practicing','ابدا التدريب'), ()=>{
            try{
              ...
              inner.innerHTML = '<div class="pel-act-prompt">' + L('We need to fix this activity','نحتاج نصلح ذا التمرين') + '</div><div class="pel-act-hint arabic">ذا التمرين ناقص بيانات، بننتقل للتمرين الجا.</div>';
              this.ready(ctx, L('Continue','متابعه'), ()=>this.next());
            }
      ...
      } else { inner.innerHTML = `<p>${esc(label)}</p>`; this.ready(ctx, L('Continue','متابعه'), ()=>this.next()); }
    },
    ...
    /* mark(ctx, correct, fallbackSelfCheck, feedbackMsg)
       feedbackMsg: optional string/HTML shown in the feedback bar instead
       of the generic ok/no message. Used by grammar renderers to explain
       WHY an answer is wrong — research shows explanatory feedback is the
       #1 missing feature in language apps (ACTFL, Reddit r/languagelearning).
       When omitted, the generic ✓/× message is used (backward compatible). */
    mark(ctx, correct, fallbackSelfCheck, feedbackMsg){
      const s=ctx.s;
      ...
      // Self-check fallbacks (no mic) are flagged and excluded from the
      // mastery gate so a student can't pass production accuracy by
      // clicking "Check" without actually speaking.
      try{
        const act = s.seq && s.seq[s.idx];
        if(act && !act.counted){
          act.counted = true;
          if(act.mode==='production'){
            if(fallbackSelfCheck){
              // Self-check fallback: don't count toward mastery gate
              act.selfCheck = true;
            } else {
        ...
        } else if(act && act.counted && correct && !act.okTracked && !act.selfCheck){
          act.okTracked = true;
      ...
      // If the renderer provided a feedback message, show it; otherwise use
      // the generic ok/no message (backward compatible with existing renderers).
      if(feedbackMsg){
        fb.innerHTML = (correct?'✓ ':'× ')+feedbackMsg;
      } else {
      ...
      if(!correct){ // allow retry
        ...
        btn.innerHTML = L('Try again','حاول ثانيه');
        btn.onclick = ()=>{
          // Clear resume state so restoreActivityDOM() doesn't restore
          // the old checked button (stays "Try again" instead of "Check")
          var act = s.seq && s.seq[s.idx];
          if(act) act._resume = null;
          s.checked = false; s.correct = false;
          try{ saveStageSession(); }catch(e){}
          this.render();
        };
    ...
    renderDone(){
      ...
      // Count self-check activities (no mic) for display transparency
      var selfCheckCount = 0;
      if(s.seq){ for(var i=0;i<s.seq.length;i++){ if(s.seq[i]&&s.seq[i].selfCheck) selfCheckCount++; } }
      ...
      if(!masteryMet){
        body.innerHTML = `<div class="pel-stage-done pel-card-enter">
          ...
          <p>${L('Answer correctly on the production exercises - first try - to complete this lesson. Review the weak spots and try again.','جاوب صح على تمارين الحينتاج من اول محاوله عشان تخلص الدرس. راجع نقاط ضعفك وحاول ثانيه.')}</p>
          <div class="pel-act-hint" style="margin-top:10px;">${L('Production (first try)','الحينتاج (اول محاوله)')}: <b>${prodFirstOk}/${prodTotal}</b> &nbsp;·&nbsp; ${L('Needed','المطلوب')}: <b>${Math.ceil(MASTERY_MIN_OK*prodTotal)}</b></div>${selfCheckCount?`<div class="pel-act-hint" style="margin-top:4px;">${L('Self-check activities (no mic) are not counted.','تمارين التقييم الذلكتي (ببدون مايك) لا تُحتسب.')}</div>`:''}
          <div class="pel-done-row">
            <button class="pel-act-primary" id="pelDoneRetry">${L('Practice again','تمرن ثانيه')}</button>
      ...
      body.innerHTML = `<div class="pel-stage-done pel-card-enter">
        ...
        ${((s.recTotal||s.prodTotal)||selfCheckCount)?`<div class="pel-act-hint" style="margin-top:10px;">${L('Recognition','استرجاع')}: <b>${s.recOk||0}/${s.recTotal||0}</b> &nbsp;·&nbsp; ${L('Production','انتاج')}: <b>${s.prodOk||0}/${s.prodTotal||0}</b>${selfCheckCount?` &nbsp;·&nbsp; ${L('Self-check','تقييم ذاتي')}: <b>${selfCheckCount}</b>`:''}</div>`:''}
        <div class="pel-done-row">
      ...
      if(_doneCard){
        ...
        var _secs = 5;
        _cd.innerHTML = L('Auto-advancing in','الحينتقال التلقايي خلال') + ' <b>' + _secs + '</b> ' + L('seconds','ثانيه');
        _doneCard.appendChild(_cd);
        _cdTimer = setInterval(function(){
          _secs--;
          if(_secs <= 0){ clearInterval(_cdTimer); }
          else { _cd.innerHTML = L('Auto-advancing in','الحينتقال التلقايي خلال') + ' <b>' + _secs + '</b> ' + L('seconds','ثانيه'); }
        }, 1000);
      ...
      if(s.seq){
        for(var i=0; i<s.seq.length; i++){
          ...
          if(a && (a.counted || a.okTracked)){
            ...
            acts[String(i)].selfCheck = !!a.selfCheck;
          }
        }
      }
      var sess = {
      ...
      if(saved.acts && s.seq){
        ...
        for(var k=0;k<ks.length;k++){
          ...
          if(s.seq[idx]){
            ...
            if(as.selfCheck) s.seq[idx].selfCheck = true;
  ...
  function restoreActivityDOM(){
    try{
      ...
      if(r.checked){
        ...
        if(btn){
          if(r.correct){
            btn.innerHTML = L('Continue','متابعه');
            btn.disabled = false;
            ...
            btn.onclick = function(){
              // Clear resume state so restoreActivityDOM doesn't re-restore
              // the old checked button on the next render (retry loop bug)
              var act = s.seq && s.seq[s.idx];
              if(act) act._resume = null;
              s.checked = false; s.correct = false;
              try{ saveStageSession(); }catch(e){}
  ...
  /* ---- 5c. SRS SERVER SYNC (pel_srs_state, local-first) ----
     ...
     - _srsSynced: set to true after the first successful sync. Used by
       app.html to ensure server data is merged before the review queue
       renders. If false, srsDueList uses local cache (which may be stale).
     Deps injected by app.html: supabase() -> client or null, userId() ->
     auth uid or null. Tests inject neither; both guards must hold. */
  var _srsSynced = false;
  ...
  function srsPush(en, r){
    try{
      if(!en || !r) return;
      if(window.PEL_COOKIE_AUTH && typeof window.pelTableUpsert === 'function'){
        var cUid = srsUserId();
        if(!cUid) return;
        pelTableUpsert('pel_srs_state', srsRow(cUid, en, r), 'user_id,en').catch(function(){});
        return;
      }
  ...
  function srsPushAll(c, uid){
    try{
      ...
      const flush = function(){
        ...
        if(window.PEL_COOKIE_AUTH && typeof window.pelTableUpsert === 'function'){
          pelTableUpsert('pel_srs_state', batch, 'user_id,en').catch(function(){});
        } else {
  ...
  function srsSync(){
    try{
      if(window.PEL_COOKIE_AUTH && typeof window.pelTableSelect === 'function'){
        var sUid = srsUserId();
        if(!sUid) return Promise.resolve(false);
        return pelTableSelect('pel_srs_state', 'en,ease,interval_days,streak,due_at,snap,updated_at', { limit: 2000 })
          .then(function(res){
            ...
            if(merged) srsSave(m);
            const pushed = srsPushAll(null, sUid);
            _srsSynced = true;
  ...
  function connectionNoteFor(act){
    ...
    if(/\bthere\s+(is|are)\b/i.test(text)){
      return 'there is = فيه (لوواحد) · there are = فيهم (للكثر). نستخدمها لما نقول ان شي موجود. الترتيب: There is/are + الشي + المكان. مثال: There is a book on the table = فيه كتاب على الطاوله';
    }
    // 2. Present continuous - am/is/are + -ing
    if(/\b(am|is|are)\s+\w+ing\b/i.test(text)){
      return 'هنا نستخدم am او is او are + كلمه تنتهي بـ ing. معناها شي يصير الحين. am مع I، is مع he/she/it، are مع we/you/they. الترتيب: الشخص + am/is/are + كلمه+ing. مثال: I am eating = انا اكل الحين';
    }
    // 3. Present perfect - have/has + past participle
    if(/\b(have|has|ve|s)\s+\w+(ed|en|wn|rd|t)\b/i.test(text) || /\bhave\s+been\b/i.test(text)){
      return 'هنا نستخدم have او has + كلمه فعل بوقت الماضي (زي stopped او eaten). معناها شي صار في الماضي وللحين مهم. have مع I/we/you/they، has مع he/she/it. مثال: I have eaten = انا اكلت (ولا زال تاثيره موجود)';
    }
    // 4. Going to - future plans
    if(/\bgoing\s+to\b/i.test(text)){
      return 'going to = رايح (للمستقبل). نستخدمها لما فيه خطه مسبقه. الترتيب: الشخص + am/is/are + going to + كلمه فعل. مثال: I am going to visit = انا رايح ازور';
    }
    // 5. Will - future
    if(/\bwill\b/i.test(text) && !/\b(would|william)\b/i.test(text)){
      return 'will = راح (للمستقبل). نستخدمها لشي راح يصير ببدون خطه. الترتيب: الشخص + will + كلمه فعل. مثال: I will call you = راح اتصل بك';
    }
    // 6. Can / can't - ability
    if(/\bcan('t|not)?\b/i.test(text)){
      return 'can = ايمكنر (للاستطاعه) · can\'t = ما ايمكنر. نستخدمها لما نقول انا نيمكنر اسوي شي او ما ايمكنر. الترتيب: الشخص + can/can\'t + كلمه فعل. مثال: I can swim = ايمكنر اسبح';
    }
    // 7. Have / has - possession
    if(/\b(have|has)\b/i.test(text) && !/\b(have|has)\s+\w+(ed|en|wn|rd)\b/i.test(text)){
      return 'have/has = عندي/عنده. have مع I/we/you/they، has مع he/she/it. الترتيب: الشخص + have/has + الشي. مثال: I have a car = عندي سياره. She has a phone = عندها جوال';
    }
    // 8. Would like - polite requests
    if(/\bwould\s+like\b/i.test(text)){
      return 'would like = ابي/احب (طلب مهذب). احسن من I want لانها اكثر مهذبه. الترتيب: I + would like + to + كلمه فعل. مثال: I would like to order = ابي اطلب';
    }
    // 9. Could you / Would you mind - polite requests
    if(/\bcould\s+you\b/i.test(text)){
      return 'Could you = ممكن (طلب مهذب). اكثر مهذبه من Can you. الترتيب: Could you + كلمه فعل. مثال: Could you help me = ممكن تساعدني';
    }
    if(/\bwould\s+you\s+mind\b/i.test(text)){
      return 'Would you mind = هل تمانع (اطلب تهذيب شديد). لسهها كلمه فعل + ing. مثال: Would you mind opening = هل تمانع تفتح';
    }
    // 10. How much / How many - countable/uncountable
    if(/\bhow\s+much\b/i.test(text)){
      return 'How much = كم (لللي ما يعد والينلوس). الترتيب: How much + الشي + ... مثال: How much is it = كم سعره';
    }
    ...
    if(/\bwhat\b/i.test(text)){
      return 'What = شنو/ايش. تبدا بيها السوال. لسهها كلمه مساعده (do, are, is). الترتيب: What + كلمه مساعده + الشخص + كلمه فعل. مثال: What do you want = شنو تبي';
    }
    if(/\bwhere\b/i.test(text)){
      return 'Where = وين. للسوال عن المكان. الترتيب: Where + كلمه مساعده + الشخص + ... مثال: Where do you live = وين تسكن';
    }
    if(/\bwhen\b/i.test(text)){
      return 'When = متى. للسوال عن الوقت. الترتيب: When + كلمه مساعده + الشخص + ... مثال: When do you work = متى تشتغل';
    }
    if(/\bwho\b/i.test(text)){
      return 'Who = من. للسوال عن الشخص. الترتيب: Who + كلمه مساعده + الشخص + ... مثال: Who is he = من ذا';
    }
    if(/\bwhy\b/i.test(text)){
      return 'Why = ليش. للسوال عن السبب. الجواب يبدا بـ because (لان). الترتيب: Why + كلمه مساعده + الشخص + ... مثال: Why are you happy = ليش انت مبسوط';
    }
    if(/\bhow\b/i.test(text) && !/\bhow\s+(much|many|old)\b/i.test(text)){
      return 'How = عشانف. للسوال عن الطريقه او الحاله. الترتيب: How + كلمه مساعده + الشخص + ... مثال: How are you = عشانفك';
    }
    // 12. Comparatives
    if(/\b\w+er\s+than\b/i.test(text) || /\bmore\s+\w+\s+than\b/i.test(text)){
      return 'للمقارنه بين شييين: الكلمه القصيره + er + than (bigger than = اكبر من). او more + كلمه وصف + than (more beautiful than = اجمل من). مثال: This is bigger than that = ذا اكبر من ذاك';
    }
    // 13. Demonstrative pronouns
    if(/\b(this|that|these|those)\b/i.test(text)){
      return 'this = ذس (قريب، وواحد) · that = ذات (بعيد، وواحد) · these = ذيز (قريب، كثر) · those = ذوز (بعيد، كثر). نشاور بها على الشي. الترتيب: this/that/these/those + الشي + كلمه فعل + باقي الجمله. مثال: This is a book = ذا كتاب';
    }
    // 14. Articles - a/an/the
    if(/\b\ba\s+[bcdfghjklmnpqrstvwxyz]\w*/i.test(text)){
      return 'a = وواحد (قبل صوت ساكن). نحطها قبل الشي الوواحد. الترتيب: a + الشي. مثال: a book = كتاب، a car = سياره';
    }
    if(/\ban\s+[aeiou]\w*/i.test(text)){
      return 'an = وواحد (قبل صوت متحرك a/e/i/o/u). نحطها قبل الشي الوواحد اللي يبدا بحرف متحرك. الترتيب: an + الشي. مثال: an apple = تفاحه، an egg = بيضه';
    }
    if(/\bthe\b/i.test(text) && !/\bthere\b/i.test(text)){
      return 'the = الـ (للشي المحدد اللي الكل يعرفه). الترتيب: the + الشي. مثال: the book = الكتاب، the door = الباب';
    }
    // 15. Possessive adjectives
    if(/\b(my|your|his|her|our|their)\b/i.test(text)){
      return 'كلمات المعشانه: my = حقتي · your = حقتك · his = حقه · her = حقها · our = حقنا · their = حقهم. تحطها قبل الشي. الترتيب: كلمه معشانه + الشي. مثال: my name = اسمي، your phone = جوالك';
    }
    ...
    if(/\bin\s+(the\s+)?(morning|afternoon|evening|night|room|house|car|bag|box|school|work|bed)\b/i.test(text)){
      return 'in = في (للاوقات الكبيره والاماكن المقفوله). في الصباح، في الغرفه، في السياره. الترتيب: in + وقت/مكان. مثال: in the morning = في الصباح، in the car = في السياره';
    }
    if(/\bon\s+(monday|tuesday|wednesday|thursday|friday|saturday|sunday|table|desk|wall|floor|shelf)\b/i.test(text)){
      return 'on = على (ليوم الاسبوع والاسطح). على الطاوله، يوم الاثنين. الترتيب: on + يوم/سطح. مثال: on Monday = يوم الاثنين، on the table = على الطاوله';
    }
    if(/\bat\s+\d/i.test(text) || /\bat\s+(home|school|work|night|noon)\b/i.test(text)){
      return 'at = عند/في (للاوقات المحدده والاماكن المحدده). الساعه 6، في البيت، في الليل. الترتيب: at + وقت/مكان محدد. مثال: at 6pm = الساعه 6، at home = في البيت';
    }
    // 17. So do I / Neither do I - agreement
    if(/\bso\s+do\s+i\b/i.test(text)){
      return 'So do I = وانا مثلن (موافقه). نستخدمها لما نوافق على لام حد. مثال: A: I like coffee. B: So do I = وانا مثلن';
    }
    if(/\bneither\s+do\s+i\b/i.test(text)){
      return 'Neither do I = وانا لا (موافقه مع النفي). نستخدمها لما نوافق على لام منفي. مثال: A: I don\'t like tea. B: Neither do I = وانا لا';
    }
    ...
    if(/^it\s+is\s+\w+/i.test(text) || /\bit\s+is\s+(hot|cold|rainy|sunny|windy|warm|cool|nice|beautiful|important)\b/i.test(text)){
      return 'It is + كلمه وصف: لوصف الجو او شي. الترتيب: It is + كلمه وصف. مثال: It is hot = الجو حار، It is rainy = الجو ممطر';
    }
    ...
    if(/\b(am|is|are)\b/i.test(text) && !/\b(was|were|will|can|could|should|would|have|has|had)\b/i.test(text)){
      return 'am/is/are = كلمه ربط (للحاضر). am مع I، is مع he/she/it، are مع we/you/they. الترتيب: الشخص + am/is/are + باقي الجمله. مثال: I am happy = انا مبسوط، She is tired = هي تعبانه';
    }
    // 20. Past simple was/were
    if(/\b(was|were)\b/i.test(text)){
      return 'was/were = كلمه ربط (للماضي). was مع I/he/she/it، were مع we/you/they. الترتيب: الشخص + was/were + باقي الجمله. مثال: I was happy = كنت مبسوط، They were tired = كانوا تعبانين';
    }
    ...
    if(/\b(plays|goes|eats|works|lives|likes|wants|needs|runs|walks|talks|looks|sees|hears|feels|comes|does|says|sits|stands|reads|writes|drives|rides|flies|takes|makes|gives|gets|lets|sets|hits|fits|puts|cuts|costs|bets|bids|shuts|bursts|casts)\b/i.test(text)){
      return 'في الحاضر البسيط: اذا كان الشخص وواحد (he/she/it) نزيد s على اخر كلمه الينعل. الترتيب: الشخص + كلمه فعل+s + باقي الجمله. مثال: He plays = هو يلعب، She works = هي تشتغل';
    }
    // 22. Questions with do/does
    if(/\b(do you|does he|does she|does it|do they|do we|does the)\b/i.test(text)){
      return 'للسوال في الحاضر البسيط نستخدم Do او Does قبل الشخص. Does مع he/she/it، Do مع I/you/we/they. الترتيب: Do/Does + الشخص + كلمه فعل. مثال: Do you work = انت تشتغل؟، Does he like = هو يحب؟';
    }
    // 23. Negation with don't/doesn't
    if(/\b(don't|doesn't|do not|does not)\b/i.test(text)){
      return 'للنفي في الحاضر البسيط نستخدم don\'t او doesn\'t. don\'t مع I/you/we/they، doesn\'t مع he/she/it. الترتيب: الشخص + don\'t/doesn\'t + كلمه فعل. مثال: I don\'t know = ما اعرف، She doesn\'t work = ما تشتغل';
    }
    ...
    if(/^(go|turn|take|stop|wait|listen|look|open|close|come|sit|stand|bring|give|show|tell|put|let|keep|try|make|check|read|write|say)\b/i.test(text)){
      return 'صيغه الامر: كلمه الينعل ببدون شخص قبلها. نعطي تعليمات مباشره. مثال: Go straight = امشي مستقيم، Turn left = لف يسار، Open the door = افتح الباب';
    }
    ...
    if(/\b(a|an|the)\s+(big|small|red|blue|green|white|black|new|old|good|nice|beautiful|happy|sad|tired|hungry|good|great|long|short|tall|young|old|rich|poor|strong|weak|fast|slow|clean|dirty|empty|full|open|close|hot|cold|warm|cool|dry|wet|hard|soft|heavy|light|sharp|dull|smooth|rough|flat|round|square|deep|shallow|wide|narrow|thick|thin|bright|dark)\s+\w+/i.test(text)){
      return 'بالعربي الصفه تجي لسه الاسم: سياره حمرا. بالحينجليزي الصفه تجي قبل الاسم: a red car. الترتيب: a/an/the + كلمه وصف + الاسم. مثال: a big house = بيت كبير، the new car = السياره الجديده';
    }
    ...
    if(/\bno\b/i.test(text) && !/\bnot\b/i.test(text) && !/\bknow\b/i.test(text) && !/\bnow\b/i.test(text) && !/\bnoon\b/i.test(text) && !/\bsnow\b/i.test(text)){
      return 'no = لا (للرفض المستقل). not = ما/مو (للنفي داخل الجمله). العربي يستخدم لا للاثنين بس بالحينجليزي مختلفين. مثال: No, thanks = لا، شكرا. I am not tired = انا مو تعبان';
    }
    // 27. Adverb position (always, usually, never)
    if(/\b(always|usually|sometimes|never|often|rarely|seldom)\b/i.test(text)){
      return 'كلمات التكرار (always, usually, never) تجي قبل الينعل الاساسي: I always go. بس لسه is/are/am: She is always late. مثال: I never drink coffee = ما اشرب قهوه ابدا، He is always happy = هو دايماً مبسوط';
    }
    return '';
  }
  ...
  function grammarGlossary(act){
    ...
    if(connNote){
      if(connNote.indexOf('كلمه فعل') >= 0 || connNote.indexOf('كلمه الينعل') >= 0){
        add('verb', 'كلمه الينعل', 'كلمه تدل على فعل او حركه. مثال: go (يروح)، eat (ياكل)، play (يلعب)، work (يشتغل)');
      }
      if(connNote.indexOf('الشخص') >= 0){
        add('subject', 'الشخص', 'اللي يسوي الينعل. الكلمات: I (انا)، you (انت)، he (هو)، she (هي)، it (للشي)، we (احنا)، they (هم)');
      }
      if(connNote.indexOf('الشي') >= 0){
        add('noun', 'الشي / الاسم', 'كلمه تدل على شي او اسم. مثال: book (كتاب)، car (سياره)، name (اسم)، phone (جوال)');
      }
      if(connNote.indexOf('كلمه وصف') >= 0 || connNote.indexOf('كلمه الوصف') >= 0){
        add('adj', 'كلمه الوصف / الصفه', 'كلمه تصف الشي. مثال: big (كبير)، good (زين)، hot (حار)، happy (مبسوط)');
      }
      if(connNote.indexOf('كلمه مساعده') >= 0){
        add('aux', 'كلمه مساعده', 'كلمه تساعد نسوي بها سوال او نفي. مثال: do, does, am, is, are, was, were');
      }
      if(connNote.indexOf('كلمه ربط') >= 0){
        add('tobe', 'كلمه ربط (am/is/are)', 'كلمه تربط الشخص بالوصف او الشي. am مع I، is مع he/she/it، are مع we/you/they. مثال: I am happy = انا مبسوط');
      }
      if(connNote.indexOf('كلمه معشانه') >= 0){
        add('poss', 'كلمات المعشانه', 'كلمات تدل على الملك. my = حقتي، your = حقتك، his = حقه، her = حقها، our = حقنا، their = حقهم');
      }
      if(connNote.indexOf('كلمه اشاره') >= 0 || connNote.indexOf('الاشاره') >= 0){
        add('dem', 'كلمات الاشاره', 'كلمات نشاور فيها على شي. this = ذس (قريب وواحد)، that = ذات (بعيد وواحد)، these = ذيز (قريب كثر)، those = ذوز (بعيد كثر)');
      }
    }
    ...
    if(lesson.grammar && lesson.grammar.rule){
      ...
      if(/present simple|present tense/.test(r)) add('pressimple', 'الحاضر البسيط', 'يصف شي يصير دايم. مثال: I work = انا اشتغل، He plays = هو يلعب');
      if(/present continuous|present progressive/.test(r)) add('prescont', 'الحاضر المستمر', 'زمن يوصف شي يصير الحين. am/is/are + فعل+ing. مثال: I am eating = انا اكل الحين');
      if(/present perfect/.test(r)) add('presperf', 'المضارع التام', 'يربط الماضي بالحاضر. have/has + فعل ماضي. مثال: I have eaten = انا اكلت');
      if(/past simple|past tense/.test(r)) add('past', 'الماضي البسيط', 'يصف شي صار وانتهى. مثال: I worked = اشتغلت، He played = لعب');
      if(/future/.test(r)) add('future', 'المستقبل', 'زمن يصف شي راح يصير. will + فعل او going to + فعل. مثال: I will go = راح اروح');
      if(/auxiliary/.test(r)) add('aux2', 'كلمه مساعده', 'كلمه تساعد نسوي بها سوال او نفي. مثال: do, does, am, is, are, have, has');
      if(/article/.test(r)) add('article', 'كلمات التعريف', 'a = وواحد (قبل ساكن)، an = وواحد (قبل متحرك)، the = الـ (للمحدد)');
      if(/preposition/.test(r)) add('prep', 'كلمات المكان/الوقت', 'كلمات تدل على مكان او وقت. in = في، on = على، at = عند');
      if(/possessive/.test(r)) add('poss2', 'كلمات المعشانه', 'my = حقتي، your = حقتك، his = حقه، her = حقها');
      if(/question/.test(r)) add('quest', 'كلمات السوال', 'What = شنو، Where = وين، When = متى، Who = من، Why = ليش، How = عشانف');
      if(/imperative|command/.test(r)) add('imp', 'صيغه الامر', 'جمله تبدا بفعل مباشر ببدون شخص. مثال: Go straight = امشي مستقيم');
      if(/comparative/.test(r)) add('comp', 'المقارنه', 'نقارن بين شييين. القصير + er + than (bigger than). الطويل: more + صفه + than (more beautiful than)');
    }
  ...
  function wordTypeFor(word, lesson){
    ...
    // Common pronouns
    if(/^(i|you|he|she|it|we|they|me|him|her|us|them)$/.test(w)) return 'كلمه شخص';
    // Common verbs
    if(/^(am|is|are|was|were|have|has|had|do|does|did|will|would|can|could|should|shall|may|might|must)$/.test(w)) return 'كلمه مساعده';
  ...
  function posLabel(pos){
    ...
    if(/^(adj|jj|jjr|jjs|adjective)$/.test(p)) return 'صفه';
    if(/^(adv|rb|rbr|rbs|adverb)$/.test(p)) return 'كلمه وصف';
    if(/^(pron|prp|pdt|poss|prp\$)$/.test(p)) return 'كلمه شخص';
    if(/^(det|dt|pdt)$/.test(p)) return 'كلمه تعريف';
    if(/^(in|prep|preposition)$/.test(p)) return 'كلمه مكان/وقت';
    if(/^(cc|conj|conjunction)$/.test(p)) return 'كلمه وصل';
  ...
  function buildTeachHtml(act){
    ...
    var html = '<div class="pel-teach">' +
      '<div class="pel-act-prompt">' + L('Learn first then practice','تعلم اول شي لسهين تمرن') + '</div>';
    ...
    if(sensitive){
      ...
      if(prereqs.length){
        html += '<div class="pel-teach-section">' + L('Before this question','قبل ذا السوال') + '</div>';
        html += '<div class="pel-teach-section" style="font-size:.78rem;color:var(--text-muted);margin-top:4px;">' + L('You need these pieces','تحتاج هذي الكلمات') + '</div>';
      ...
      if(nextWord){
        ...
        html += '<div class="pel-teach-section">' + L('New word','كلمه جديده') + '</div>';
        ...
        if(tc){
          ...
          // Common mistake
          if(tc.commonMistake) html += '<div style="padding:8px 10px;background:rgba(245,158,11,.08);border-radius:8px;border-right:3px solid var(--gold);"><div style="font-size:.72rem;color:var(--gold);margin-bottom:3px;">' + L('Common mistake','غلط شايع') + '</div><span class="arabic" style="font-size:.85rem;line-height:1.6;">' + esc(tc.commonMistake) + '</span></div>';
          // How to avoid
          if(tc.howToAvoid) html += '<div style="padding:8px 10px;background:rgba(99,102,241,.08);border-radius:8px;border-right:3px solid #6366f1;"><div style="font-size:.72rem;color:#6366f1;margin-bottom:3px;">' + L('How to avoid','عشانف تتجنبه') + '</div><span class="arabic" style="font-size:.85rem;line-height:1.6;">' + esc(tc.howToAvoid) + '</span></div>';
          // What to remember
        ...
        html += '<button class="pel-act-play" id="pelTeachPlay" style="margin-top:14px;"><i data-lucide="volume-2" width="16" height="16"></i> ' + L('Hear the word','اسمع الكلمه') + '</button>';
      } else {
      ...
      if(vocab.length){
        html += '<div class="pel-teach-section">' + L('Key words','الكلمات المفتاحيه') + '</div>';
        html += '<div class="pel-teach-vocab">';
    ...
    if(lesson.grammar && lesson.grammar.saudi && !taughtKeys['grammar_saudi']){
      ...
      html += '<div class="pel-teach-section">' + L('Grammar rule','القاعده') + '</div>';
    ...
    if(connNote && !taughtKeys['connection']){
      ...
      html += '<div class="pel-teach-section">' + L('How words connect','عشانف تتصل الكلمات') + '</div>';
  ...
  const RENDERERS = {
      ...
      const reveal = () => {
        ...
        if(revealEl){
          ...
          if(tc){
            ...
            if(tc.commonMistake) tcHtml += '<div style="padding:8px 10px;background:rgba(245,158,11,.08);border-radius:8px;border-right:3px solid var(--gold);"><div style="font-size:.72rem;color:var(--gold);margin-bottom:3px;">' + L('Common mistake','غلط شايع') + '</div><span class="arabic" style="font-size:.85rem;line-height:1.6;">' + esc(tc.commonMistake) + '</span></div>';
            if(tc.howToAvoid) tcHtml += '<div style="padding:8px 10px;background:rgba(99,102,241,.08);border-radius:8px;border-right:3px solid #6366f1;"><div style="font-size:.72rem;color:#6366f1;margin-bottom:3px;">' + L('How to avoid','عشانف تتجنبه') + '</div><span class="arabic" style="font-size:.85rem;line-height:1.6;">' + esc(tc.howToAvoid) + '</span></div>';
    ...
    learn_sentence(inner, act, ctx){
      ...
      const reveal = () => {
        ...
        ctx.btn.innerHTML = L('Continue','متابعه');
        ctx.btn.disabled = false;
      };
      inner.innerHTML = `
    ...
    how_to_say(inner, act, ctx){
      ...
      inner.innerHTML = `
        <div style="text-align:center;padding:8px 0 4px;">
          <div style="font-size:.78rem;color:var(--gold-soft);margin-bottom:10px;text-transform:uppercase;letter-spacing:.06em;">${L('How to say it','عشانف تنطقها')}</div>
    ...
    arrange_words(inner, act, ctx){
      ...
      if(words.length < 2){
        inner.innerHTML = '<div class="pel-act-prompt">' + L('Not enough words to build','ما في كلمات كافيه للترتيب') + '</div>';
        ctx.self.ready(ctx, L('Continue','متابعه'), ()=>ctx.self.next());
        return;
      }
      const tokens = shuffle(words);
      let placed=[];
      inner.innerHTML = `<div class="pel-act-prompt">${L('Build the sentence','رتب الجمله')}</div>
    ...
    fill_blank(inner, act, ctx){
      ...
      inner.innerHTML = `<div class="pel-act-prompt">${L('Complete the sentence','كمل الجمله')}</div>
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{ var _selBtn=inner.querySelector('.pel-option.selected'); sel=_selBtn?_selBtn.textContent.trim():''; btns.forEach((b,i)=>{ if(b.textContent.trim()===target) b.classList.add('correct'); else if(b.textContent.trim()===sel) b.classList.add('wrong'); }); var correct = norm(sel)===norm(target); var fb = correct ? '' : L('Correct answer: ','الاجابه الصحه: ')+esc(target); ctx.self.mark(ctx, correct, false, fb); });
      ctx.btn.disabled = true;
    },
    spell(inner, act, ctx){
      ...
      let placed = [];
      inner.innerHTML = `<div class="pel-act-prompt">${L('Spell the word','اهجّ الكلمه')}</div>
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        ...
        var fb = correct ? '' : L('Correct spelling: ','التهجيه الصحه: ')+esc(it.en);
        ctx.self.mark(ctx, correct, false, fb);
      });
      ctx.btn.disabled = true;
    },
    translate(inner, act, ctx){
      ...
      let sel=null;
      inner.innerHTML = `<div class="pel-act-prompt">${L('What is this in English?','وش ذا بالحينجليزي؟')}</div>
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        ...
        var correct = norm(sel)===norm(it.en);
        var fb = correct ? '' : L('Correct: ','الصح: ')+esc(it.en);
        ctx.self.mark(ctx, correct, false, fb);
      });
      ctx.btn.disabled = true;
    },
    listen(inner, act, ctx){
      ...
      let played=false;
      inner.innerHTML = `<div class="pel-act-prompt">${L('Listen carefully','اسمع زين')}</div>
        ...
        <div class="pel-act-hint">${L('Tap play and listen. You will identify it next.','اضغط تشغيل واصغي. بتحددها لسه.')}</div>`;
    ...
    identify_heard(inner, act, ctx){
      ...
      var optsHtml = opts.map(function(o, i){
        ...
        return '<button class="pel-option" data-i="'+i+'" data-choice-key="'+esc(o.key)+'" disabled><span class="o-en">'+hl+'</span></button>';
      }).join('');
      inner.innerHTML = '<div class="pel-act-prompt">'+L('What did you hear?','وش سمعت؟')+'</div>'+
        '<button class="pel-act-play" id="pelIdPlay"><i data-lucide="volume-2" width="16" height="16"></i> '+L('Play','تشغيل')+'</button>'+
        '<div class="pel-options" id="pelIdOpts" style="margin-top:16px;">'+optsHtml+'</div>';
      const _audio = audioText;
      $('#pelIdPlay').onclick=()=>{ played = true; $('#pelIdPlay').classList.add('pel-played'); play(_audio,'en-US'); enableOpts(); };
      const btns=inner.querySelectorAll('.pel-option');
      function enableOpts(){ if(played){ btns.forEach(function(b){ b.disabled = false; b.style.opacity = ''; b.style.pointerEvents = ''; }); } }
      btns.forEach(function(b){ b.style.opacity = '0.4'; b.style.pointerEvents = 'none'; });
    ...
    pronunciation(inner, act, ctx){
      ...
      let heardFallback = false; // track if student heard audio (fallback gate)
      inner.innerHTML = `
        <div class="pel-act-prompt">${L('Pronounce the word','انطق الكلمه')}</div>
        ...
        <div id="pelProMicWrap" style="margin-top:16px;">
          ${canRec ? `<button class="pel-act-play pel-mic-btn" id="pelProMic" style="width:100%;background:rgba(210,92,92,.16);border-color:rgba(210,92,92,.4);color:var(--danger);"><i data-lucide="mic" width="16" height="16"></i> ${L('Speak now','انطق الحين')}</button>
            ...
            <div class="pel-act-hint">${L('Press the button and say the word clearly.','اضغط الزر وانطق الكلمه بوضوح.')}</div>`
          : `<div class="pel-act-hint">${L('Say it out loud, then tap Check.','نطقها بصوت عالي، لسهها اضغط تحقق.')}</div>`}
        </div>
      ...
      $('#pelProPlay').onclick = ()=>{ heardFallback = true; play(it.en,'en-US'); if(!canRec){ ctx.btn.disabled = false; } };
      const revealAr = () => {
      ...
      if(canRec){
        ...
        micBtn.onclick = () => {
          if(typeof recordAndScore !== 'function'){ ctx.btn.disabled=false; revealAr(); ctx.self.mark(ctx, true, true); return; }
          ...
          recordAndScore((heard, score, err)=>{
            ...
            if(err){
              fb.innerHTML = `<div class="pel-act-hint" style="color:var(--gold);">${typeof micErrorMessage==='function'?esc(micErrorMessage(err)):L('Mic error','غلط بالمايك')}</div><div class="pel-act-hint">${L('Try again, or tap Check to continue.','حاول ثانيه، او اضغط تحقق للمتابعه.')}</div>`;
              return;
            }
            ...
            let enc = '';
            if(sc != null){
              if(sc < 40) enc = `<div class="pel-act-hint arabic" style="color:var(--text-muted);">الغلط عادي، ذا عشانف نتعلم. حاول مره ثانيه.</div>`;
              else if(sc < 70) enc = `<div class="pel-act-hint arabic" style="color:var(--text-muted);">كويس! قربت من النطق الصح. حاول مره ثانيه.</div>`;
            ...
            fb.innerHTML = `<div style="font-size:1.25rem; font-weight:700; color:${ok?'var(--success)':'var(--gold)'};">${sc!=null?sc:'-'}% ${ok?'✓':'×'}</div>`
              ...
              + enc
              + (!ok?`<div class="pel-act-hint">${L('Try again, or tap Check to continue.','حاول ثانيه، او اضغط تحقق للمتابعه.')}</div>`:'');
            ctx.self.mark(ctx, ok);
          }, it.en, micBtn);
        };
        ctx.self.ready(ctx, L('Check','تحقق'), ()=>{ revealAr(); ctx.self.mark(ctx, true, true); });
        ctx.btn.disabled = true; // Must use mic first
      } else {
        // Fallback gate: when no mic, require Hear it before Check.
        // This ensures the student at least heard the correct pronunciation
        // before self-assessing. The mark is still true (self-check).
        ctx.self.ready(ctx, L('Check','تحقق'), ()=>{ revealAr(); ctx.self.mark(ctx, true, true); });
        ctx.btn.disabled = true; // Re-gate: must click Hear it first
      }
    },
    speaking(inner, act, ctx){
      ...
      let heardFallback = false; // track if student heard audio (fallback gate)
      inner.innerHTML = `
        <div class="pel-act-prompt">${L('Say the sentence','نطق الجمله')}</div>
        ...
        <div id="pelSpkMicWrap" style="margin-top:16px;">
          ${canRec ? `<button class="pel-act-play pel-mic-btn" id="pelSpkMic" style="width:100%;background:rgba(210,92,92,.16);border-color:rgba(210,92,92,.4);color:var(--danger);"><i data-lucide="mic" width="16" height="16"></i> ${L('Speak now','انطق الحين')}</button>
            ...
            <div class="pel-act-hint">${L('Press the button and say the sentence clearly.','اضغط الزر وانطق الجمله بوضوح.')}</div>`
          : `<div class="pel-act-hint">${L('Say it out loud, then tap Check.','نطقها بصوت عالي، لسهها اضغط تحقق.')}</div>`}
        </div>
      ...
      $('#pelSpkPlay').onclick = ()=>{ heardFallback = true; play(s.en,'en-US'); if(!canRec){ ctx.btn.disabled = false; } };
      const revealAr = () => {
    ...
    conversation_response(inner, act, ctx){
      ...
      if(!line || !reply){ ctx.self.ready(ctx, L('Continue','متابعه'), ()=>ctx.self.next()); return; }
    ...
    complete_dialogue(inner, act, ctx){
      ...
      inner.innerHTML = `<div class="pel-act-prompt">${L('Complete the dialogue','كمل المحادثه')}</div>
    ...
    grammar_correction(inner, act, ctx){
      ...
      let sel=null;
      inner.innerHTML = `<div class="pel-act-prompt">${L('Which sentence is correct?','اي جمله صح؟')}</div>
    ...
    listening_dictation(inner, act, ctx){
      ...
      inner.innerHTML = `
        ...
        <button class="pel-act-play" id="pelDicPlay" style="width:100%;"><i data-lucide="volume-2" width="16" height="16"></i> ${L('Play the sentence','شغل الجمله')}</button>
    ...
    guided_production(inner, act, ctx){
      ...
      if(!it || !it.en){ ctx.self.ready(ctx, L('Continue','متابعه'), ()=>ctx.self.next()); return; }
      ...
      let sel=null;
      inner.innerHTML = `
        <div class="pel-act-prompt">${L('Complete the sentence','كمل الجمله')}</div>
    ...
    free_response(inner, act, ctx){
      ...
      var placed = [];
      const prompt = ar() ? `كون جمله باستخدام كلمه <b>${esc(it.en)}</b>` : `Build a sentence using <b>${esc(it.en)}</b>`;
      inner.innerHTML = `<div class="pel-act-prompt">${prompt}</div>
    ...
    review(inner, act, ctx){
      ...
      const ask = () => {
        if(idx >= items.length){
          inner.innerHTML = `<div class="pel-act-prompt">${L('Review complete','المراجعه خلصت')}</div>
        ...
        const it = items[idx];
        let revealed = false;
        inner.innerHTML = `<div class="pel-act-prompt">${L('What does this mean?','وش يعني ذا؟')} (${idx+1}/${items.length})</div>
          <div class="pel-act-en" dir="ltr">${esc(it.en)}</div>
    ...
    concept(inner, act, ctx){
      ...
      if(sections.rule.length){
        html += '<div class="pel-concept-section-label">' + L('The Rule','القاعده') + '</div>';
      ...
      // Examples section
      if(examples.length){
        html += '<div class="pel-concept-section-label"><i data-lucide="file-text" width="14" height="14"></i> ' + L('Examples','امثله') + '</div>';
    ...
    concept_examples(inner, act, ctx){
      ...
      let idx = 0;
      const renderOne = () => {
        if(idx >= sentences.length){ ctx.self.ready(ctx, L('Continue','متابعه'), ()=>ctx.self.next()); return; }
        ...
        const reveal = () => {
          ...
          ctx.btn.innerHTML = idx < sentences.length-1 ? L('Next example','المثال الجا') : L('Continue','متابعه');
          ctx.btn.disabled = false;
        };
        inner.innerHTML = `
    ...
    db_order(inner, act, ctx){
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        ...
        var correct = built===target;
        var fb = correct ? '' : L('Correct: ','الصح: ')+esc(ansStr);
        ctx.self.mark(ctx, correct, false, fb);
      });
      ctx.btn.disabled = true;
    },
    db_spell(inner, act, ctx){
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        ...
        var correct = accepted.indexOf(built)!==-1;
        var fb = correct ? '' : L('Correct spelling: ','التهجيه الصحه: ')+esc(p.answer);
        ctx.self.mark(ctx, correct, false, fb);
      });
      ctx.btn.disabled = true;
    },
    db_translate(inner, act, ctx){
      ...
      if(hb) hb.onclick=()=>{ if(hr){
        var hintHTML = '';
        if(p.source_tr){
          hintHTML = '<div class="pel-act-translit">'+esc(p.source_tr)+'</div>';
        } else if(srcIsEn){
          // Fallback for translate-to-Arabic: show first letter of each answer word
          var firstLetters = answerWords.map(function(w){ return w.charAt(0); }).join(' ');
          hintHTML = '<div class="pel-act-translit"><span class="arabic">الحروف الاولى: </span>'+esc(firstLetters)+'</div>';
        } else {
          hintHTML = '<div class="pel-act-translit"><span class="arabic">رتب نفس المعنى. ابدا بكلمه الينعل، لسهين كمل بقيه الجمله.</span></div>';
        }
        hr.innerHTML = hintHTML;
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        ...
        var correct = accepted.indexOf(built)!==-1;
        var fb = correct ? '' : L('Correct: ','الصح: ')+esc(p.answer);
        ctx.self.mark(ctx, correct, false, fb);
      });
      ctx.btn.disabled = true;
    },
    db_correct(inner, act, ctx){
      ...
      let sel=null;
      inner.innerHTML = `<div class="pel-act-prompt">${L('Which sentence is correct?','اي جمله صح؟')}</div>
        ${ex.hint_ar?`<div class="arabic" style="font-size:.84rem;color:var(--text-muted);margin-bottom:12px;">${esc(ex.hint_ar)}</div>`:`<div dir="ltr" style="font-size:.84rem;color:var(--text-muted);margin-bottom:12px;">${esc(ex.hint_en||'')}</div>`}
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        ...
        if(whyEn || whyAr){
          ...
          why.innerHTML = `${whyEn?`<div dir="ltr">${esc(whyEn)}</div>`:''}${whyAr?`<div class="arabic">${esc(whyAr)}</div>`:''}`;
    ...
    mistake_coach(inner, act, ctx){
      ...
      const renderTip = () => {
        inner.innerHTML = `
          <div class="pel-act-prompt">${L('Common Saudi Mistake','غلطه شايعه عند السعوديين')}</div>
      ...
      const renderPractice = () => {
        ...
        inner.innerHTML = `
          ...
          <div class="pel-act-hint" dir="ltr" style="margin-bottom:14px;">${esc(pattern.titleEn || '')}</div>
    ...
    minimal_pairs(inner, act, ctx){
      ...
      const tipAr = pair.tipAr || ('الينرق صوت وواحد. اسمع الكلمتين زين، لسهين قول الكلمه الصح.');
      inner.innerHTML = `
        <div class="pel-act-prompt">${L('Minimal Pair Drill','تمرين الاصوات المتقاربه')}</div>
        ...
        <div style="display:flex;gap:12px;margin-bottom:16px;">
          ...
          <div style="flex:1;text-align:center;padding:16px;border:2px solid var(--danger);border-radius:12px;background:rgba(231,76,60,.06);">
            ...
            <div class="arabic" style="font-size:.85rem;color:var(--text-muted);">${L('Common mistake','غلطه شايعه')}</div>
      ...
      if(playT) playT.onclick = ()=>{ play(target,'en-US'); if(!canRec){ ctx.btn.disabled = false; } };
      if(playC) playC.onclick = ()=>{ play(confusion,'en-US'); if(!canRec){ ctx.btn.disabled = false; } };
      ...
      if(canRec){
        ...
        if(micBtn){
          micBtn.onclick = ()=>{
            if(typeof recordAndScore !== 'function'){ ctx.btn.disabled=false; ctx.self.mark(ctx, true, true); return; }
            micBtn.classList.add('recording');
            ...
            recordAndScore((heard, score, err)=>{
              ...
              ctx.btn.disabled=false;
              if(err){
                if(fb) fb.innerHTML = `<div class="pel-act-hint" style="color:var(--gold);">${typeof micErrorMessage==='function'?esc(micErrorMessage(err)):L('Mic error','غلط بالمايك')}</div>`;
                return;
              }
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{ ctx.self.mark(ctx, true, true); });
      // Gate: when mic available, must use mic first. When no mic,
      // require hearing at least one audio clip before Check.
      if(canRec) ctx.btn.disabled = true;
      else ctx.btn.disabled = true; // Re-gate: must click Hear first
    },
    ...
    intonation(inner, act, ctx){
      ...
      const questionMeaning = act.questionMeaning || L('A question','سوال');
      const statementMeaning = act.statementMeaning || L('A statement','جمله خبريه');
      let sel = null;
      let playedQ = false, playedS = false;
      // Randomize which audio button plays the question vs statement
      const questionFirst = Math.random() < 0.5;

      inner.innerHTML = `
        <div class="pel-act-prompt">${L('Question or statement?','سوال ولا جمله؟')}</div>
        <div class="pel-act-hint arabic" style="margin-bottom:14px;">${L('Hear both sentences, then pick which is the question.','اسمع الجملتين، لسهين اختر اي وحده سوال.')}</div>
        <div style="text-align:center;margin-bottom:16px;">
          <button class="pel-act-play" id="intPlayQ" style="margin:0 6px;"><i data-lucide="volume-2" width="16" height="16"></i> ${L('Sentence 1','جمله 1')}</button>
          <button class="pel-act-play" id="intPlayS" style="margin:0 6px;"><i data-lucide="volume-2" width="16" height="16"></i> ${L('Sentence 2','جمله 2')}</button>
        </div>
      ...
      if(playQ) playQ.onclick = ()=>{ playQ.classList.add('pel-played'); playedQ = true; play(questionFirst ? question : statement,'en-US'); updateGate(); };
      if(playS) playS.onclick = ()=>{ playS.classList.add('pel-played'); playedS = true; play(questionFirst ? statement : question,'en-US'); updateGate(); };

      // Gate: student must hear BOTH sentences before answering (same
      // principle as the listen activity). Without this, the student can
      // guess without engaging with the audio at all.
      function updateGate(){
        var bothPlayed = playedQ && playedS;
        if(bothPlayed){
          opts.forEach(function(o){ o.disabled = false; o.style.opacity = ''; o.style.pointerEvents = ''; });
        }
      }
      // Disable options until both audio clips are played
      opts.forEach(function(o){ o.disabled = true; o.style.opacity = '0.4'; o.style.pointerEvents = 'none'; });
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        ...
        const why = correct
          ? Lt('Correct! ' + (questionFirst ? 'Sentence 1' : 'Sentence 2') + ' is the question: Are you...? Do you...?', 'صح! ' + (questionFirst ? 'جمله 1' : 'جمله 2') + ' هي السوال: Are you...? Do you...?')
          : Lt('Questions use different word order: Are you...? Do you...? The question was ' + (questionFirst ? 'Sentence 1' : 'Sentence 2') + '.', 'الاساله بالحينجليزي تغير ترتيب الكلمات: Are you...? Do you...? السوال كان ' + (questionFirst ? 'جمله 1' : 'جمله 2') + '.');
      ...
      ctx.btn.disabled = true; // ready() re-enables; re-gate until both clips played + selection
    },
    ...
    writing_practice(inner, act, ctx){
      // WORD BANK: student taps words in order to build the sentence.
      // No typing required — students don't know how to type English.
      ...
      // Add 1-2 distractor words from lesson vocab for challenge
      var lv = (Stage.state && Stage.state.lesson && Stage.state.lesson.vocab) || [];
      var distractors = [];
      lv.forEach(function(v){ if(v && v.en && distractors.length < 2 && !words.some(function(w){ return norm(w)===norm(v.en); })) distractors.push(v.en); });
      var bankWords = words.concat(distractors);
      const tokens = shuffle(bankWords);
      let placed = [];
      const _targetText = answer;

      inner.innerHTML = `
        <div class="pel-act-prompt">${L('Build the sentence','رتب الجمله')}</div>
        <div class="pel-act-hint arabic" style="margin-bottom:10px;">${esc(promptAr)}</div>
        ${hint?`<div class="pel-act-hint" style="margin-bottom:14px;" dir="ltr">${esc(hint)}</div>`:''}
        <div class="pel-arrange-drop" id="pelWpDrop" data-ph="${Lt('Tap words below','اضغط الكلمات تحت')}"></div>
        <div class="pel-tokens" id="pelWpTk">${tokens.map((t,i)=>`<button class="pel-token" data-i="${i}">${esc(t)}</button>`).join('')}</div>
        <div id="wpFb"></div>`;

      const drop = inner.querySelector('#pelWpDrop');
      const tk = inner.querySelector('#pelWpTk');
      const fb = inner.querySelector('#wpFb');

      const renderDrop=()=>{ drop.innerHTML = placed.map((t,i)=>`<button class="pel-token" data-pi="${i}">${esc(t)}</button>`).join('')||'';
        drop.querySelectorAll('[data-pi]').forEach(b=>b.onclick=()=>{ const idx=+b.dataset.pi; const tok=placed[idx]; placed.splice(idx,1); addBack(tok); renderDrop(); });
        ctx.btn.disabled = placed.length === 0;
      };
      const addBack=(tok)=>{ const btn=document.createElement('button'); btn.className='pel-token'; btn.textContent=tok; btn.onclick=()=>{ if(btn.disabled)return; btn.remove(); placed.push(tok); renderDrop(); }; tk.appendChild(btn); };
      tk.querySelectorAll('.pel-token').forEach(b=>b.onclick=()=>{ b.remove(); placed.push(tokens[+b.dataset.i]); renderDrop(); });
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        var _normFn = norm;
        const built = _normFn(placed.join(' '));
        const target = _normFn(_targetText);
        ...
        if(fb) fb.innerHTML = correct
          ...
          : `<div style="color:var(--gold);font-weight:700;">× ${L('Try again','حاول ثانيه')}</div>`
            + `<div class="pel-act-hint" dir="ltr">${esc(en)}</div>`
            + `<div class="pel-act-hint arabic">الغلط عادي، ذا عشانف نتعلم.</div>`;
        ctx.self.mark(ctx, correct);
      });
      ctx.btn.disabled = true;
    },
    ...
    scenario_roleplay(inner, act, ctx){
      ...
      const renderTurn = () => {
        if(turnIdx >= turns.length){
          // Scenario completed
          inner.innerHTML = `
            <div class="pel-act-prompt">${L('Task complete!','تمت المهمه!')}</div>
        ...
        ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
          ...
          if(chosen.ok){
            turnIdx++;
            ctx.self.ready(ctx, L('Continue','متابعه'), ()=>renderTurn());
          } else {
            hadRetry = true;
            ctx.self.ready(ctx, L('Try again','حاول ثانيه'), ()=>renderTurn());
          }
        });
      };
  ...
  var TEACHING_CONTENT = {
    ...
    'you': {
      meaning: 'انت / انتم',
      useWhen: 'تخاطب شخص او مجموعه. مثال: You are nice = انت لطيف',
      dontUseWhen: 'ما تستخدمها للحديث عن نفسك او شخص غايب',
    ...
    'this': {
      meaning: 'ذا / هذي (للقريب)',
      useWhen: 'تشاور على شي قريب منك. مثال: This is my book = ذا كتابي',
    ...
    'these': {
      ...
      useWhen: 'تشاور على اشيا قريبه وجمع. مثال: These are my books = هذي كتبي',
      dontUseWhen: 'لا تستخدمها للوواحد ولا للبعيد',
      commonMistake: 'استخدام these للوواحد بدل this',
      howToAvoid: 'جمع قريب = these، جمع بعيد = those',
      remember: 'these = جمع قريب'
    },
    'those': {
      meaning: 'ذول (جمع بعيد)',
      useWhen: 'تشاور على اشيا بعيده وجمع. مثال: Those are nice = ذول حلوين',
      dontUseWhen: 'لا تستخدمها للوواحد ولا للقريب',
      commonMistake: 'خلط بين these و those',
      howToAvoid: 'جمع قريب = these، جمع بعيد = those',
      remember: 'those = جمع بعيد'
    },
    'am': {
      meaning: 'تستخدم مع I بس — مثل: I am = انا',
      useWhen: 'تتكلم عن نفسك في الحاضر. مثال: I am happy = انا مبسوط',
      dontUseWhen: 'ما تستخدمها مع he/she/it/we/you/they',
      commonMistake: 'الطلاب يقولون I is بدل I am',
      howToAvoid: 'I + am = زوج ثابت. ما تفرقهم ابداً',
      remember: 'am تجي مع I بس'
    },
    'do': {
      meaning: 'كلمه مساعده للاساله والنفي في الحاضر',
      useWhen: 'تسال سوال في الحاضر. مثال: Do you like tea? = تحب الشاي؟',
      dontUseWhen: 'ما تستخدمها مع he/she/it — استخدم does',
      commonMistake: 'استخدام do مع he/she/it بدل does',
      howToAvoid: 'I/you/we/they = do، he/she/it = does',
      remember: 'do = مع I/you/we/they'
    },
    'does': {
      meaning: 'كلمه مساعده مع he/she/it في الحاضر',
      useWhen: 'تسال عن شخص وواحد غايب. مثال: Does he work? = هو يشتغل؟',
      dontUseWhen: 'ما تستخدمها مع I/you/we/they',
    ...
    'what': {
      meaning: 'وش / ايش',
      useWhen: 'تسال عن الشي. مثال: What is this? = وش ذا؟',
    ...
    'can': {
      meaning: 'ايمكنر (ليمكنره)',
      useWhen: 'تتكلم عن يمكنرتك على شي. مثال: I can drive = ايمكنر اسوق',
      dontUseWhen: 'لا تستخدمها للمستقبل — استخدم will',
      commonMistake: 'استخدام can للمستقبل',
      howToAvoid: 'can = يمكنره الحين، will = مستقبل',
      remember: 'can = ايمكنر (الحين)'
    },
    'will': {
      meaning: 'راح (للمستقبل)',
      useWhen: 'تتكلم عن شي راح يصير. مثال: I will help you = راح اساعدك',
      dontUseWhen: 'لا تستخدمها ليمكنره الحاليه — استخدم can',
      commonMistake: 'خلط بين will و can',
      howToAvoid: 'will = مستقبل، can = يمكنره',
    ...
    'a': {
      meaning: 'تعريف للشي الوواحد (غير محدد)',
      useWhen: 'تتكلم عن شي وواحد غير محدد. مثال: a book = كتاب',
      dontUseWhen: 'لا تستخدمها قبل كلمه تبدا بحرف عله — استخدم an',
      commonMistake: 'استخدام a قبل كلمه تبدا بحرف عله',
      howToAvoid: 'a = قبل حرف ساكن، an = قبل حرف عله (a,e,i,o,u)',
      remember: 'a = وواحد غير محدد، قبل الساكن'
    },
    'an': {
      meaning: 'تعريف للشي الوواحد (قبل حرف عله)',
      useWhen: 'تتكلم عن شي وواحد يبدا بحرف عله. مثال: an apple = تفاحه',
      dontUseWhen: 'لا تستخدمها قبل حرف ساكن — استخدم a',
      commonMistake: 'استخدام a بدل an قبل حرف عله',
      howToAvoid: 'a,e,i,o,u بالبدايه = an',
      remember: 'an = قبل حرف ايمكنه'
    },
    ...
    'the': {
      ...
      dontUseWhen: 'ما تستخدمها مع الجمع العام او غير المعدود. مثال: Dogs are loyal (مو the dogs)',
      commonMistake: 'نسيان the او زيادتها في اماكن غلط — العرب ما عندهم a/an فلازم تنتبه',
      howToAvoid: 'اذا انت والمستمع تعرفون اي شي هو = the. اذا شي عام ببدون تحديد = ببدون the',
      remember: 'the = شي محدد نعرفه، ببدون = شي عام'
    },
    // Prepositions: #2 error category - direct translation causes errors
    'in': {
      meaning: 'في — للاماكن المغلقه والوقت',
      ...
      commonMistake: 'خلط in مع on سبب الترجمه الحرفيه من العربي',
      howToAvoid: 'in = جوّه (في غرفه، في مدينه)، on = فوق (على طاوله)، at = نقطه (عند الساعه 5)',
      remember: 'in = جوّه/في وقت، on = فوق، at = نقطه'
    },
    'on': {
      meaning: 'على — للسطح والايام',
      useWhen: 'تتكلم عن شي فوق سطح (on the table) او يوم (on Monday) او شغال (the TV is on)',
      dontUseWhen: 'لا تستخدمها للاماكن المغلقه — استخدم in. ولا للنقاط الزمنيه — استخدم at',
      commonMistake: 'ترجمه على الحرفيه من العربي في اماكن غلط',
      howToAvoid: 'on = فوق سطح، on + يوم، is on = شغال (تلفزيون، نور)',
      remember: 'on = فوق / يوم / شغال'
    },
    'at': {
      meaning: 'عند — لنقطه محدده وساعه',
      useWhen: 'تتكلم عن مكان محدد (at the door) او ساعه (at 5 oclock) او حدث (at a party)',
      dontUseWhen: 'لا تستخدمها للمدن او الدول — استخدم in. ولا للسطح — استخدم on',
      commonMistake: 'خلط at مع in للاماكن',
      howToAvoid: 'at = نقطه (باب، ساعه، عنوان)، in = فضا (مدينه، غرفه)',
      remember: 'at = نقطه محدده، in = فضا واسع'
    },
    // Subject-verb agreement: common Arabic interference error
    'is': {
      meaning: 'كلمه مساعده — تستخدم مع he/she/it',
      useWhen: 'تتكلم عن شخص وواحد غايب في الحاضر. مثال: He is tall = هو طويل',
      dontUseWhen: 'ما تستخدمها مع I — استخدم am. ولا مع we/you/they — استخدم are',
      commonMistake: 'استخدام is مع I او they (Arabic interference)',
      howToAvoid: 'I + am، he/she/it + is، we/you/they + are',
      remember: 'is = مع وواحد غايب (he/she/it)'
    },
    'are': {
      meaning: 'كلمه مساعده — تستخدم مع we/you/they',
      useWhen: 'تتكلم عن جمع او المخاطب. مثال: They are happy = هم مبسوطين',
      dontUseWhen: 'ما تستخدمها مع I — استخدم am. ولا مع he/she/it — استخدم is',
    ...
    'was': {
      meaning: 'كان — ماضي is',
      useWhen: 'تتكلم عن شي وواحد غايب في الماضي. مثال: He was here = كان هنا',
      dontUseWhen: 'ما تستخدمها مع I — استخدم was بسن. ولا مع الجمع — استخدم were',
      commonMistake: 'خلط was مع were',
      howToAvoid: 'I/he/she/it + was، we/you/they + were',
      remember: 'was = ماضي للوواحد، were = ماضي للجمع'
    },
    'were': {
      meaning: 'كانوا — ماضي are',
      useWhen: 'تتكلم عن جمع في الماضي. مثال: They were here = كانوا هنا',
      dontUseWhen: 'ما تستخدمها مع الوواحد — استخدم was',
    ...
    'have': {
      ...
      useWhen: 'تتكلم عن امتلاك شي. مثال: I have a car = عندي سياره',
      dontUseWhen: 'ما تستخدمها مع he/she/it — استخدم has',
    ...
    'has': {
      ...
      useWhen: 'تتكلم عن امتلاك شي لوواحد غايب. مثال: He has a car = عنده سياره',
      dontUseWhen: 'ما تستخدمها مع I/we/you/they — استخدم have',
      commonMistake: 'استخدام has مع I او they',
      howToAvoid: 'he/she/it + has، I/we/you/they + have',
      remember: 'has = مع he/she/it بس'
    },
    // Negation: Arabic uses لا for both no/not
    'not': {
      meaning: 'مو / ما — للنفي',
      useWhen: 'تنفي فعل او صفه. مثال: I am not tired = انا مو تعبان',
      ...
      remember: 'not = نفي اللام، no = رفض الطلب'
    },
    'no': {
      meaning: 'لا — للرفض',
      useWhen: 'ترفض شي. مثال: No, thanks = لا، شكرا',
      dontUseWhen: 'لا تستخدمها بدل not لنفي الوفعال',
      commonMistake: 'استخدام no بدل not في الجمل',
      howToAvoid: 'no = رفض (سوال)، not = نفي (جمله)',
    ...
    'but': {
      ...
      dontUseWhen: 'لا تستخدمها للموافقه — استخدم and',
      commonMistake: 'نسيان but وربط الجمل ببدون رابط',
      howToAvoid: 'but = التعارض، and = الومثلن، so = النتيجه',
      remember: 'but = بس / لكن'
    },
    'because': {
      meaning: 'لان — للسبب',
      useWhen: 'تذكر سبب شي. مثال: I am happy because today is Friday = مبسوط لان اليوم الجمعه',
      dontUseWhen: 'لا تستخدمها للنتيجه — استخدم so',
      commonMistake: 'خلط because مع so — because = السبب، so = النتيجه',
      howToAvoid: 'because يجي قبل السبب، so يجي قبل النتيجه',
      remember: 'because = ليش، so = عشان كذا'
    },
    'or': {
      meaning: 'او — للاختيار',
      useWhen: 'تختار بين شيين. مثال: Tea or coffee? = شاي او قهوه؟',
    ...
    'there': {
      ...
      howToAvoid: 'there is = في وواحد، there are = في جمع. مثال: There are books = في كتب',
      remember: 'there is/are = فيه / في'
    }
  };
  ...
  var FUNCTION_WORDS = {
    'do':'كلمه مساعده للاساله','does':'كلمه مساعده مع he/she/it','did':'كلمه مساعده للماضي',
    ...
    'where':'وين','what':'وش','who':'منو','when':'متى','why':'ليش','how':'عشانف',
    'the':'الـ','a':'وواحد','an':'وواحد',
    'this':'ذا','that':'ذاك','these':'هذي','those':'ذول',
    'in':'في','on':'على','at':'عند','to':'لـ','for':'لـ','with':'مع','from':'من',
    'can':'ايمكنر','will':'راح','have':'عندي/امتلك','has':'عنده/امتلك',
    'going':'رايح','to':'لـ'
  };
  ...
  const TYPE_LABELS_DEF = {
    learn:['Learn','تعلم'], learn_sentence:['Sentence','جمله'], recognize:['Recognize','تعرف'],
    ...
    identify_heard:['Identify','حدد'], pronunciation:['Pronounce','انطق'], speaking:['Speak','تكلم'],
    ...
    free_response:['Build','رتب'], review:['Review','راجع'], challenge:['Challenge','تحدّي'],
    listening_dictation:['Dictation','املا'], guided_production:['Build it','ركبها'],
    concept:['Concept','قاعده'], concept_examples:['Examples','امثله'], db_order:['Build','رتب'], db_spell:['Spell','تهجى'],
    db_translate:['Translate','ترجم'], db_correct:['Fix','صحح'],
    mistake_coach:['Saudi Tip','نصيحه سعوديه'],
    minimal_pairs:['Sounds','اصوات'], intonation:['Question?','سوال؟'],
    writing_practice:['Build','رتب'], scenario_roleplay:['Role-play','موضع'],
  };
  const PROMPTS_DEF = {
    recognize:['Pick the meaning','اختر المعنى'], match:['Tap a pair','اضغط زوج'],
    arrange_words:['Tap words in order','اضغط الكلمات بالترتيب'], fill_blank:['Pick the missing word','اختر الكلمه الناقصه'],
    spell:['Spell the word','اهجّ الكلمه'], translate:['Translate','ترجم'],
    listen:['Press play','اضغط تشغيل'], identify_heard:['Pick what you heard','اختر اللي سمعته'],
    pronunciation:['Say it aloud','نطقها بصوت عالي'], speaking:['Say the sentence','نطق الجمله'],
    conversation_response:['Pick the natural reply','اختر الرد الطبيعي'], complete_dialogue:['Fill the gap','املا الينراغ'],
    grammar_correction:['Pick the correct sentence','اختر الجمله الصحه'], choose_natural_expression:['Pick the natural one','اختر الطبيعي'],
    free_response:['Build your answer','رتب جوابك'], review:['Recall','استرجع'], challenge:['Quick fire','سوال سريع'],
    listening_dictation:['Listen and arrange','اسمع ورتب'], guided_production:['Complete the sentence','كمل الجمله'],
    concept:['Read the rule','اقرا القاعده'], concept_examples:['See examples','شاهد الامثله'], db_order:['Tap words in order','اضغط الكلمات بالترتيب'],
    db_spell:['Spell the English word','اهجّ الكلمه بالحينجليزي'], db_translate:['Translate the sentence','ترجم الجمله'], db_correct:['Which sentence is correct?','اي جمله صح؟'],
    mistake_coach:['Fix the Saudi mistake','صلح الغلطه'],
    minimal_pairs:['Hear both, say the correct one','اسمع الكلمتين، قول الصح'],
    intonation:['Hear both, pick the question','اسمع الجملتين، اختر السوال'],
    writing_practice:['Tap words to build the sentence','اضغط الكلمات عشان تبني الجمله'],
    scenario_roleplay:['Complete the real-life task','كمل المهمه الواقعيه'],
  };
  ...
  return {
    ...
    srsSync,
    // SRS sync status (true after first successful server sync).
    srsSynced: function(){ return _srsSynced; }
  };
};
