  ...
  const PEL_BEGINNER = {
    'greetings-goodbye': {
      ...
      dialogue: [
        ...
        { who: 'B', en: 'I am fine, thank you. And you?', ar: 'تمام، شكراً. وانت؟', translit: 'اي ام فوين، ثانك يو. اند يو؟' },
    ...
    'introducing-yourself': {
      ...
      items: [
        ...
        },
        {
          ...
          example: { en: 'Nice to meet you, Sara.', ar: 'سعدت بلقياك، ساره.', translit: 'نايس تو ميت يو، ساره.' },
      ...
      dialogue: [
        ...
        { who: 'B', en: 'My name is Sara. Nice to meet you.', ar: 'اسمي ساره. سعدت بلقياك.', translit: 'ماي نيم ايز ساره. نايس تو ميت يو.' },
        { who: 'A', en: 'Nice to meet you too. I am from Jeddah.', ar: 'سعدت بلقياك بعد. انا من جده.', translit: 'نايس تو ميت يو تو. اي ام فرام جدّه.' },
      ...
      items: [
        {
          ...
          usage: { en: 'A scheduled meeting with a doctor, office, or service.', ar: 'موعد مجدول مع دكتور او جهه.' },
          sentences: [
        ...
        },
        {
          ...
          usage: { en: 'Polite way to say what you want. "I want" is more direct.', ar: 'طريقه مهذبه تبين اللي تبيه. "اي ونت" اكثر مباشره.' },
          sentences: [
    ...
    'asking-directions': {
      ...
      items: [
        {
          ...
          ipa: '/wer/',
          example: { en: 'Where is the school?', ar: 'وين المدرسه؟', translit: 'وير ايز ذا سكول؟' },
      ...
      dialogue: [
        { who: 'A', en: 'Where is the school?', ar: 'وين المدرسه؟', translit: 'وير ايز ذا سكول؟' },
    ...
    'places-in-town': {
      ...
      items: [
        {
          ...
          ipa: '/skuːl/',
          example: { en: 'The school is near.', ar: 'المدرسه قريبه.', translit: 'ذا سكول ايز نير.' },
          usage: { en: 'Where children learn.', ar: 'مكان يتعلم فيه الاطفال.' },
          sentences: [
            { en: 'I go to school.', ar: 'اروح المدرسه.', translit: 'اي قو تو سكول.' },
            { en: 'The school is big.', ar: 'المدرسه كبيره.', translit: 'ذا سكول ايز بيغ.' },
            { en: 'Where is the school?', ar: 'وين المدرسه؟', translit: 'وير ايز ذا سكول؟' },
          ],
        },
        {
      ...
      dialogue: [
        ...
        { who: 'B', en: 'It is near the school.', ar: 'قريب من المدرسه.', translit: 'ات ايز نير ذا سكول.' },
...
@media(max-width:680px){
  ...
  const PEL_MIN_PAIRS = [
    ...
    { contrast:'/f/ vs /v/', target:'very', confusion:'fery', ar:'جدا', tipAr:'V فيها اهتزاز بالشفه، F ما فيها. حط يدك على حنجرتك حس الاهتزاز.' },
    ...
    },
    {
      ...
      turns:[
        ...
        },
        {
          ...
          options:[
            { text:'Thank you! You too.', ok:true, whyAr:'ممتاز! شكرت وردت على الدعوه. طريقه مهذبه جدا.', outcomeAr:'تم استلام القهوه. احسنت!' },
    ...
    },
    {
      ...
      turns:[
        ...
        },
        {
          ...
          options:[
            { text:'Thank you! Have a great day.', ok:true, whyAr:'ممتاز! شكرت وردت على الدعوه. طريقه مهذبه جدا.', outcomeAr:'تم تسجيل الدخول. احسنت!' },
  ...
  function connectionNoteFor(act){
    ...
    if(/\b(am|is|are)\s+\w+ing\b/i.test(text)){
      return 'هنا نستخدم am او is او are + كلمه تنتهي بـ ing. معناها شي يصير الحين هذي اللحظه. am مع I، is مع he/she/it، are مع we/you/they. الترتيب: الشخص + am/is/are + كلمه+ing. مثال: I am eating = انا اكل الحين';
    }
    // 3. Present perfect - have/has + past participle
    if(/\b(have|has|ve|s)\s+\w+(ed|en|wn|rd|t)\b/i.test(text) || /\bhave\s+been\b/i.test(text)){
      return 'هنا نستخدم have او has + كلمه فعل بصيغه الماضي (زي stopped او eaten). معناها شي صار في الماضي ولا زال مهم للحين. have مع I/we/you/they، has مع he/she/it. مثال: I have eaten = انا اكلت (ولا زال تاثيره موجود)';
    }
    // 4. Going to - future plans
    if(/\bgoing\s+to\b/i.test(text)){
      return 'going to = رايح (للمستقبل). نستخدمها لما يكون فيه خطه مسبقه. الترتيب: الشخص + am/is/are + going to + كلمه فعل. مثال: I am going to visit = انا رايح ازور';
    }
    // 5. Will - future
    if(/\bwill\b/i.test(text) && !/\b(would|william)\b/i.test(text)){
      return 'will = راح (للمستقبل). نستخدمها لشي راح يصير بدون خطه مسبقه. الترتيب: الشخص + will + كلمه فعل. مثال: I will call you = راح اتصل بك';
    }
    // 6. Can / can't - ability
    if(/\bcan('t|not)?\b/i.test(text)){
      return 'can = اقدر (للاستطاعه) · can\'t = ما اقدر. نستخدمها لما نقول اننا نقدر نسوي شي او ما نقدر. الترتيب: الشخص + can/can\'t + كلمه فعل. مثال: I can swim = اقدر اسبح';
    }
    ...
    if(/\bwould\s+like\b/i.test(text)){
      return 'would like = ابي/احب (طلب مهذب). احسن من I want لانها اكثر تهذيبا. الترتيب: I + would like + to + كلمه فعل. مثال: I would like to order = ابي اطلب';
    }
    // 9. Could you / Would you mind - polite requests
    if(/\bcould\s+you\b/i.test(text)){
      return 'Could you = ممكن (طلب مهذب). اكثر تهذيبا من Can you. الترتيب: Could you + كلمه فعل. مثال: Could you help me = ممكن تساعدني';
    }
    ...
    if(/\bin\s+(the\s+)?(morning|afternoon|evening|night|room|house|car|bag|box|school|work|bed)\b/i.test(text)){
      return 'in = في (للوقت الكبير والاماكن المغلقه). في الصباح، في الغرفه، في السياره. الترتيب: in + وقت/مكان. مثال: in the morning = في الصباح، in the car = في السياره';
    }
    ...
    if(/\bat\s+\d/i.test(text) || /\bat\s+(home|school|work|night|noon)\b/i.test(text)){
      return 'at = عند/في (للوقت المحدد والاماكن المحدده). الساعه 6، في البيت، في الليل. الترتيب: at + وقت/مكان محدد. مثال: at 6pm = الساعه 6، at home = في البيت';
    }
    // 17. So do I / Neither do I - agreement
    if(/\bso\s+do\s+i\b/i.test(text)){
      return 'So do I = وانا مثلن (موافقه). نستخدمها لما نوافق على كلام احد. مثال: A: I like coffee. B: So do I = وانا مثلن';
    }
    if(/\bneither\s+do\s+i\b/i.test(text)){
      return 'Neither do I = وانا لا (موافقه على النفي). نستخدمها لما نوافق على كلام منفي. مثال: A: I don\'t like tea. B: Neither do I = وانا لا';
    }
    ...
    if(/^it\s+is\s+\w+/i.test(text) || /\bit\s+is\s+(hot|cold|rainy|sunny|windy|warm|cool|nice|beautiful|important)\b/i.test(text)){
      return 'It is + كلمه وصف: لوصف الجو او شي عام. الترتيب: It is + كلمه وصف. مثال: It is hot = الجو حار، It is rainy = الجو ممطر';
    }
    ...
    if(/\b(am|is|are)\b/i.test(text) && !/\b(was|were|will|can|could|should|would|have|has|had)\b/i.test(text)){
      return 'am/is/are = كلمه ربط (للمضارع). am مع I، is مع he/she/it، are مع we/you/they. الترتيب: الشخص + am/is/are + باقي الجمله. مثال: I am happy = انا مبسوط، She is tired = هي تعبانه';
    }
    ...
    if(/\b(plays|goes|eats|works|lives|likes|wants|needs|runs|walks|talks|looks|sees|hears|feels|comes|does|says|sits|stands|reads|writes|drives|rides|flies|takes|makes|gives|gets|lets|sets|hits|fits|puts|cuts|costs|bets|bids|shuts|bursts|casts)\b/i.test(text)){
      return 'في المضارع البسيط: اذا كان الشخص واحد (he/she/it) نزيد s على اخر كلمه الفعل. الترتيب: الشخص + كلمه فعل+s + باقي الجمله. مثال: He plays = هو يلعب، She works = هي تشتغل';
    }
    // 22. Questions with do/does
    if(/\b(do you|does he|does she|does it|do they|do we|does the)\b/i.test(text)){
      return 'للسوال في المضارع البسيط نستخدم Do او Does قبل الشخص. Does مع he/she/it، Do مع I/you/we/they. الترتيب: Do/Does + الشخص + كلمه فعل. مثال: Do you work = انت تشتغل؟، Does he like = هو يحب؟';
    }
    // 23. Negation with don't/doesn't
    if(/\b(don't|doesn't|do not|does not)\b/i.test(text)){
      return 'للنفي في المضارع البسيط نستخدم don\'t او doesn\'t. don\'t مع I/you/we/they، doesn\'t مع he/she/it. الترتيب: الشخص + don\'t/doesn\'t + كلمه فعل. مثال: I don\'t know = ما اعرف، She doesn\'t work = ما تشتغل';
    }
  ...
  function grammarGlossary(act){
    ...
    if(lesson.grammar && lesson.grammar.rule){
      ...
      if(/present simple|present tense/.test(r)) add('pressimple', 'المضارع البسيط', 'زمن يصف شي يصير عاده او دايم. مثال: I work = انا اشتغل، He plays = هو يلعب');
      ...
      if(/imperative|command/.test(r)) add('imp', 'صيغه الامر', 'جمله تبدا بكلمه فعل مباشره بدون شخص. مثال: Go straight = امشي مستقيم');
  ...
  var TEACHING_CONTENT = {
    ...
    'was': {
      ...
      dontUseWhen: 'لا تستخدمها مع I — استخدم was بسن. ولا مع الجمع — استخدم were',
