...
.pel-teach-word{display:flex;align-items:baseline;gap:10px;flex-wrap:wrap;padding:10px 14px;background:var(--card-elevated);border-radius:12px;border:1px solid var(--border);}
.pel-teach-en{font-size:1rem;font-weight:600;direction:ltr;}
.pel-teach-tr{font-size:.85rem;color:var(--gold-soft);direction:rtl;}
.pel-teach-ar{font-size:.95rem;margin-inline-start:auto;direction:rtl;}
...
@media(max-width:680px){
  ...
  var PRON_HINTS = {
    ...
    'the': { beats:1, ar:'مقطع واحد: ذا — خفيفة وسريعة', avoid:'لا تقول: ده أو ذي' },
    'this': { beats:1, ar:'مقطع واحد: ذس', avoid:'لا تقول: ديس' },
    'that': { beats:1, ar:'مقطع واحد: ذات', avoid:'لا تقول: دات' },
    'these': { beats:1, ar:'مقطع واحد: ذيز', avoid:'لا تقول: ديز' },
    'those': { beats:1, ar:'مقطع واحد: ذوز — تبدأ بـ ذ مو د', avoid:'لا تقول: دوز أو دو-ز' },
    'there': { beats:1, ar:'مقطع واحد: ذير — تبدأ بـ ذ مو د', avoid:'لا تقول: دير' },
    'their': { beats:1, ar:'مقطع واحد: ذير — مثل there', avoid:'لا تقول: دير' },
    'then': { beats:1, ar:'مقطع واحد: ذِن — TH هنا صوتها ذ', avoid:'لا تقول: دِن' },
    'with': { beats:1, ar:'مقطع واحد: وِذ — آخرها TH ناعمة', avoid:'لا تقول: وِت' },
    'three': { beats:1, ar:'مقطع واحد: ثري — طرف اللسان بين الأسنان', avoid:'لا تقول: تري أو سري' },
    'think': { beats:1, ar:'مقطع واحد: ثِنك — TH خفيفة من بين الأسنان', avoid:'لا تقول: تنك أو سنك' },
    'thank': { beats:1, ar:'مقطع واحد: ثانك — TH مو T', avoid:'لا تقول: تانك' },
    'thought': { beats:1, ar:'مقطع واحد: ثوت', avoid:'لا تقول: ثو-ت' },
    'through': { beats:1, ar:'مقطع واحد: ثرو', avoid:'لا تقول: ثرو-و' },

    // --- P vs B (Arabic has no P) ---
    'pen': { beats:1, ar:'مقطع واحد: پِن — صوت P يطلع بهواء من الشفايف', avoid:'لا تقول: بِن' },
    'people': { beats:2, ar:'مقطعين: پي-پل — ركز على P في البداية', avoid:'لا تقول: بيبل' },
    'please': { beats:1, ar:'مقطع واحد: پليز — P مو B', avoid:'لا تقول: بليز' },
    'park': { beats:1, ar:'مقطع واحد: پارك — P قوية بهواء', avoid:'لا تقول: بارك' },
    'paper': { beats:2, ar:'مقطعين: پي-پر — فيها P مرتين', avoid:'لا تقول: بيبر' },
    'problem': { beats:2, ar:'مقطعين: پرا-بلم — P في البداية', avoid:'لا تقول: بروبلم' },
    'speak': { beats:1, ar:'مقطع واحد: سپيك — SP مع بعض و P مو B', avoid:'لا تقول: اسبيك أو سبيك' },

    // --- V vs F (Arabic has no V) ---
    'very': { beats:2, ar:'مقطعين: ڤي-ري — V اهتزاز خفيف في الشفة', avoid:'لا تقول: فيري' },
    'visit': { beats:2, ar:'مقطعين: ڤي-زت — V مو F', avoid:'لا تقول: فيزت' },
    'have': { beats:1, ar:'مقطع واحد: هاڤ — آخرها V', avoid:'لا تقول: هاف' },
    'five': { beats:1, ar:'مقطع واحد: فايف — آخرها V خفيفة', avoid:'لا تقول: فايف بقوة F' },
    'seven': { beats:2, ar:'مقطعين: سِ-ڤن — V في النص', avoid:'لا تقول: سِفن' },

    // --- Consonant clusters (Arabic adds a vowel before s-clusters) ---
    'school': { beats:1, ar:'مقطع واحد: سكول — ابدأ بـ S مباشرة', avoid:'لا تقول: اسكول' },
    'student': { beats:2, ar:'مقطعين: ستو-دنت — ابدأ بـ ST مباشرة', avoid:'لا تقول: استودنت' },
    'street': { beats:1, ar:'مقطع واحد: ستريت — STR مع بعض', avoid:'لا تقول: استريت' },
    'small': { beats:1, ar:'مقطع واحد: سمال — SM مع بعض', avoid:'لا تقول: اسمال' },

    // --- CH sound ---
    'chair': { beats:1, ar:'مقطع واحد: چير — CH مثل تش خفيفة', avoid:'لا تقول: شير' },
    'cheap': { beats:1, ar:'مقطع واحد: چيپ — CH ثم P', avoid:'لا تقول: شيب' },
    'question': { beats:2, ar:'مقطعين: كوس-چن — آخرها چن', avoid:'لا تقول: كويستيون' },

    // --- Diphthongs and long vowels ---
    'name': { beats:1, ar:'مقطع واحد: نيم — A هنا مثل إي طويلة', avoid:'لا تقول: نام' },
    'day': { beats:1, ar:'مقطع واحد: ديي — طويلة شوي', avoid:'لا تقول: داي قصيرة' },
    'rain': { beats:1, ar:'مقطع واحد: رين — AI مثل إي طويلة', avoid:'لا تقول: راين' },
    'phone': { beats:1, ar:'مقطع واحد: فون — PH تنطق F', avoid:'لا تقول: پون' },
    'home': { beats:1, ar:'مقطع واحد: هوم — O طويلة', avoid:'لا تقول: هُم' },
    'go': { beats:1, ar:'مقطع واحد: قو/گو — O طويلة', avoid:'لا تقول: جُو قصيرة' },
    'about': { beats:2, ar:'مقطعين: أ-باوت — لا تضغط أول حرف', avoid:'لا تقول: آبَوت' },
    'house': { beats:1, ar:'مقطع واحد: هاوس — OU مثل او', avoid:'لا تقول: هوس' },

    // --- R/L clusters ---
    'work': { beats:1, ar:'مقطع واحد: وِرك — لا تمد الواو', avoid:'لا تقول: وورك' },
    'world': { beats:1, ar:'مقطع واحد: وِرلد — اربط RLD بسرعة', avoid:'لا تقول: وور-لد' },
    'girl': { beats:1, ar:'مقطع واحد: قِرل/گِرل — R خفيفة', avoid:'لا تقول: جيرل بمقطعين' },

    // --- Silent letters ---
    'know': { beats:1, ar:'مقطع واحد: نو — K ساكت', avoid:'لا تقول: كنو' },
    'write': { beats:1, ar:'مقطع واحد: رايت — W ساكت', avoid:'لا تقول: ورايت' },
    'listen': { beats:2, ar:'مقطعين: لِ-سن — T ساكت', avoid:'لا تقول: لِستن' },
    'hour': { beats:1, ar:'مقطع واحد: آور — H ساكت', avoid:'لا تقول: هاور' },
    'walked': { beats:1, ar:'مقطع واحد: ووكت — ED هنا صوتها T', avoid:'لا تقول: ووكد أو ووكدِد' },

    // --- Multi-syllable common traps ---
    'tired': { beats:1, ar:'مقطع واحد: تايرد — قلها بسرعة بدون ما توقف بين الحروف', avoid:'لا تقول: تاي-رِد (مقطعين)' },
    'water': { beats:2, ar:'مقطعين: وا-تر (الواو والتر مربوطين)', avoid:'لا تقول: وا-تر بسكتة بينهم' },
    'better': { beats:2, ar:'مقطعين: بي-تر', avoid:'لا تقول: بي-ت-تر' },
    'father': { beats:2, ar:'مقطعين: فا-ذر', avoid:'لا تقول: فا-ت-ه-ر' },
    'mother': { beats:2, ar:'مقطعين: ما-ذر', avoid:'لا تقول: ما-ت-ه-ر' },
    'brother': { beats:2, ar:'مقطعين: برا-ذر', avoid:'لا تقول: برا-ت-ه-ر' },
    'daughter': { beats:2, ar:'مقطعين: دو-تر', avoid:'لا تقول: دو-ت-ه-ر' },
    'important': { beats:3, ar:'ثلاث مقاطع: ام-بور-تننت', avoid:'لا تقول: ام-بور-تن-ت' },
    'comfortable': { beats:3, ar:'ثلاث مقاطع: كام-فتر-بل', avoid:'لا تقول: كوم-فور-تبل (اربع)' },
    'every': { beats:2, ar:'مقطعين: اڤ-ري', avoid:'لا تقول: اڤ-ري-و' },
    'different': { beats:3, ar:'ثلاث مقاطع: دي-فر-نت', avoid:'لا تقول: دي-ف-ر-نت' },
    'interesting': { beats:3, ar:'ثلاث مقاطع: ان-تر-ستنج', avoid:'لا تقول: ان-تر-اس-تنج' },
    'restaurant': { beats:3, ar:'ثلاث مقاطع: راس-تر-نت', avoid:'لا تقول: راس-تو-ران-ت' },
    'would': { beats:1, ar:'مقطع واحد: ود', avoid:'لا تقول: و-ول-د' },
    'should': { beats:1, ar:'مقطع واحد: شود', avoid:'لا تقول: شو-ول-د' },
    'could': { beats:1, ar:'مقطع واحد: كود', avoid:'لا تقول: كو-ول-د' }
  };
  ...
  var PRON_PATTERNS = [
    ...
    { test:/^str\w/i, hint:{ beats:1, ar:'STR مع بعض — ابدأ بـ S ثم T ثم R بسرعة', avoid:'لا تضيف إ قبل الـ S' } },
    // s + stop clusters: Arabic speakers add إ/ا before s
    { test:/^(sp|st|sk|sm|sn)\w/i, hint:{ beats:1, ar:'ابدأ بحرف S مع الحرف اللي بعده مباشرة بدون ما تضيف صوت قبلها', avoid:'لا تضيف إ أو ا قبل الـ S' } },
    // ph → F
    { test:/^ph/i, hint:{ beats:1, ar:'PH تنطق F — لا تستخدم P', avoid:'لا تنطقها پ' } },
    // kn → silent K
    { test:/^kn/i, hint:{ beats:1, ar:'K ساكت — ابدأ بالنون مباشرة', avoid:'لا تنطق الـ K' } },
    // wr → silent W
    { test:/^wr/i, hint:{ beats:1, ar:'W ساكت — ابدأ بالراء مباشرة', avoid:'لا تنطق الـ W' } },
    // -tion ending → شن
    { test:/tion$/i, hint:{ beats:0, ar:'آخرها -tion تنطق شن مثل question', avoid:'لا تنطقها تيون أو سيون' } }
  ];
  ...
  function buildSequence(lesson, lessonId){
    ...
    main.forEach((it, i) => {
      ...
      var learnSent = it.sentences[1] || (it.sentences[0] && it.sentences[0].en && it.sentences[0].en !== it.en && it.sentences[0].en.split(/\s+/).filter(Boolean).length >= 2 ? it.sentences[0] : null);
      if(learnSent) seq.push({ type:'learn_sentence', item:it, sentence:learnSent, skill:'vocabulary' });
    });
    ...
    // 13c. Guided PRODUCTION: the bridge between controlled practice and
    ...
    // Recognition vs production tagging: every activity is classified so
    // the done screen can report both skills separately (recognizing an
    // answer is not the same as producing one).
    const MODE_BY_TYPE = {
      learn:'recognition', learn_sentence:'recognition', recognize:'recognition', match:'recognition',
  ...
  const Stage = {
    ...
    render(){
      ...
      if(renderer){
        ...
        if(!isTeachingAct && TEACH_BEFORE[act.type] && !act._taught){
          ...
          if(teachPlay){
            var tvocab = extractActivityVocab(act);
            var twIdx = 0;
          ...
          if(window.lucide) lucide.createIcons();
          this.ready(ctx, L('Start practicing','ابدأ التدريب'), ()=>{
    ...
    next(){
      const s=this.state; if(!s) return;
      if(s.idx < s.seq.length){ s.idx++; saveStagePos(); this.render(); }
    },
    renderDone(){
      ...
      if(!masteryMet){
        body.innerHTML = `<div class="pel-stage-done pel-card-enter">
          ...
          <p>${L('Answer correctly on the production exercises — first try — to complete this lesson. Review the weak spots and try again.','جاوب صح على تمارين الإنتاج من أول محاولة عشان تخلص الدرس. راجع نقاط ضعفك وحاول ثانية.')}</p>
          <div class="pel-act-hint" style="margin-top:10px;">${L('Production (first try)','الإنتاج (أول محاولة)')}: <b>${prodFirstOk}/${prodTotal}</b> &nbsp;·&nbsp; ${L('Needed','المطلوب')}: <b>${Math.ceil(MASTERY_MIN_OK*prodTotal)}</b></div>
      ...
      // Auto-advance to next lesson after 5 seconds (cancel on any click)
      ...
      if(_doneCard){
        ...
        var _secs = 5;
        _cd.innerHTML = L('Auto-advancing in','الانتقال التلقائي خلال') + ' <b>' + _secs + '</b> ' + L('seconds','ثانية');
        _doneCard.appendChild(_cd);
        var _cdTimer = setInterval(function(){
          _secs--;
          if(_secs <= 0){ clearInterval(_cdTimer); }
          else { _cd.innerHTML = L('Auto-advancing in','الانتقال التلقائي خلال') + ' <b>' + _secs + '</b> ' + L('seconds','ثانية'); }
        }, 1000);
        _doneCard.addEventListener('click', function(){
          clearTimeout(_autoAdv); clearInterval(_cdTimer);
  ...
  function captureActivityDOM(){
    ...
    try{
      ...
      // Ordered tokens (db_order / arrange_words)
      var tokens = [];
      Stage.el.querySelectorAll('.pel-token-placed').forEach(function(el){
      ...
      // Matched pairs
      var pairs = [];
      Stage.el.querySelectorAll('.pel-pair-done').forEach(function(el){
  ...
  function saveStageSession(){
    try{
      ...
      if(c && uid){
        c.from('student_data').upsert({ user_id: uid, key: STAGE_POS_KEY, value: raw }).then(function(){}).catch(function(){});
      }
    }catch(e){}
  }
  ...
  function restoreActivityDOM(){
    try{
      ...
      // Enable Check button if selections/typed text were restored (pre-check state)
      if(!r.checked && (r.selected || r.typed)){
  ...
  function clearStagePos(){
    try{
      ...
      var c = srsSupabase(), uid = srsUserId();
      if(c && uid){
        c.from('student_data').upsert({ user_id: uid, key: STAGE_POS_KEY, value: null }).then(function(){}).catch(function(){});
      }
    }catch(e){}
  }
  ...
  function srsPush(en, r){
    try{
      ...
      if(!c || !uid) return;
      c.from('pel_srs_state').upsert(srsRow(uid, en, r), { onConflict: 'user_id,en' }).then(function(){}).catch(function(){});
    }catch(e){}
  }
  function srsPushAll(c, uid){
    try{
      ...
      const flush = function(){
        ...
        c.from('pel_srs_state').upsert(batch, { onConflict: 'user_id,en' }).then(function(){}).catch(function(){});
        batch = [];
      };
  ...
  function connectionNoteFor(act){
    ...
    if(/\bthere\s+(is|are)\b/i.test(text)){
      return 'there is = فيه (للمفرد) · there are = فيهم (للجمع). نستخدمها لقول ان شي موجود. النمط: There is/are + اسم + مكان';
    }
    // 2. Present continuous — am/is/are + -ing
    if(/\b(am|is|are)\s+\w+ing\b/i.test(text)){
      return 'المضارع المستمر: am/is/are + فعل + ing. يوصف شي يصفر الحين. am للمتكلم (I)، is للمفرد، are للجمع. النمط: فاعل + am/is/are + فعل-ing + ...';
    }
    // 3. Present perfect — have/has + past participle
    if(/\b(have|has|ve|s)\s+\w+(ed|en|wn|rd|t)\b/i.test(text) || /\bhave\s+been\b/i.test(text)){
      return 'المضارع التام: have/has + التصريف الثالث. يربط الماضي بالحاضر. have للجمع (I/we/you/they)، has للمفرد (he/she/it). النمط: فاعل + have/has + تصريف ثالث + ...';
    }
    // 4. Going to — future plans
    if(/\bgoing\s+to\b/i.test(text)){
      return 'going to = رايح (للمستقبل المخطط). نستخدمها لما يكون فيه خطة. النمط: فاعل + am/is/are + going to + فعل + ...';
    }
    // 5. Will — future
    if(/\bwill\b/i.test(text) && !/\b(would|william)\b/i.test(text)){
      return 'will = راح (للمستقبل المفاجئ او القرار اللحظي). النمط: فاعل + will + فعل + ...';
    }
    // 6. Can / can't — ability
    if(/\bcan('t|not)?\b/i.test(text)){
      return 'can = اقدر (للاستطاعة) · can\'t = ما اقدر. نستخدمها للقدرة والامكانية. النمط: فاعل + can/can\'t + فعل + ...';
    }
    // 7. Have / has — possession
    if(/\b(have|has)\b/i.test(text) && !/\b(have|has)\s+\w+(ed|en|wn|rd)\b/i.test(text)){
      return 'have/has = عندي/عنده (للملكية). have للجمع (I/we/you/they)، has للمفرد (he/she/it). النمط: فاعل + have/has + اسم + ...';
    }
    // 8. Would like — polite requests
    if(/\bwould\s+like\b/i.test(text)){
      return 'would like = ابي/احب (طلب مهذب). اكثر تهذيبا من I want. النمط: I + would like + to + فعل او I would like + اسم';
    }
    // 9. Could you / Would you mind — polite requests
    if(/\bcould\s+you\b/i.test(text)){
      return 'Could you = ممكن (طلب مهذب). Could اكثر تهذيبا من Can. النمط: Could you + فعل + ...؟';
    }
    if(/\bwould\s+you\s+mind\b/i.test(text)){
      return 'Would you mind = هل تمانع (طلب اكثر تهذيبا). ياخذ فعل + ing. النمط: Would you mind + فعل-ing + ...؟';
    }
    // 10. How much / How many — countable/uncountable
    if(/\bhow\s+much\b/i.test(text)){
      return 'How much = كم (للغير معدود والفلوس). النمط: How much + اسم غير معدود + ...؟';
    }
    if(/\bhow\s+many\b/i.test(text)){
      return 'How many = كم (للمعدود). النمط: How many + اسم جمع + ...؟';
    }
    // 11. WH- question words
    if(/\bwhat\b/i.test(text)){
      return 'What = شنو/ايش. تبدا بيها السؤال، بعدها الفعل المساعد. النمط: What + فعل مساعد + فاعل + فعل + ...؟';
    }
    if(/\bwhere\b/i.test(text)){
      return 'Where = وين. للسؤال عن المكان. النمط: Where + فعل مساعد + فاعل + ...؟';
    }
    if(/\bwhen\b/i.test(text)){
      return 'When = متى. للسؤال عن الوقت. النمط: When + فعل مساعد + فاعل + ...؟';
    }
    if(/\bwho\b/i.test(text)){
      return 'Who = من. للسؤال عن الشخص. النمط: Who + فعل مساعد + فاعل + ...؟';
    }
    if(/\bwhy\b/i.test(text)){
      return 'Why = ليش. للسؤال عن السبب. الجواب يبدا بـ because. النمط: Why + فعل مساعد + فاعل + ...؟';
    }
    if(/\bhow\b/i.test(text) && !/\bhow\s+(much|many|old)\b/i.test(text)){
      return 'How = كيف. للسؤال عن الطريقة او الحالة. النمط: How + فعل مساعد + فاعل + ...؟';
    }
    // 12. Comparatives
    if(/\b\w+er\s+than\b/i.test(text) || /\bmore\s+\w+\s+than\b/i.test(text)){
      return 'المقارنة: الصفة القصيرة + er + than (bigger than) · الصفة الطويلة: more + صفة + than (more beautiful than). النمط: اسم + صفةer/more صفة + than + اسم';
    }
    // 13. Demonstrative pronouns
    if(/\b(this|that|these|those)\b/i.test(text)){
      return 'this = ذس (قريب، مفرد) · that = ذات (بعيد، مفرد) · these = ذيز (قريب، جمع) · those = ذوز (بعيد، جمع). النمط: اسم اشارة + اسم + فعل + باقي الجملة';
    }
    // 14. Articles — a/an/the
    if(/\b\ba\s+[bcdfghjklmnpqrstvwxyz]\w*/i.test(text)){
      return 'a = واحد (قبل صوت ساكن). النمط: a + اسم مفرد يبدا بصوت ساكن. مثال: a book، a car';
    }
    if(/\ban\s+[aeiou]\w*/i.test(text)){
      return 'an = واحد (قبل صوت متحرك a/e/i/o/u). النمط: an + اسم مفرد يبدا بصوت متحرك. مثال: an apple، an egg';
    }
    if(/\bthe\b/i.test(text) && !/\bthere\b/i.test(text)){
      return 'the = الـ (للشي المحدد اللي يعرفه الطرفين). النمط: the + اسم. مثال: the book، the door';
    }
    // 15. Possessive adjectives
    if(/\b(my|your|his|her|our|their)\b/i.test(text)){
      return 'ملكيات: my = ي · your = ك · his = ه · her = ها · our = نا · their = هم. توضع قبل الاسم. النمط: ضمير ملكية + اسم. مثال: my name، your phone';
    }
    ...
    if(/\bin\s+(the\s+)?(morning|afternoon|evening|night|room|house|car|bag|box|school|work|bed)\b/i.test(text)){
      return 'in = في (للوقت الكبير والاماكن المغلقة). في الصباح/المساء، في الغرفة، في السيارة. النمط: in + وقت/مكان';
    }
    if(/\bon\s+(monday|tuesday|wednesday|thursday|friday|saturday|sunday|table|desk|wall|floor|shelf)\b/i.test(text)){
      return 'on = على (ليوم الاسبوع والاسطح). على الطاولة، يوم الاثنين. النمط: on + يوم/سطح';
    }
    if(/\bat\s+\d/i.test(text) || /\bat\s+(home|school|work|night|noon)\b/i.test(text)){
      return 'at = عند/في (للوقت المحدد والاماكن المحددة). الساعة 6، في البيت، في الليل. النمط: at + وقت/مكان محدد';
    }
    // 17. So do I / Neither do I — agreement
    if(/\bso\s+do\s+i\b/i.test(text)){
      return 'So do I = وانا كذلك (موافقة على جملة مثبتة). النمط: So + فعل مساعد + فاعل';
    }
    if(/\bneither\s+do\s+i\b/i.test(text)){
      return 'Neither do I = وانا لا (موافقة على جملة منفية). النمط: Neither + فعل مساعد + فاعل';
    }
    ...
    if(/^it\s+is\s+\w+/i.test(text) || /\bit\s+is\s+(hot|cold|rainy|sunny|windy|warm|cool|nice|beautiful|important)\b/i.test(text)){
      return 'It is + صفة: لوصف الجو او شي عام. It is hot = الجو حار. It is rainy = الجو ممطر. النمط: It is + صفة + ...';
    }
    ...
    if(/\b(am|is|are)\b/i.test(text) && !/\b(was|were|will|can|could|should|would|have|has|had)\b/i.test(text)){
      return 'am/is/are = فعل يكون (للمضارع). am للمتكلم (I)، is للمفرد (he/she/it)، are للجمع (we/you/they). النمط: فاعل + am/is/are + ...';
    }
    // 20. Past simple was/were
    if(/\b(was|were)\b/i.test(text)){
      return 'was/were = فعل يكون (للماضي). was للمفرد (I/he/she/it)، were للجمع (we/you/they). النمط: فاعل + was/were + ...';
    }
    ...
    if(/\b(plays|goes|eats|works|lives|likes|wants|needs|runs|walks|talks|looks|sees|hears|feels|comes|does|says|sits|stands|reads|writes|drives|rides|flies|takes|makes|gives|gets|lets|sets|hits|fits|puts|cuts|costs|bets|bids|shuts|bursts|casts)\b/i.test(text)){
      return 'في المضارع البسيط: الفاعل المفرد (he/she/it) ياخذ فعل + s. النمط: فاعل + فعل + s + ...';
    }
    // 22. Questions with do/does
    if(/\b(do you|does he|does she|does it|do they|do we|does the)\b/i.test(text)){
      return 'للسؤال في المضارع البسيط: Do/Does + فاعل + فعل. Does للمفرد (he/she/it)، Do للجمع. النمط: Do/Does + فاعل + فعل + ...؟';
    }
    // 23. Negation with don't/doesn't
    if(/\b(don't|doesn't|do not|does not)\b/i.test(text)){
      return 'النفي في المضارع البسيط: don\'t (للجمع) / doesn\'t (للمفرد) + فعل. النمط: فاعل + don\'t/doesn\'t + فعل + ...';
    }
    ...
    if(/^(go|turn|take|stop|wait|listen|look|open|close|come|sit|stand|bring|give|show|tell|put|let|keep|try|make|check|read|write|say)\b/i.test(text)){
      return 'صيغة الامر: الفعل بدون فاعل. اعطي تعليمات مباشرة. النمط: فعل + ... (مثال: Go straight، Turn left)';
    }
    return '';
  }
  ...
  function buildTeachHtml(act){
    ...
    html += '<div class="pel-teach-title">' + L('You will practice','ستتمرن على') + ': ' + esc(actLabel) + '</div>';

    // Full sentence/question with Arabic translation
    var sentence = extractActivitySentence(act);
    if(sentence){
      html += '<div class="pel-teach-section">' + L('Sentence / Question','الجملة / السؤال') + '</div>';
    ...
    if(lesson.grammar && lesson.grammar.saudi){
      html += '<div class="pel-teach-section">' + L('Grammar rule','القاعدة') + '</div>';
      html += '<div class="pel-teach-grammar arabic">' + esc(lesson.grammar.saudi) + '</div>';
    }
    if(lesson.grammar && lesson.grammar.rule){
      html += '<div class="pel-teach-grammar">' + esc(lesson.grammar.rule) + '</div>';
    }
    if(lesson.dbNotes && lesson.dbNotes.length){
      lesson.dbNotes.forEach(function(n){
        if(n.ar){
          html += '<div class="pel-teach-grammar arabic">' + esc(n.ar) + '</div>';
        } else if(n.en){
          html += '<div class="pel-teach-grammar">' + esc(n.en) + '</div>';
        }
      });
    }

    // Connection note: how words connect (Arabic grammar explanation)
    var connNote = connectionNoteFor(act);
    if(connNote){
      html += '<div class="pel-teach-section">' + L('How words connect','كيف تتصل الكلمات') + '</div>';
      html += '<div class="pel-teach-grammar arabic">' + esc(connNote) + '</div>';
    }
  ...
  const RENDERERS = {
      ...
      const reveal = () => {
        ...
        if(revealEl){
          revealEl.innerHTML = `
            ...
            ${it.ar?`<div class="pel-act-ar arabic">${esc(it.ar)}</div>`:''}
            ${it.example&&it.example.en?`<div class="pel-act-example">
              <div class="ex-en">${esc(it.example.en)}</div>
              ${it.example.translit?`<div class="ex-tr">${esc(it.example.translit)}</div>`:''}
              ${it.example.ar?`<div class="ex-ar arabic">${esc(it.example.ar)}</div>`:''}
            </div>`:''}
            ${usageHtml(it.usage)}`;
    ...
    learn_sentence(inner, act, ctx){
      ...
      const reveal = () => {
        ...
        if(r){
          r.innerHTML = `${s.translit?`<div class="pel-act-translit">${esc(s.translit)}</div>`:''}${s.ar?`<div class="pel-act-ar arabic">${esc(s.ar)}</div>`:''}`;
    ...
    recognize(inner, act, ctx){
      const it=act.item; const pool=act.pool.length>=3?act.pool:[...act.pool, ...PEL_STARTER_ITEMS];
      ...
      const _distr=shuffle(pool.filter(x=>x&&x.en&&norm(x.en)!==norm(it.en))).slice(0,3);
      const _seen=new Set(); const _dd=[]; for(const d of _distr){ const k=norm(d.en); if(!_seen.has(k)){ _seen.add(k); _dd.push(d); } }
      ...
      inner.innerHTML = `<div class="pel-act-prompt">${prompt}</div>
        <div class="pel-options" id="pelRecOpts">${opts.map((o,i)=>`<button class="pel-option" data-i="${i}" data-choice-key="${esc(o.en)}"><span class="o-en arabic">${esc(o.ar)}</span></button>`).join('')}</div>`;
    ...
    fill_blank(inner, act, ctx){
      const it=act.item; const s=act.sentence||it.sentences[0]||{en:(it.example&&it.example.en)||it.en};
      ...
      inner.innerHTML = `<div class="pel-act-prompt">${L('Complete the sentence','كمل الجملة')}</div>
        ...
        <div class="pel-options" style="margin-top:18px;">${distractors.map((o,i)=>`<button class="pel-option" data-i="${i}" data-choice-key="${esc(o)}"><span class="o-en">${esc(o)}</span></button>`).join('')}</div>`;
    ...
    spell(inner, act, ctx){
      const it=act.item;
      // Transliteration is a near-answer leak, so hide it behind an optional
      // hint reveal (like arrange_words already does).
      inner.innerHTML = `<div class="pel-act-prompt">${L('Spell the English for','املك الانجليزي لـ')}:</div>
        ...
        <input class="pel-input" id="pelSpellIn" style="margin-top:16px;" placeholder="${Lt('Type the word...','اكتب الكلمة...')}" autocomplete="off" autocapitalize="off" />
        <button class="btn-outline" id="pelSpellHint" style="margin-top:10px;width:100%;">${L('Show hint','اعرض تلميح')}</button>
        <div id="pelSpellHintRev" class="pel-reveal" style="opacity:0;max-height:0;overflow:hidden;transition:opacity .4s,max-height .4s;"></div>`;
      const inp=$('#pelSpellIn'); setTimeout(()=>inp.focus(),50);
      inp.addEventListener('keydown',e=>{ if(e.key==='Enter'){ e.preventDefault(); ctx.btn.click(); } });
      const hb=$('#pelSpellHint'); const hr=$('#pelSpellHintRev');
      if(hb) hb.onclick=()=>{ if(hr){ hr.innerHTML=`<div class="pel-act-translit">${esc(it.translit)}</div>`; hr.classList.add('show'); hb.style.display='none'; } };
    ...
    translate(inner, act, ctx){
      ...
      inner.innerHTML = `<div class="pel-act-prompt">${L('Translate to English','ترجم للانجليزي')}:</div>
        ...
        <input class="pel-input" id="pelTrIn" style="margin-top:16px;" placeholder="${Lt('Type in English...','اكتب بالانجليزي...')}" autocomplete="off" autocapitalize="off" />`;
    ...
    listen(inner, act, ctx){
      ...
      $('#pelLsnPlay').onclick=()=>{ played=true; play(it.example.en||it.en,'en-US'); ctx.btn.disabled=false; };
      ctx.btn.disabled=true;
    ...
    identify_heard(inner, act, ctx){
      ...
      const _distr=shuffle(pool.filter(x=>x&&x.en&&norm(x.en)!==norm(it.en))).slice(0,3);
      const _seen=new Set(); const _dd=[]; for(const d of _distr){ const k=norm(d.en); if(!_seen.has(k)){ _seen.add(k); _dd.push(d); } }
      const opts=shuffle([it, ..._dd]).slice(0,4); let sel=null;
      inner.innerHTML = `<div class="pel-act-prompt">${L('What did you hear?','وش سمعت؟')}</div>
        ...
        <div class="pel-options" id="pelIdOpts" style="margin-top:16px;">${opts.map((o,i)=>`<button class="pel-option" data-i="${i}" data-choice-key="${esc(o.en)}"><span class="o-en">${esc(o.en)}</span></button>`).join('')}</div>`;
    ...
    conversation_response(inner, act, ctx){
      ...
      const distractors=shuffle(conv.filter((c,j)=>j!==i && j!==i+1).map(c=>c.en).filter(e=>e&&norm(e)!==norm(reply.en))).slice(0,2);
    ...
    grammar_correction(inner, act, ctx){
      ...
      inner.innerHTML = `<div class="pel-act-prompt">${L('Fix the mistake','صحح الخطا')}</div>
        ...
        <input class="pel-input" id="pelGrIn" style="margin-top:16px;" placeholder="${Lt('Type the correct sentence...','اكتب الجملة الصحيحة...')}" autocomplete="off" autocapitalize="off" />
    ...
    choose_natural_expression(inner, act, ctx){
      const q=act.quiz[0]; const opts=(q.options||[]);
      ...
      inner.innerHTML = `<div class="pel-act-prompt">${L('Choose the natural one','اختر الطبيعي')}</div>
        ...
        <div class="pel-options">${opts.map((o,i)=>`<button class="pel-option" data-i="${i}" data-choice-key="${esc(optText(o))}"><span class="o-en">${esc(optText(o))}</span></button>`).join('')}</div>`;
      const btns=inner.querySelectorAll('.pel-option');
      btns.forEach(b=>b.onclick=()=>{ btns.forEach(x=>x.classList.remove('selected')); b.classList.add('selected'); sel=+b.dataset.i; });
      ctx.btn.disabled=true;
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{ var _selBtn=inner.querySelector('.pel-option.selected'); sel=_selBtn?[...btns].indexOf(_selBtn):-1; const correct=sel===correctIdx; btns.forEach((b,i)=>{ if(i===correctIdx){ b.classList.add('correct'); const sub=optSub(opts[i]); if(sub) b.insertAdjacentHTML('beforeend', `<span class="o-ar arabic">${esc(sub)}</span>`); } else if(i===sel) b.classList.add('wrong'); }); ctx.self.mark(ctx,correct); });
    },
    listening_dictation(inner, act, ctx){
      // LISTENING DICTATION — hear the sentence, type what you heard.
      // Real production from audio; scored by word similarity so small
      // spelling slips do not fail an otherwise-correct transcription.
      const s = act.sentence || {};
      inner.innerHTML = `
        <div class="pel-act-prompt">${L('Type what you hear','اكتب اللي تسمعه')}</div>
        ...
        <input class="pel-input" id="pelDicIn" style="margin-top:16px;" placeholder="${Lt('Type the sentence you heard...','اكتب الجملة اللي سمعتها...')}" autocomplete="off" autocapitalize="off" />
        <div id="pelDicRev" class="pel-reveal" style="opacity:0;max-height:0;overflow:hidden;transition:opacity .4s,max-height .4s;"></div>`;
      let plays = 0;
      $('#pelDicPlay').onclick = ()=>{ plays++; play(s.en,'en-US'); };
      const inp=$('#pelDicIn'); setTimeout(()=>inp.focus(),50);
      inp.addEventListener('keydown',e=>{ if(e.key==='Enter'){ e.preventDefault(); ctx.btn.click(); } });
      ctx.btn.disabled=true;
      inp.addEventListener('input',()=>{ ctx.btn.disabled = !inp.value.trim(); });
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        const sim = similarity(norm(inp.value), norm(s.en));
        const ok = sim >= 0.75;
        const r = inner.querySelector('#pelDicRev');
        if(r){
          r.innerHTML = `<div class="pel-act-hint">${L('You wrote','كتبت')}: ${esc(inp.value||'—')}</div>
            <div class="pel-act-hint">${L('Correct sentence','الجملة الصحيحة')}: <b>${esc(s.en)}</b></div>
            ${(!ok && s.ar)?`<div class="pel-act-hint arabic">${esc(s.ar)}</div>`:''}`;
          r.classList.add('show');
        }
        ctx.self.mark(ctx, ok);
      });
      // ready() re-enables the Check button — gate it again until the
      // student has typed something (input listener re-enables it).
      ctx.btn.disabled = !inp.value.trim();
      // auto-play once on entry so the student hears the task
      setTimeout(()=>{ if(plays===0 && s.en) play(s.en,'en-US'); }, 350);
    },
    guided_production(inner, act, ctx){
      ...
      const bank = shuffle([key, ...shuffle(vocabPool).slice(0,2)]);
      let sel=null;
      inner.innerHTML = `
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        ...
        fb.innerHTML = `<div class="pel-act-en">${esc(s.en||key)}</div>${s.translit?`<div class="pel-act-translit">${esc(s.translit)}</div>`:''}`;
    ...
    free_response(inner, act, ctx){
      const it=act.item;
      // Production from meaning: show the Arabic + the target word to use,
      // HIDE the English model so the student must produce it themselves.
      // Reveal the model only after they write, for self-comparison.
      let revealed = false;
      const prompt = ar() ? `اكتب جملة بالانجليزي تستخدم كلمة <b>${esc(it.en)}</b>` : `Write a sentence in English using <b>${esc(it.en)}</b>`;
      inner.innerHTML = `<div class="pel-act-prompt">${prompt}</div>
        <div class="pel-act-ar arabic" style="font-size:1.4rem;">${esc(it.ar)}</div>
        ${it.translit?`<div class="pel-act-hint arabic">${esc(it.translit)}</div>`:''}
        <textarea class="pel-input" id="pelFrIn" style="margin-top:16px;min-height:90px;" placeholder="${Lt('Write your own sentence...','اكتب جملتك...')}" autocomplete="off" autocapitalize="off"></textarea>
        <button class="btn-outline" id="pelFrReview" style="margin-top:10px;width:100%;">${L('Review my writing','راجع كتابتي')}</button>
      ...
      if(reviewBtn) reviewBtn.onclick = function(){
        ...
        if(v.length < 3){ if(typeof toast==='function') toast(L('Write a sentence first.','اكتب جملة اولا')); return; }
        if(window.pelReviewWriting) window.pelReviewWriting(v, document.getElementById('pelFrFb'));
      };
      const revealModel = () => {
        if(revealed) return; revealed = true;
      ...
      ctx.self.ready(ctx, L('Done','تم'), ()=>{
        const v = inp.value.trim();
        // Meaningful check: must actually use the target word and write a
        // real sentence (3+ words), not just tap through with 3 characters.
        const usesTarget = norm(v).indexOf(norm(it.en)) !== -1;
        const wordCount = v.split(/\s+/).filter(Boolean).length;
        const ok = usesTarget && wordCount >= 3;
        revealModel();
        ctx.self.mark(ctx, ok);
      });
    },
    ...
    challenge(inner, act, ctx){
      ...
      const opts=shuffle([it,...shuffle(pool.filter(x=>x&&x.en&&norm(x.en)!==norm(it.en))).slice(0,3)]).slice(0,4); let sel=null;
      const prompt = ar() ? `<span class="arabic">سوال سريع: وش معنى <b>${esc(it.en)}</b>؟</span>` : `Quick check: what does <b>${esc(it.en)}</b> mean?`;
      inner.innerHTML = `<div class="pel-act-prompt">${prompt}</div>
        <div class="pel-options">${opts.map((o,i)=>`<button class="pel-option" data-i="${i}" data-choice-key="${esc(o.en)}"><span class="o-en arabic">${esc(o.ar)}</span></button>`).join('')}</div>`;
      const btns=inner.querySelectorAll('.pel-option');
      btns.forEach(b=>b.onclick=()=>{ btns.forEach(x=>x.classList.remove('selected')); b.classList.add('selected'); sel=+b.dataset.i; });
      ctx.btn.disabled=true;
    ...
    concept(inner, act, ctx){
      // SEE IT / UNDERSTAND IT — a rule explanation from the DB (explain/pattern
      // items). Previously these were mapped to lesson.dbNotes but never
      // rendered, so the rule was silently dropped. Now shown before practice.
      const n = act.note || {};
      const en = n.en || n.note_en || '';
      const arText = n.ar || '';
      const tr = n.tr || '';
      inner.innerHTML = `
        <div class="pel-act-prompt">${L('Read and understand','اقرأ وفهم')}</div>
        <div class="pel-act-en" style="font-size:1.12rem;line-height:1.7;">${esc(en)}</div>
        ${tr?`<div class="pel-act-translit">${esc(tr)}</div>`:''}
        ${arText?`<div class="pel-act-ar arabic" style="font-size:1.05rem;line-height:1.8;">${esc(arText)}</div>`:''}
        <button class="pel-act-play" id="pelCncPlay" style="margin-top:14px;"><i data-lucide="volume-2" width="16" height="16"></i> ${L('Hear it','اسمعها')}</button>`;
      ...
      const renderOne = () => {
        ...
        const reveal = () => {
          ...
          if(r){
            ...
            if(s.ar) html += '<div class="pel-act-ar arabic">'+esc(s.ar)+'</div>';
            r.innerHTML = html;
            r.classList.add('show');
          }
        ...
        inner.innerHTML = `
          ...
          <div style="margin-top:14px;">
            <button class="btn-outline" id="pelCexShow" style="width:100%;">${L('Show meaning','اعرض المعنى')}</button>
          </div>`;
        const playBtn = $('#pelCexPlay'); if(playBtn) playBtn.onclick = ()=>play(s.en,'en-US');
        const showBtn = $('#pelCexShow'); if(showBtn) showBtn.onclick = ()=>reveal();
    ...
    db_order(inner, act, ctx){
      ...
      let placed = [];
      inner.innerHTML = `<div class="pel-act-prompt">${L('Build the sentence','رتب الجملة')}</div>
        ${p.prompt&&p.prompt.en?`<div style="font-size:.95rem;margin-bottom:6px;">${esc(p.prompt.en)}</div>`:''}
      ...
      tk.querySelectorAll('.pel-token').forEach(b=>b.onclick=()=>{ b.remove(); placed.push(tokens[+b.dataset.i]); renderDrop(); });
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        const ansStr = Array.isArray(p.answer) ? p.answer.join(' ') : (p.answer||'');
    ...
    db_spell(inner, act, ctx){
      // Authored 'spell' exercise. Translit hidden behind a hint reveal.
      const ex = act.ex; const p = (ex && ex.payload) || {};
      const display = p.display || p.answer || '';
      inner.innerHTML = `<div class="pel-act-prompt">${L('Spell it','املكها')}</div>
        <div style="font-size:1.15rem;font-family:'Fraunces',serif;letter-spacing:.35em;">${esc(display)}</div>
        ${p.meaning?`<div class="pel-act-ar arabic" style="font-size:1.1rem;">${esc(p.meaning)}</div>`:''}
        <input class="pel-input" id="pelDbsIn" style="margin-top:16px;" placeholder="${Lt('Type the word...','اكتب الكلمة...')}" autocomplete="off" autocapitalize="off" />
      ...
      const inp=$('#pelDbsIn'); setTimeout(()=>inp.focus(),50);
      inp.addEventListener('keydown',e=>{ if(e.key==='Enter'){ e.preventDefault(); ctx.btn.click(); } });
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        const accepted=[p.answer].concat(Array.isArray(p.accept)?p.accept:[]).map(norm);
        ctx.self.mark(ctx, accepted.indexOf(norm(inp.value))!==-1);
      });
    },
    db_translate(inner, act, ctx){
      // Authored 'translate' exercise. Hint reveals only the source translit,
      // never the answer.
      const ex = act.ex; const p = (ex && ex.payload) || {};
      const srcIsEn = p.dir !== 'ar2en';
      inner.innerHTML = `<div class="pel-act-prompt">${srcIsEn?L('Say it in Arabic','قلها بالعربي'):L('Say it in English','قلها بالانجليزي')}</div>
        <div class="${srcIsEn?'':'arabic'}" style="font-size:1.1rem;">${esc(p.source||'')}</div>
        <input class="pel-input" id="pelDbtIn" style="margin-top:16px;" placeholder="${srcIsEn?Lt('Type in Arabic...','اكتب بالعربي...'):Lt('Type in English...','اكتب بالانجليزي...')}" autocomplete="off" autocapitalize="off" />
      ...
      const inp=$('#pelDbtIn'); setTimeout(()=>inp.focus(),50);
      inp.addEventListener('keydown',e=>{ if(e.key==='Enter'){ e.preventDefault(); ctx.btn.click(); } });
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        ...
        ctx.self.mark(ctx, accepted.indexOf(normAny(inp.value))!==-1);
      });
    },
    db_correct(inner, act, ctx){
      ...
      let sel=null;
      inner.innerHTML = `<div class="pel-act-prompt">${L('Pick the correct one','اختر الصح')}</div>
        <div style="font-size:.84rem;color:var(--text-muted);margin-bottom:12px;">${esc(ex.hint_en||'')} ${ex.hint_ar?`<span class="arabic">${esc(ex.hint_ar)}</span>`:''}</div>
        <div class="pel-options">
          <button class="pel-option" data-ok="0" data-choice-key="${esc(wrong)}">${esc(wrong)}</button>
          <button class="pel-option" data-ok="1" data-choice-key="${esc(right)}">${esc(right)}</button>
        </div>`;
      const btns=inner.querySelectorAll('.pel-option');
  ...
  const TYPE_LABELS_DEF = {
    ...
    listening_dictation:['Dictation','إملاء'], guided_production:['Build it','ركّبها'],
    concept:['Concept','قاعدة'], concept_examples:['Examples','أمثلة'], db_order:['Build','رتب'], db_spell:['Spell','تهجى'],
  ...
  const PROMPTS_DEF = {
    ...
    concept:['Read the rule','اقرأ القاعدة'], concept_examples:['See examples','شاهد الأمثلة'], db_order:['Tap words in order','اضغط الكلمات بالترتيب'],
    db_spell:['Type the word','اكتب الكلمة'], db_translate:['Type the answer','اكتب الجواب'], db_correct:['Pick the correct one','اختر الصح'],
  };
