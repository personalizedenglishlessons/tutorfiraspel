...
@media(max-width:680px){
  ...
  function buildSequence(lesson, lessonId){
    ...
    seq.push({ type:'fill_blank', item:fbItem, sentence:(fbItem.sentences[1]||fbItem.sentences[0]||(fbItem.example&&fbItem.example.en?fbItem.example:{en:fbItem.en,ar:fbItem.ar,translit:fbItem.translit})), skill:'grammar' });
