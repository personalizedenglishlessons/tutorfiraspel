  ...
  const PEL_BEGINNER = {
    ...
    'days-and-months': {
      ...
      items: [
        ...
        },
        {
          ...
          usage: { en: 'Seven days, from Sunday to Saturday.', ar: 'سبعه ايام، من الاحد للسبت.' },
          sentences: [
    ...
    'shopping-and-money': {
      ...
      dialogue: [
        ...
        { who: 'B', en: 'OK, eight.', ar: 'تمام، لسهينانيه.', translit: 'اوكي، ايت.' },
      ],
    },
    'daily-routine': {
      ...
      items: [
        ...
        },
        {
          ...
          sentences: [
            ...
            { en: 'These shoes are old.', ar: 'هذي الجزم قديمه.', translit: 'ذيس شوز ار اولد.' },
    ...
    'at-the-hotel': {
      ...
      items: [
        ...
        { en: 'room key', ar: 'مفتاح الغرفه', translit: 'روم كي', pos: 'phrase', ipa: '/ruːm kiː/',
      ...
      dialogue: [
        ...
        { who: 'B', en: 'Here is your room key. Enjoy your stay.', ar: 'ذا مفتاح غرفتك. نورت.', translit: 'هير از يور روم كي. انجوي يور ستاي.' },
      ],
    },
    'at-the-pharmacy': {
    ...
    'at-the-bank': {
      ...
      dialogue: [
        ...
        { who: 'B', en: 'Please sign here. Done.', ar: 'وقّع هنا. تم.', translit: 'بليز سوين هير. دون.' },
      ],
    },
    'phone-calls': {
      ...
      items: [
        ...
        { en: 'leave a message', ar: 'ترك رساله', translit: 'ليف ا مسيج', pos: 'phrase', ipa: '/liːv ə ˈmɛsɪdʒ/',
          example: { en: 'Can I leave a message?', ar: 'اقدر اترك رساله؟', translit: 'كان اي ليف ا مسيج؟' },
          usage: { en: 'Ask to leave words for someone who is busy.', ar: 'تطلب تترك كلام لشخص مشغول.' },
          sentences: [
            { en: 'Can I leave a message?', ar: 'اقدر اترك رساله؟', translit: 'كان اي ليف ا مسيج؟' },
      ...
      dialogue: [
        ...
        { who: 'B', en: 'He is busy. Can I leave a message?', ar: 'مشغول. اقدر اترك رساله؟', translit: 'ه ايز بيزي. كان اي ليف ا مسيج؟' },
...
@media(max-width:680px){
  ...
  const PEL_MIN_PAIRS = [
    ...
    { contrast:'th vs s', target:'think', confusion:'sink', ar:'افكر', tipAr:'TH يطلع من بين الاسنان، S من خلف الاسنان. حط لسانك بين اسنانك.' },
    { contrast:'th vs s', target:'thank', confusion:'sank', ar:'شكرا', tipAr:'نفس الفكره، اللسان يطلع برا بين الاسنان.' },
    { contrast:'th vs z', target:'this', confusion:'zis', ar:'ذا', tipAr:'TH الصوت الثاني (ذ) يطلع من بين الاسنان، Z من خلفها.' },
  ...
  const PEL_WRITING_PROMPTS = [
    ...
    { ar:'رتب: كيفك؟', en:'How are you?', answer:'How are you?', hint:'Question mark in English is ?', keywords:['how are you','كيفك','greeting','تحيه'] },
      ...
      turns:[
        ...
        },
        {
          ...
          options:[
            ...
            { text:'I want Tuesday not Thursday I dont like Thursday.', ok:false, whyAr:'جمله طويله بدون نقطه. قسمها: Tuesday, please. اسهل واوضح.', outcomeAr:'الموظفه: "So... Tuesday then?"' },
        ...
        },
        {
          ...
          options:[
            ...
            { text:'Bye.', ok:false, whyAr:'صح بس مو مهذب. زي رد بسرعه بدون شكر. قل: Thank you, goodbye.', outcomeAr:'الموظفه: "...Goodbye."' },
      ...
      turns:[
        {
          ...
          options:[
            ...
            { text:'Coffee.', ok:false, whyAr:'كلمه وحده بدون فعل. قل: I want a coffee, please. اوضح واكثر مهذب.', outcomeAr:'الباريستا: "Sorry, one coffee?"' },
      ...
      turns:[
        ...
        },
        {
          ...
          options:[
            ...
            { text:'Bye.', ok:false, whyAr:'Bye بدون شكر. قل: Thank you. اظهر شكرك دايما.', outcomeAr:'الشخص: "...Bye."' },
  ...
  var PRON_HINTS = {
    ...
    'people': { beats:2, ar:'قول كذا: پي-پل - ركز على P في البدايه', avoid:'مو كذا لانه غلط: بيبل' },
    ...
    'problem': { beats:2, ar:'قول كذا: پرا-بلم - P في البدايه', avoid:'مو كذا لانه غلط: بروبلم' },
    ...
    'tired': { beats:1, ar:'قول كذا: تايرد - قلها بسرعه بدون ما توقف بين الحروف', avoid:'مو كذا لانه غلط: تاي-رِد' },
    ...
    'parking': { beats:2, ar:'قول كذا: پار-كينق - P في البدايه', avoid:'مو كذا لانه غلط: باركينق' },
  ...
  var PRON_PATTERNS = [
    ...
    { test:/^(sp|st|sk|sm|sn)\w/i, hint:{ beats:1, ar:'ابدا بحرف S مع الحرف اللي لسهه مباشره بدون ما تضيف صوت قبلها', avoid:'مو كذا لانه غلط: تضيف ا قبل الـ S' } },
    // ph → F
        ...
        if(!isTeachingAct && TEACH_BEFORE[act.type] && !act._taught){
          ...
          this.ready(ctx, L('Start practicing','ابدا التدريب'), ()=>{
            try{
              ...
              inner.innerHTML = '<div class="pel-act-prompt">' + L('We need to fix this activity','نحتاج نصلح ذا التمرين') + '</div><div class="pel-act-hint arabic">ذا التمرين ناقص بيانات، بننتقل للتمرين التالي.</div>';
  ...
  function connectionNoteFor(act){
    ...
    if(/\bwill\b/i.test(text) && !/\b(would|william)\b/i.test(text)){
      return 'will = راح (للمستقبل). نستخدمها لشي راح يصير بدون خطه. الترتيب: الشخص + will + كلمه فعل. مثال: I will call you = راح اتصل بك';
    }
    // 6. Can / can't - ability
    if(/\bcan('t|not)?\b/i.test(text)){
      return 'can = اقدر (للاستطاعه) · can\'t = ما اقدر. نستخدمها لما نقول انا نقدر اسوي شي او ما اقدر. الترتيب: الشخص + can/can\'t + كلمه فعل. مثال: I can swim = اقدر اسبح';
    }
    ...
    if(/\bhow\b/i.test(text) && !/\bhow\s+(much|many|old)\b/i.test(text)){
      return 'How = كيف. للسوال عن الطريقه او الحاله. الترتيب: How + كلمه مساعده + الشخص + ... مثال: How are you = كيفك';
    }
    // 12. Comparatives
    ...
    if(/\bso\s+do\s+i\b/i.test(text)){
      return 'So do I = وانا مثلن (موافقه). نستخدمها لما نوافق على كلام حد. مثال: A: I like coffee. B: So do I = وانا مثلن';
    }
    if(/\bneither\s+do\s+i\b/i.test(text)){
      return 'Neither do I = وانا لا (موافقه مع النفي). نستخدمها لما نوافق على كلام منفي. مثال: A: I don\'t like tea. B: Neither do I = وانا لا';
    }
    ...
    if(/^(go|turn|take|stop|wait|listen|look|open|close|come|sit|stand|bring|give|show|tell|put|let|keep|try|make|check|read|write|say)\b/i.test(text)){
      return 'صيغه الامر: كلمه الفعل بدون شخص قبلها. نعطي تعليمات مباشره. مثال: Go straight = امشي مستقيم، Turn left = لف يسار، Open the door = افتح الباب';
    }
  ...
  function grammarGlossary(act){
    ...
    if(lesson.grammar && lesson.grammar.rule){
      ...
      if(/imperative|command/.test(r)) add('imp', 'صيغه الامر', 'جمله تبدا بفعل مباشر بدون شخص. مثال: Go straight = امشي مستقيم');
  ...
  const RENDERERS = {
    ...
    spell(inner, act, ctx){
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        ...
        var fb = correct ? '' : L('Correct spelling: ','التهجيه الصحيحه: ')+esc(it.en);
    ...
    translate(inner, act, ctx){
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        ...
        var fb = correct ? '' : L('Correct: ','الصحيح: ')+esc(it.en);
        ctx.self.mark(ctx, correct, false, fb);
      });
      ctx.btn.disabled = true;
    },
      ...
      if(canRec){
        ...
        micBtn.onclick = () => {
          ...
          recordAndScore((heard, score, err)=>{
            ...
            if(err){
              fb.innerHTML = `<div class="pel-act-hint" style="color:var(--gold);">${typeof micErrorMessage==='function'?esc(micErrorMessage(err)):L('Mic error','خطا بالمايك')}</div><div class="pel-act-hint">${L('Try again, or tap Check to continue.','حاول ثانيه، او اضغط تحقق للمتابعه.')}</div>`;
              return;
            }
            ...
            let enc = '';
            if(sc != null){
              if(sc < 40) enc = `<div class="pel-act-hint arabic" style="color:var(--text-muted);">الغلط عادي، ذا كيف نتعلم. حاول مره ثانيه.</div>`;
    ...
    concept_examples(inner, act, ctx){
      ...
      const renderOne = () => {
        ...
        const reveal = () => {
          ...
          ctx.btn.innerHTML = idx < sentences.length-1 ? L('Next example','المثال التالي') : L('Continue','متابعه');
          ctx.btn.disabled = false;
        };
        inner.innerHTML = `
    ...
    db_order(inner, act, ctx){
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        ...
        var correct = built===target;
        var fb = correct ? '' : L('Correct: ','الصحيح: ')+esc(ansStr);
        ctx.self.mark(ctx, correct, false, fb);
      });
      ctx.btn.disabled = true;
    },
    db_spell(inner, act, ctx){
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        ...
        var fb = correct ? '' : L('Correct spelling: ','التهجيه الصحيحه: ')+esc(p.answer);
        ctx.self.mark(ctx, correct, false, fb);
      });
      ctx.btn.disabled = true;
    },
    db_translate(inner, act, ctx){
      ...
      if(hb) hb.onclick=()=>{ if(hr){
        ...
        if(p.source_tr){
          ...
          hintHTML = '<div class="pel-act-translit"><span class="arabic">رتب نفس المعنى. ابدا بكلمه الفعل، لسهين كمل بقيه الجمله.</span></div>';
        }
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        ...
        var correct = accepted.indexOf(built)!==-1;
        var fb = correct ? '' : L('Correct: ','الصحيح: ')+esc(p.answer);
        ctx.self.mark(ctx, correct, false, fb);
      });
      ctx.btn.disabled = true;
    },
    ...
    minimal_pairs(inner, act, ctx){
      ...
      const tipAr = pair.tipAr || ('الفرق صوت واحد. اسمع الكلمتين زين، لسهين قول الكلمه الصح.');
      inner.innerHTML = `
      ...
      ctx.self.ready(ctx, L('Check','تحقق'), ()=>{
        ...
        if(fb) fb.innerHTML = correct
          ...
          : `<div style="color:var(--gold);font-weight:700;">× ${L('Try again','حاول ثانيه')}</div>`
            + `<div class="pel-act-hint" dir="ltr">${esc(en)}</div>`
            + `<div class="pel-act-hint arabic">الغلط عادي، ذا كيف نتعلم.</div>`;
        ctx.self.mark(ctx, correct);
      });
      ctx.btn.disabled = true;
    },
  ...
  var TEACHING_CONTENT = {
    ...
    'an': {
      ...
      howToAvoid: 'a,e,i,o,u في البدايه = an',
      remember: 'an = قبل حرف العله'
    },
    ...
    'but': {
      ...
      howToAvoid: 'but = التعارض، and = الاضافه، so = النتيجه',
      remember: 'but = بس / لكن'
    },
    'because': {
      meaning: 'لان — للسبب',
  ...
  const PROMPTS_DEF = {
    ...
    grammar_correction:['Pick the correct sentence','اختر الجمله الصحيحه'], choose_natural_expression:['Pick the natural one','اختر الطبيعي'],
