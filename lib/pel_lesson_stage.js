  ...
  const PEL_BEGINNER = {
    ...
    'introducing-yourself': {
      ...
      items: [
        ...
        },
        {
          ...
          sentences: [
            ...
            { en: 'Nice to meet you too.', ar: 'فرحت بلقياك بعد.', translit: 'نايس تو ميت يو تو.' },
          ],
        },
        {
      ...
      dialogue: [
        ...
        { who: 'A', en: 'Nice to meet you too. I am from Jeddah.', ar: 'فرحت بلقياك بعد. انا من جده.', translit: 'نايس تو ميت يو تو. اي ام فرام جدّه.' },
    ...
    'family-members': {
      ...
      dialogue: [
        ...
        { who: 'B', en: 'Nice to meet you too.', ar: 'فرحت بلقياك بعد.', translit: 'نايس تو ميت يو تو.' },
      ],
    },
    'telling-time': {
    ...
    'shopping-and-money': {
      ...
      dialogue: [
        ...
        { who: 'B', en: 'OK, eight.', ar: 'تمام، بعدينانيه.', translit: 'اوكي، ايت.' },
      ],
    },
    'daily-routine': {
    ...
    'clothes': {
      ...
      dialogue: [
        ...
        { who: 'B', en: 'Yes, and my shoes are new too.', ar: 'ايه، وجزمي جديده بعد.', translit: 'يس، اند ماي شوز ار نيو تو.' },
      ...
      items: [
        ...
        { en: 'leave a message', ar: 'ترك رساله', translit: 'ليف ا مسيج', pos: 'phrase', ipa: '/liːv ə ˈmɛsɪdʒ/',
          ...
          sentences: [
            ...
            { en: 'Please leave a message after the beep.', ar: 'اترك رساله بعد الصفير.', translit: 'بليز ليف ا مسيج افتر ذا بيب.' },
          ],
        },
...
@media(max-width:680px){
    ...
    },
    {
      ...
      turns:[
        ...
        },
        {
          ...
          options:[
            { text:'Thank you! You too.', ok:true, whyAr:'ممتاز! شكرت وردت على الدعوه. طريقه مهذبه مره.', outcomeAr:'تم استلام القهوه. احسنت!' },
  ...
  var PRON_PATTERNS = [
    ...
    { test:/^(sp|st|sk|sm|sn)\w/i, hint:{ beats:1, ar:'ابدا بحرف S مع الحرف اللي بعده مباشره بدون ما تضيف صوت قبلها', avoid:'مو كذا لانه غلط: تضيف ا قبل الـ S' } },
    // ph → F
  ...
  function connectionNoteFor(act){
    ...
    if(/\b(a|an|the)\s+(big|small|red|blue|green|white|black|new|old|good|nice|beautiful|happy|sad|tired|hungry|good|great|long|short|tall|young|old|rich|poor|strong|weak|fast|slow|clean|dirty|empty|full|open|close|hot|cold|warm|cool|dry|wet|hard|soft|heavy|light|sharp|dull|smooth|rough|flat|round|square|deep|shallow|wide|narrow|thick|thin|bright|dark)\s+\w+/i.test(text)){
      return 'بالعربي الصفه تجي بعد الاسم: سياره حمرا. بالحينجليزي الصفه تجي قبل الاسم: a red car. الترتيب: a/an/the + كلمه وصف + الاسم. مثال: a big house = بيت كبير، the new car = السياره الجديده';
    }
    ...
    if(/\b(always|usually|sometimes|never|often|rarely|seldom)\b/i.test(text)){
      return 'كلمات التكرار (always, usually, never) تجي قبل الفعل الاساسي: I always go. بس بعد is/are/am: She is always late. مثال: I never drink coffee = ما اشرب قهوه ابدا، He is always happy = هو دايماً مبسوط';
    }
    return '';
  }
