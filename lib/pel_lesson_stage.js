...
@media(max-width:680px){
  ...
  var PRON_HINTS = {
    ...
    'print': { beats:1, ar:'قول كذا: برنت - P مو B', avoid:'مو كذا لانه غلط: برنت بـ B' },
    ...
    'paper': { beats:2, ar:'قول كذا: پي-پر - P مرتين', avoid:'مو كذا لانه غلط: بي-بر' },
  ...
  var TEACHING_CONTENT = {
    ...
    'not': {
      ...
      commonMistake: 'وضع not في المكان الخطا',
    ...
    'have': {
      meaning: 'عندي / عندي — مع I/we/you/they',
