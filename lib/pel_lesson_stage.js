...
(function () {
  ...
  const PEL_BEGINNER = {
    'greetings-goodbye': {
      ...
      items: [
        ...
        },
        {
          ...
          usage: { en: 'A friendly check-in. Reply with "I am fine, thank you."', ar: 'سؤال ودّي. جاوب بـ "تمام، شكراً".' },
          sentences: [
    ...
    'doctor-appointment': {
      ...
      items: [
        ...
        },
        {
          ...
          usage: { en: 'Free, not busy. Use it to ask about times.', ar: 'فاضي، مو مشغول. استخدمها تسأل عن الاوقات.' },
          sentences: [
      ...
      items: [
        {
          ...
          ipa: '/red/',
          example: { en: 'The car is red.', ar: 'السيارة حمراء.', translit: 'ذا كار ايز رد.' },
          usage: { en: 'A common color. Also used for the traffic light that means stop.', ar: 'لون شائع. كمان يستخدم للاشارة اللي تعني قف.' },
          sentences: [
        ...
        },
        {
          ...
          ipa: '/bluː/',
          example: { en: 'The sky is blue.', ar: 'السماء زرقاء.', translit: 'ذا سكاي ايز بلو.' },
          usage: { en: 'The color of the sky and the sea.', ar: 'لون السماء والبحر.' },
          sentences: [
        ...
        },
        {
          ...
          usage: { en: 'The color of plants and the go light.', ar: 'لون النباتات والاشارة الخضراء.' },
          sentences: [
            { en: 'Green.', ar: 'اخضر.', translit: 'غرين.' },
            { en: 'Green light.', ar: 'اشارة خضراء.', translit: 'غرين لايت.' },
    ...
    'telling-time': {
      ...
      items: [
        ...
        {
          en: 'late', ar: 'متأخر', translit: 'ليت', pos: 'adjective',
          ipa: '/leɪt/',
          example: { en: 'I am late.', ar: 'تأخرت.', translit: 'اي ام ليت.' },
          usage: { en: 'After the agreed time. The opposite is early.', ar: 'بعد الوقت المتفق عليه. العكس مبكر.' },
          sentences: [
            { en: 'I am late.', ar: 'تأخرت.', translit: 'اي ام ليت.' },
            { en: 'Are you late?', ar: 'متأخر؟', translit: 'ار يو ليت؟' },
            { en: 'Sorry, I am late.', ar: 'المعذرة، تأخرت.', translit: 'سوري، اي ام ليت.' },
          ],
        },
      ],
      dialogue: [
        ...
        { who: 'A', en: 'I am late!', ar: 'تأخرت!', translit: 'اي ام ليت!' },
    ...
    'food-and-drinks': {
      ...
      items: [
        ...
        },
        {
          ...
          usage: { en: 'A hot drink, very common in Saudi Arabia.', ar: 'مشروب حار، شائع بالسعودية.' },
          sentences: [
      ...
      items: [
        ...
        },
        {
          ...
          sentences: [
            ...
            { en: 'Ask the teacher.', ar: 'اسأل المعلم.', translit: 'اسك ذا تيتشر.' },
          ],
        },
      ],
      dialogue: [
      ...
      items: [
        {
          ...
          usage: { en: 'Ask this to know the price.', ar: 'اسأل بها عشان تعرف السعر.' },
          sentences: [
    ...
    'subject-pronouns': {
      title: { en: 'Subject Pronouns', ar: 'ضمائر الفاعل' },
      items: [
        {
    ...
    'this-and-that': {
      ...
      items: [
        ...
        },
        {
          ...
          usage: { en: 'Plural of this, for close things.', ar: 'جمع هذا، لاشياء قريبة.' },
          sentences: [
      ...
      items: [
        {
          ...
          usage: { en: 'Used before a word starting with a consonant sound.', ar: 'تستخدمها قبل كلمة تبدأ بصوت ساكن.' },
          sentences: [
        ...
        },
        {
          ...
          usage: { en: 'Used before a word starting with a vowel sound.', ar: 'تستخدمها قبل كلمة تبدأ بصوت متحرك.' },
          sentences: [
    ...
    'common-verbs': {
      title: { en: 'Common Verbs', ar: 'افعال شائعة' },
      items: [
        {
    ...
    'places-in-town': {
      ...
      items: [
        ...
        },
        {
          ...
          usage: { en: 'Where you buy things.', ar: 'مكان تشتري فيه الاشياء.' },
          sentences: [
    ...
    'transport': {
      ...
      dialogue: [
        ...
        { who: 'B', en: 'The bus is slow but cheap.', ar: 'الباص بطيء بس رخيص.', translit: 'ذا باص ايز سلو بات تشيب.' },
      ],
    },
    'home-and-rooms': {
    ...
    'clothes': {
      ...
      items: [
        ...
        {
          en: 'shoes', ar: 'حذاء', translit: 'شوز', pos: 'clothing',
          ipa: '/ʃuːz/',
          example: { en: 'My shoes are black.', ar: 'حذائي اسود.', translit: 'ماي شوز ار بلاك.' },
          usage: { en: 'You wear them on your feet.', ar: 'تلبسها برجليك.' },
          sentences: [
            { en: 'I need new shoes.', ar: 'محتاج حذاء جديد.', translit: 'اي نيد نيو شوز.' },
            { en: 'These shoes are old.', ar: 'هذا الحذاء قديم.', translit: 'ذيس شوز ار اولد.' },
            { en: 'Where are my shoes?', ar: 'وين حذائي؟', translit: 'وير ار ماي شوز؟' },
          ],
        },
        {
      ...
      dialogue: [
        ...
        { who: 'B', en: 'Yes, and my shoes are new too.', ar: 'ايه، وحذائي جديد بعد.', translit: 'يس، اند ماي شوز ار نيو تو.' },
    ...
    'body-parts': {
      ...
      items: [
        ...
        },
        {
          ...
          usage: { en: 'You use it to hold things.', ar: 'تستخدمها تمسك الاشياء.' },
          sentences: [
    ...
    'hobbies-likes': {
      ...
      items: [
        {
          en: 'read', ar: 'اقرأ', translit: 'ريد', pos: 'verb',
          ipa: '/riːd/',
          example: { en: 'I read books.', ar: 'اقرأ كتب.', translit: 'اي ريد بوكس.' },
          usage: { en: 'To look at words and understand them.', ar: 'تنظر للكلمات وتفهمها.' },
          sentences: [
            { en: 'I read at night.', ar: 'اقرأ بالليل.', translit: 'اي ريد ات نايت.' },
            { en: 'Do you read?', ar: 'تقرأ؟', translit: 'دو يو ريد؟' },
            { en: 'I like to read.', ar: 'احب اقرأ.', translit: 'اي لايك تو ريد.' },
          ],
        },
        {
      ...
      dialogue: [
        ...
        { who: 'B', en: 'I like to read books. And you?', ar: 'احب اقرأ كتب. وانت؟', translit: 'اي لايك تو ريد بوكس. اند يو؟' },
      ...
      items: [
        {
          ...
          usage: { en: 'The list of food and prices. Ask for it when you sit down.', ar: 'قائمة الاكل والاسعار. اطلبها اول ما تقعد.' },
          sentences: [
    ...
    'at-the-airport': {
      ...
      items: [
        ...
        },
        {
          ...
          usage: { en: 'Your bags and suitcases. Saudis say شنط for bags.', ar: 'حقائبك. السعوديين يقولون شنط.' },
          sentences: [
      ...
      items: [
        {
          ...
          usage: { en: 'High temperature. Very common in Saudi summer.', ar: 'حرارته عالية. شائع بصيف السعودية.' },
          sentences: [
      ...
      items: [
        {
          ...
          usage: { en: 'A warm southern way to ask how someone is.', ar: 'طريقة جنوبية دافئة تسأل فيها عن حال الشخص.' },
          sentences: [
    ...
    'at-the-hotel': {
      ...
      items: [
        { en: 'reservation', ar: 'حجز', translit: 'ريزيرفيشن', pos: 'noun', ipa: '/ˌrezərˈveɪʃən/',
          ...
          usage: { en: 'Say this at the front desk to confirm your booking.', ar: 'قولها في الاستقبال عشان تأكد حجزك.' },
          sentences: [
        ...
        { en: 'check in', ar: 'تسجيل دخول', translit: 'تشيك إن', pos: 'phrase', ipa: '/tʃɛk ɪn/',
          example: { en: 'I would like to check in.', ar: 'ابغى اسجل دخول.', translit: 'اي وود لايك تو تشيك إن.' },
          usage: { en: 'Used when you arrive to get your room.', ar: 'تقولها اول ما توصل عشان تستلم غرفتك.' },
          sentences: [
            { en: 'I would like to check in.', ar: 'ابغى اسجل دخول.', translit: 'اي وود لايك تو تشيك إن.' },
            { en: 'Can I check in now?', ar: 'اقدر اسجل دخول الحين؟', translit: 'كان اي تشيك إن ناو؟' },
            { en: 'Check in is at two.', ar: 'التسجيل الساعة اثنين.', translit: 'تشيك إن ايز ات تو.' },
          ],
        },
      ...
      dialogue: [
        { who: 'A', en: 'Good evening. I have a reservation.', ar: 'مساء الخير. عندي حجز.', translit: 'غود ايفنينق. اي هاف ا ريزيرفيشن.' },
    ...
    'at-the-pharmacy': {
      ...
      items: [
        { en: 'headache', ar: 'صداع', translit: 'هيدايك', pos: 'noun', ipa: '/ˈhɛdˌeɪk/',
          ...
          sentences: [
            ...
            { en: 'My headache started today.', ar: 'الصداع بدأ اليوم.', translit: 'ماي هيدايك ستارتد توداي.' },
          ],
        },
        { en: 'medicine', ar: 'دواء', translit: 'ميديسن', pos: 'noun', ipa: '/ˈmɛdɪsən/',
          example: { en: 'I need medicine for a cold.', ar: 'ابغى دواء للزكام.', translit: 'اي نيد ميديسن فور ا كولد.' },
          usage: { en: 'Something you take to feel better.', ar: 'شي ياخذه المريض عشان يتحسن.' },
          sentences: [
            { en: 'I need medicine.', ar: 'ابغى دواء.', translit: 'اي نيد ميديسن.' },
            { en: 'Do you have medicine for a fever?', ar: 'عندك دواء للحرارة؟', translit: 'دو يو هاف ميديسن فور ا فيفر؟' },
            { en: 'Take this medicine twice a day.', ar: 'خذ هذا الدواء مرتين باليوم.', translit: 'تيك ذس ميديسن تويس ا داي.' },
          ],
        },
        { en: 'prescription', ar: 'وصفة', translit: 'بريسكريبشن', pos: 'noun', ipa: '/prɪˈskrɪpʃən/',
          ...
          usage: { en: 'A paper from the doctor that lets you get medicine.', ar: 'ورقة من الطبيب تقدر تجيب منها الدواء.' },
          sentences: [
      ...
      dialogue: [
        ...
        { who: 'B', en: 'Take this medicine twice a day.', ar: 'خذ هذا الدواء مرتين باليوم.', translit: 'تيك ذس ميديسن تويس ا داي.' },
      ],
    },
    'at-the-bank': {
      title: { en: 'At the Bank', ar: 'في البنك' },
      items: [
        { en: 'deposit', ar: 'إيداع', translit: 'ديبوزيت', pos: 'noun', ipa: '/dɪˈpɒzɪt/',
      ...
      dialogue: [
        ...
        { who: 'A', en: 'One thousand riyals.', ar: 'ألف ريال.', translit: 'وان ثاوزند ريالز.' },
    ...
    'phone-calls': {
      ...
      items: [
        ...
        { en: 'the line is bad', ar: 'الإشارة ضعيفة', translit: 'ذا لاين ايز باد', pos: 'phrase', ipa: '/ðə laɪn ɪz bæd/',
          example: { en: 'Sorry, the line is bad.', ar: 'عذراً، الإشارة ضعيفة.', translit: 'سوري، ذا لاين ايز باد.' },
          usage: { en: 'Say this when you cannot hear well.', ar: 'تقولها اذا ما تسمع زين.' },
          sentences: [
            { en: 'Sorry, the line is bad.', ar: 'عذراً، الإشارة ضعيفة.', translit: 'سوري، ذا لاين ايز باد.' },
            { en: 'The line is bad, call me back.', ar: 'الإشارة ضعيفة، رد عليّ.', translit: 'ذا لاين ايز باد، كول مي باك.' },
            { en: 'Can you hear me? The line is bad.', ar: 'تسمعني؟ الإشارة ضعيفة.', translit: 'كان يو هير مي؟ ذا لاين ايز باد.' },
          ],
        },
      ],
      dialogue: [
        ...
        { who: 'B', en: 'Sorry, the line is bad. Say that again.', ar: 'عذراً، الإشارة ضعيفة. كرر.', translit: 'سوری، ذا لاين ایز باد. سی ذات اقیین.' },
      ],
    },
    'at-the-barber': {
      ...
      items: [
        ...
        { en: 'shorter on the sides', ar: 'قص الأطراف', translit: 'شورتر اون ذا سايدز', pos: 'phrase', ipa: '/ˈʃɔːrtər ɒn ðə saɪdz/',
          example: { en: 'Shorter on the sides, please.', ar: 'قص الأطراف.', translit: 'شورتر اون ذا سایدز، بلیز.' },
          usage: { en: 'Tell the barber where to cut more.', ar: 'قل للحلاق وين يقص أكثر.' },
          sentences: [
            { en: 'Shorter on the sides, please.', ar: 'قص الأطراف.', translit: 'شورتر اون ذا سایدز، بلیز.' },
            { en: 'Make it shorter on the sides.', ar: 'قص الأطراف أكثر.', translit: 'میک ات شورتر اون ذا سایدز.' },
            { en: 'Shorter on top, not the sides.', ar: 'قص الفوق، مو الأطراف.', translit: 'شورتر اون توب، نات ذا سایدز.' },
          ],
        },
      ],
      dialogue: [
        ...
        { who: 'A', en: 'Shorter on the sides too?', ar: 'نقص الأطراف بعد؟', translit: 'شورتر اون ذا سایدز تو؟' },
    ...
    'technology-and-phone': {
      ...
      items: [
        ...
        { en: 'charge my phone', ar: 'أشحن جوالي', translit: 'تشارج ماي فون', pos: 'phrase', ipa: '/tʃɑːrdʒ maɪ foʊn/',
    ...
    'job-interview': {
      ...
      items: [
        ...
        { en: 'strengths', ar: 'نقاط قوة', translit: 'سترونقثس', pos: 'noun', ipa: '/strɛŋθs/',
          ...
          usage: { en: 'Things you do well.', ar: 'الاشياء اللي تبدع فيها.' },
          sentences: [
        ...
        { en: 'I am good at', ar: 'أنا ممتاز في', translit: 'اي ام غود ات', pos: 'phrase', ipa: '/aɪ æm ɡʊd æt/',
    ...
    'emergency-and-help': {
      title: { en: 'Emergencies & Help', ar: 'الطوارئ والنجدة' },
      items: [
        ...
        { en: 'call an ambulance', ar: 'اتصل بالإسعاف', translit: 'كول ان امبولانس', pos: 'phrase', ipa: '/kɔːl ən ˈæmbjələns/',
          example: { en: 'Call an ambulance!', ar: 'اتصل بالإسعاف!', translit: 'كول ان امبولانس!' },
          usage: { en: 'When someone is badly hurt or sick.', ar: 'اذا في احد متوعك او مصاب.' },
          sentences: [
            { en: 'Call an ambulance!', ar: 'اتصل بالإسعاف!', translit: 'كول ان امبولانس!' },
            { en: 'We need an ambulance.', ar: 'محتاجين إسعاف.', translit: 'وي نید ان امبولانس.' },
            { en: 'Please call an ambulance now.', ar: 'اتصل بالإسعاف الحين.', translit: 'بلیز كول ان امبولانس ناو.' },
          ],
        },
        { en: 'where is the nearest', ar: 'وين أقرب', translit: 'وير از ذا نيرست', pos: 'phrase', ipa: '/wɛər ɪz ðə ˈnɪrəst/',
      ...
      dialogue: [
        ...
        { who: 'B', en: 'Call an ambulance, please!', ar: 'اتصل بالإسعاف!', translit: 'كول ان امبولانس، بلیز!' },
  ...
  const PEL_BEGINNER_PHASES = [
    ...
    { id:'phase-2', title:{en:'People & Family', ar:'الناس والعائلة'}, lessons:['family-members','feelings-and-emotions','subject-pronouns','be-verb','this-and-that'] },
...
@media(max-width:680px){
  ...
  function buildSequence(lesson, lessonId){
    ...
    // 2. Recognize (multiple choice en -> ar)
    if(main.length >= 2){
      seq.push({ type:'recognize', item:main[0], pool:main, skill:'vocabulary' });
    }
    ...
    // 4. Build a sentence (arrange words)
    const arrangeTarget = (main[0] && main[0].sentences[0]) || {en:items[0].en, ar:items[0].ar, translit:items[0].translit};
    seq.push({ type:'arrange_words', sentence:arrangeTarget, skill:'grammar' });

    // 5. Fill the missing word
    seq.push({ type:'fill_blank', item:main[0]||items[0], sentence:((main[0]||items[0]).sentences[1]||arrangeTarget), skill:'grammar' });

    // 6. Spell the word
    seq.push({ type:'spell', item:main[0]||items[0], skill:'spelling' });

    // 7. Translate ar -> en
    seq.push({ type:'translate', item:main[0]||items[0], skill:'translation' });

    // 8. Listen + identify
    seq.push({ type:'listen', item:main[0]||items[0], skill:'listening' });
    seq.push({ type:'identify_heard', item:main[0]||items[0], pool:main, skill:'listening' });

    // 9. Pronunciation
    seq.push({ type:'pronunciation', item:main[0]||items[0], skill:'pronunciation' });

    // 10. Speaking (say the sentence)
    seq.push({ type:'speaking', sentence:(main[0]||items[0]).sentences[1]||arrangeTarget, skill:'speaking' });
    ...
    if(quiz.length){
      ...
      seq.push({ type:'grammar_correction', item:main[0]||items[0], skill:'grammar' });
    }
  ...
  const RENDERERS = {
    ...
    learn_sentence(inner, act, ctx){
      ...
      inner.innerHTML = `
        ...
        <div class="pel-act-ar arabic">${esc(s.ar)}</div>
    ...
    match(inner, act, ctx){
      ...
      inner.innerHTML = `<div class="pel-act-prompt">${L('Match the pairs','طابق الأزواج')}</div>
    ...
    arrange_words(inner, act, ctx){
      ...
      inner.innerHTML = `<div class="pel-act-prompt">${L('Build the sentence','رتب الجملة')}</div>
        ...
        <div class="pel-act-hint arabic" style="margin-top:14px;">${esc(s.ar)}</div>`;
    ...
    pronunciation(inner, act, ctx){
      const it=act.item;
      inner.innerHTML = `<div class="pel-act-prompt">${L('Repeat aloud','كرر بصوت عالي')}</div>
        <div class="pel-act-en">${esc(it.en)}</div>
        <div class="pel-act-translit">${esc(it.translit)}</div>
        <div class="pel-act-ar arabic">${esc(it.ar)}</div>
      ...
      ctx.self.ready(ctx, L('I said it','نطقتها'), ()=>ctx.self.mark(ctx,true));
    },
    speaking(inner, act, ctx){
      const s=act.sentence;
      inner.innerHTML = `<div class="pel-act-prompt">${L('Say the sentence','نطق الجملة')}</div>
        <div class="pel-act-en">${esc(s.en)}</div>
        <div class="pel-act-translit">${esc(s.translit)}</div>
        <div class="pel-act-ar arabic">${esc(s.ar)}</div>
    ...
    conversation_response(inner, act, ctx){
      ...
      const distractors=shuffle(conv.filter((c,j)=>j!==i+1).map(c=>c.en)).slice(0,2);
    ...
    grammar_correction(inner, act, ctx){
      ...
      inner.innerHTML = `<div class="pel-act-prompt">${L('Fix the mistake','صحح الخطأ')}</div>
    ...
    review(inner, act, ctx){
      ...
      inner.innerHTML = `<div class="pel-act-prompt">${L('Quick review','مراجعة سريعة')}</div>
        <div class="pel-tiles">${items.map(it=>`<div class="pel-tile"><div>${esc(it.en)}</div><div class="arabic" style="font-size:.85rem;color:var(--text-muted);margin-top:3px;">${esc(it.ar)}</div></div>`).join('')}</div>`;
      ctx.self.ready(ctx, L('Continue','متابعة'), ()=>ctx.self.next());
    },
    challenge(inner, act, ctx){
      const items=shuffle(act.items).slice(0,3); const it=items[0]; const pool=items;
      const opts=shuffle([it,...shuffle(pool.filter(x=>x.en!==it.en)).slice(0,3)]).slice(0,4); let sel=null;
      const prompt = ar() ? `<span class="arabic">سؤال سريع: وش معنى <b>${esc(it.en)}</b>؟</span>` : `Quick check: what does <b>${esc(it.en)}</b> mean?`;
      inner.innerHTML = `<div class="pel-act-prompt">${prompt}</div>
  ...
  const TYPE_LABELS_DEF = {
    ...
    match:['Match','طابق'], arrange_words:['Build','رتب'], fill_blank:['Fill','املأ'],
  ...
  const PROMPTS_DEF = {
    ...
    conversation_response:['Pick the natural reply','اختر الرد الطبيعي'], complete_dialogue:['Fill the gap','املأ الفراغ'],
    ...
    free_response:['Type your answer','اكتب جوابك'], review:['Recall','استرجع'], challenge:['Quick fire','سؤال سريع'],
  };
