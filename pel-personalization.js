...
(function(){
  ...
  const LEVELS = [
    { id:'A1', en:'Starting Out', ar:'تبدأ من الصفر',
  ...
  const ACADEMY_META = {
    ...
    'reading-corner':          { en:'Reading Corner', ar:'ركن القراءة', icon:'book', from:'#C8A96A', to:'#17171B', diff:'Intermediate', level:'B1' },
    ...
    'emergency-english':       { en:'Emergency English', ar:'انجليزي الطوارئ', icon:'siren', from:'#D25C5C', to:'#343744', diff:'Intermediate', level:'B1' },
  ...
  const QUESTIONS = [
    { key:'q1', multi:true, max:4, id:'goals',
      ...
      sub:{ en:'Pick everything that matters. You can change this later.', ar:'اختر كل شيء يهمك. تقدر تغيره بعدين.' },
      options:[
        ...
        { id:'customers', en:'Customer service', ar:'خدمة عملاء' },
    ...
    { key:'q3', multi:true, max:5, id:'contexts',
      ...
      sub:{ en:'This shapes which real-life lessons come first.', ar:'هذا يحدد وش الدروس العملية اللي تبدأ فيها.' },
      options:[
        { id:'workplace', en:'Workplace', ar:'بالدوام' },
        { id:'meetings', en:'Meetings', ar:'اجتماعات' },
        { id:'customers', en:'Customers', ar:'عملاء' },
    ...
    { key:'q4', multi:true, max:4, id:'weaknesses',
      title:{ en:'What feels hardest right now?', ar:'وش اصعب شيء عليك الحين؟' },
    ...
    { key:'q5', multi:false, id:'comfort',
      ...
      sub:{ en:'There is no wrong answer. We start where you are.', ar:'ما فيه جواب غلط. نبدأ من وين انت.' },
      options:[
        ...
        { id:'communicate-mistakes', en:'I can communicate, but I make a lot of mistakes', ar:'اتواصل بس اخطائي كثيرة' },
  ...
  const PLACEMENT = [
    { band:'A1', q:{ en:'What is a "book"?', ar:'وش يعني "book"؟' },
      options:[ { en:'Something you read', ar:'شيء تقراه' }, { en:'Something you eat', ar:'شيء تاكله' }, { en:'A kind of car', ar:'نوع سيارة' } ], correct:0 },
    ...
    { band:'B1', q:{ en:'Your manager asks: "Can you handle the client call?" You say...', ar:'مديرك سألك: "Can you handle the client call?" تقول...' },
    ...
    { band:'B2', q:{ en:'"Despite the delay, we delivered." means...', ar:'"Despite the delay, we delivered." يعني...' },
      options:[ { en:'Even though we were late, we finished', ar:'رغم التأخير انهينا الشغل' }, { en:'Because we were late, we stopped', ar:'لاننا تأخرنا وقفنا' }, { en:'We replaced the delay', ar:'استبدلنا التأخير' } ], correct:0 },
    { band:'B2', q:{ en:'A client complains about a mistake. You say...', ar:'عميل اشتكى من غلط. تقول له...' },
      options:[ { en:'I take full responsibility and here is how I\'ll fix it', ar:'اتحمل المسؤولية وهذي طريقة حلها' }, { en:'It is not my fault', ar:'مو غلطتي' }, { en:'Sorry maybe', ar:'اسف يمكن' } ], correct:0 },
  ];
  ...
  const API = {
    ...
    academyLessons: function(id){ return ACADEMY_LESSONS[id] || []; },
    ...
    buildRoute: function(profile){
      ...
      if(startIdx === 0){
        stages.push({ key:'start-here', title:{ en:'Start Here', ar:'ابدأ من هنا' }, level:'A1', theme:'foundation', units:[ { academyId:'english-foundations', lessonIds:ACADEMY_LESSONS['english-foundations'].slice(0,6), level:'A1' } ] });
      } else {
    ...
    recommendNext: function(profile, route, state){
      ...
      if(unit){
        if(stage.theme === 'foundation' && stage.key === 'start-here'){
          ...
          whyAr = 'اخترناه لان كل شيء يبني على هذي الاساسيات. اول ما تصير سهلة، تنفتح المواقف الحقيقية.';
          ...
          whyAr = 'اخترناه كتسخين سريع تاخذ فيه الراحة قبل ما يبدأ المسار فعليا.';
          ...
          whyAr = 'اخترناه لان ' + (wOpt ? wOpt.ar : 'هذي المهارة') + ' من الاشياء اللي تبي تقويها.';
        }
      }
      if(!whyEn){
    ...
    whyPlan: function(profile, route){
      ...
      if(foc.length){
        ...
        linesAr.push('خطتك تركز على ' + foc.map(f => ({Speaking:'المحادثة',Listening:'الاستماع',Vocabulary:'المفردات',Grammar:'القواعد',Pronunciation:'النطق',Writing:'الكتابة'})[f] || f).join(' و ') + ' لانك اخترتها كاولوية ونتيجة التقييم تأكدها.');
      }
